...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Form.24d4d94371d6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__oa:function(e){var F=e.getData()[0];var E=this.getChildControl(m);if(E.getSelection()[0]!=F){if(F){E.setSelection([F]);}
else {E.resetSelection();}
;}
;this.__Bt();this.__Bu();}
,__Bt:function(){var H=this.getChildControl(m).getSelection()[0];var I=this.getChildControl(l);var G=H?H.getIcon():r;G==null?I.resetIcon():I.setIcon(G);}
,__Bu:function(){var L=this.getChildControl(m).getSelection()[0];var M=this.getChildControl(l);var K=L?L.getLabel():r;var J=this.getFormat();if(J!=null){K=J.call(this,L);}
...
,_onKeyPress:function(e){var S=e.getKeyIdentifier();if(S==k||S==h){if(this.__Bs){this.setSelection([this.__Bs]);this.__Bs=null;}
;this.toggle();}
...
,_onListMouseDown:function(e){if(this.__Bs){this.setSelection([this.__Bs]);this.__Bs=null;}
;}
,_onListChangeSelection:function(e){var U=e.getData();var X=e.getOldData();if(X&&X.length>0){X[0].removeListener(t,this.__Bt,this);X[0].removeListener(u,this.__Bu,this);}
;if(U.length>0){var W=this.getChildControl(o);var V=this.getChildControl(m);var Y=V.getSelectionContext();if(W.isVisible()&&(Y==x||Y==g)){this.__Bs=U[0];}
else {this.setSelection([U[0]]);this.__Bs=null;}
;U[0].addListener(t,this.__Bt,this);U[0].addListener(u,this.__Bu,this);}
