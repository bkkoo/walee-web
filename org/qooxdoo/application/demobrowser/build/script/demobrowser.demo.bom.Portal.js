...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.e2295aa933ec.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="groupBoxes",h="demobrowser.demo.bom.portal.box.Manager",g="boxData",f="qx.event.type.Event",e="boxes",d="demobrowser.demo.bom.portal.box.Box",c="_applyActiveBox",b="loaded",a="singleton";qx.Class.define(h,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__zb=[];this.__zc=[];this.__zd={};}
,statics:{dataKeyRoot:g,dataKeyGroupBoxes:m,dataKeyBoxes:e},events:{"loaded":f},properties:{activeBox:{init:null,check:d,apply:c}},members:{__zb:null,__zc:null,__zd:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);}
;n.setActive(true);}
...
,__bf:function(p){var t,w,u,v,x,p;var q=p[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var s=p[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in q){t=q[w];u=t.boxes;w=t.id;v={id:w,element:document.getElementById(w)};this.__zc.push(v);this.__zd[w]=[];for(var k=0,l=u.length;k<l;k++){p=s[u[k]];var r=document.getElementById(p.id);var x=new demobrowser.demo.bom.portal.box.Box(p,r,null,w);this.__zb.push(x);this.__zd[w].push(x);}
;}
;}
,getBoxes:function(){return this.__zb;}
,getGroupBoxes:function(){return this.__zc;}
,updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());qx.lang.Array.remove(this.__zd[z],A);qx.lang.Array.insertAt(this.__zd[y],A,B);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__zc.length,D;i<j;i++){D=this.__zd[this.__zc[i].id];for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__zc[i];}
;}
;}
;return null;}
...
(function(){var s="click",r="1px solid #444444",q="height",p="position",o="zIndex",n="_applyActive",m="width",l="box_content",k=" It does contain no UI widget code at all.",j="relative",c="demobrowser.demo.bom.portal.box.Box",i="1px solid orange",g="This is a demo application showing the low-level capabilities.",b="div",a="String",f="<br/><br/>",d="border",h="Boolean";qx.Class.define(c,{extend:qx.core.Object,construct:function(t,u,v,w){qx.core.Object.call(this);this.__ze=t;this.__bV=t.id;if(u!=null){qx.bom.element.Style.set(u,m,t.width);qx.bom.element.Style.set(u,q,t.height);this.__zh(u,v);}
;this.setElement(u);this.setGroupBoxId(w);this.__zf=null;this.__zg=null;if(t.resizable){this.setResizable(true);var x={minWidth:parseInt(t.minWidth),minHeight:parseInt(t.minHeight),maxWidth:parseInt(t.maxWidth),maxHeight:parseInt(t.maxHeight),handles:t.resizeHandles};this.__zf=new demobrowser.demo.bom.portal.box.Resizable(this,x);}
;if(t.draggable){this.setDraggable(true);this.__zg=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__zi();}
,properties:{element:{init:null},groupBoxId:{init:null,check:a},active:{check:h,init:false,apply:n},resizable:{check:h,init:false},draggable:{check:h,init:false}},members:{__bV:null,__ze:null,__zg:null,__zf:null,_applyActive:function(y,z){if(y){qx.bom.element.Style.set(this.getElement(),d,i);}
else {qx.bom.element.Style.set(this.getElement(),d,r);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__ze;}
,getDraggableComponent:function(){return this.__zg;}
,getResizableComponent:function(){return this.__zf;}
,__zh:function(A,B){if(B){for(var C in B){qx.bom.element.Style.set(C,B[C]);}
;}
;qx.bom.element.Style.set(A,p,j);qx.bom.element.Style.set(A,o,0);qx.bom.Element.addListener(A,s,this.__zj,this,true);}
,__zi:function(){var E=g+k;E=E+f+E+f+E;var D=qx.dom.Element.create(b,{"class":l});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__zj:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__ze=this.__zf=this.__zg=null;}
});}
)();
...
(function(){var u="south",t="mouseup",s="mousedown",r='px',q="width",p="_",o="height",n="px",m="east",l="div",d="demobrowser.demo.bom.portal.box.Resizable",k="southeast",h="Handle",c="mouseover",b="mouseout",g="visible",f="mousemove",i="orientation",a="hidden",j="visibility";qx.Class.define(d,{extend:qx.core.Object,construct:function(v,w){qx.core.Object.call(this);this.__zk=v;this.__fH=this.__zk.getElement();this.__zl={};this.__zm=false;this.__zn={orientation:null,lastCoord:{left:null,top:null}};this.__zo={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__zo){if(w[name]){this.__zo[name]=w[name];}
;}
;this.__zh();}
,members:{__zn:null,__zk:null,__fH:null,__zl:null,__zo:null,__zm:false,getBox:function(){return this.__zk;}
,__zh:function(){switch(this.__zo.handles){case 1:this.__zl.east=null;break;case 2:this.__zl.south=null;break;case 3:this.__zl.south=null;this.__zl.southeast=null;this.__zl.east=null;break;};for(var y in this.__zl){var x=this.__zl[y]=qx.dom.Element.create(l);qx.bom.element.Attribute.set(x,i,y);qx.dom.Element.insertEnd(x,this.__fH);if(this.__fH.id){x.id=this.__fH.id+p+y;}
;this.__zp(y);this.__zq(y);}
;}
,__zp:function(z){qx.bom.element.Class.add(this.__zl[z],z+h);qx.bom.element.Style.set(this.__zl[z],j,this.__zo.autoHide?a:g);}
,__zq:function(A){var C=qx.event.Registration;var B=this.__zl[A];C.addListener(B,s,this.__zt,this);C.addListener(document,t,this.__zu,this);if(this.__zo.autoHide){C.addListener(this.__zk.getElement(),c,this.__zr,this);C.addListener(this.__zk.getElement(),b,this.__zs,this);}
;}
,__zr:function(e){for(var D in this.__zl){qx.bom.element.Style.set(this.__zl[D],j,g);}
;}
,__zs:function(e){if(!this.__zm){for(var E in this.__zl){qx.bom.element.Style.set(this.__zl[E],j,a);}
;}
;}
,__zt:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,f,this.__zv,this,true);this.__zm=true;var F=e.getTarget();this.__zn.orientation=qx.bom.element.Attribute.get(F,i);this.__zn.lastCoord.left=e.getDocumentLeft();this.__zn.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__fH);}
;}
,__zu:function(e){e.stopPropagation();if(this.__zm){qx.event.Registration.removeListener(document,f,this.__zv,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__fH);if(this.__zo.autoHide){for(var G in this.__zl){qx.bom.element.Style.set(this.__zl[G],j,a);}
;}
;this.__zm=false;qx.bom.Selection.clear(document.body);}
;}
,__zv:function(e){e.stopPropagation();if(this.__zm){var H={left:null,top:null};switch(this.__zn.orientation){case u:H.top=e.getDocumentTop();break;case k:H.top=e.getDocumentTop();H.left=e.getDocumentLeft();break;case m:H.left=e.getDocumentLeft();break;};this.__zw(H,this.__zn.lastCoord);this.__zn.lastCoord.left=e.getDocumentLeft();this.__zn.lastCoord.top=e.getDocumentTop();}
;}
,__zw:function(I,J){var Q=qx.bom.element.Dimension;var N=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__zk.getId());var P=Q.getContentSize(N.element);if(I.left){var M=I.left-J.left;if(M!==0){var L=Q.getContentWidth(this.__fH)+M;var O=Q.getWidth(this.__fH)+M;if((this.__zo.minWidth==null||L>this.__zo.minWidth)&&(this.__zo.maxWidth==null||L<=this.__zo.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__fH,q,L+r);this.__zk.getData().width=L;}
;}
;}
;}
;if(I.top){var M=I.top-J.top;if(M!==0){var K=Q.getContentHeight(this.__fH)+M;if((this.__zo.minHeight==null||K>this.__zo.minHeight)&&(this.__zo.maxHeight==null||K<=this.__zo.maxHeight)){qx.bom.element.Style.set(this.__fH,o,K+n);}
;}
;}
;}
},destruct:function(){if(this.__zo.autoHide){qx.event.Registration.removeListener(this.__zk.getElement(),c,this.__zr,this);qx.event.Registration.removeListener(this.__zk.getElement(),b,this.__zs,this);}
;this.__zk=this.__zo=this.__fH=this.__zl=null;this.__zn=null;}
});}
)();
...
(function(){var c="auto",b="demobrowser.demo.bom.portal.box.Util",a="zIndex";qx.Class.define(b,{statics:{__zx:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,a);e=e==c?0:e;qx.bom.element.Style.set(d,a,e+this.__zx);}
,sendToBack:function(f){var g=qx.bom.element.Style.get(f,a);qx.bom.element.Style.set(f,a,g-this.__zx);}
}});}
)();
...
(function(){var o="engine.name",n="mousedown",m="mouseover",l="drag",k="dragend",j="div",i="move",h="dragHandle",g="demobrowser.demo.bom.portal.box.Draggable",f="cursor",b="html",d="mousemove",c="mouseup",a="dragstart";qx.Class.define(g,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.__zk=p;this.__fH=p.getElement();this.__zy=null;this.__zz=null;this.__zh();}
,members:{__zk:null,__fH:null,__zy:null,__zz:null,getBox:function(){return this.__zk;}
,getElement:function(){return this.__fH;}
,__zh:function(){this.__zA();this.__zq();}
,__zA:function(){this.__zy=qx.dom.Element.create(j);qx.bom.element.Class.add(this.__zy,h);qx.dom.Element.insertBegin(this.__zy,this.__fH);}
,__zq:function(){qx.bom.Element.addListener(this.__zy,n,this.__oK,this);qx.bom.Element.addListener(this.__zy,m,function(e){qx.bom.element.Style.set(this,f,i);}
,this.__zy);qx.bom.Element.addListener(this.__zy,a,this.__zD,this);qx.bom.Element.addListener(this.__zy,k,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__zy,l,this.__zE,this);}
,__oK:function(e){if(e.isLeftPressed()){this.__zz={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__fH),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__fH)};qx.bom.Element.addListener(document.body,c,this.__zC,this,true);this.__zB();qx.event.Registration.fireEvent(this.__zy,a,qx.event.type.Event);}
;}
,__zB:qx.core.Environment.select(o,{"mshtml":function(){var r=this;var q=qx.lang.Function.bind(this.__zC,r);document.getElementsByTagName(b)[0].onmouseleave=q;}
,"default":(function(){}
)}),__zC:function(e){try{e.stopPropagation();}
catch(s){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,d,this.__zE,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,c,this.__zC,this,true);}
,__zD:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__zk);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__zk);qx.event.Registration.addListener(document.body,d,this.__zE,this,true);}
,__zE:function(e){e.stopPropagation();var t=e.getDocumentLeft()-this.__zz.left;var top=e.getDocumentTop()-this.__zz.top;qx.event.Timer.once(function(){this.checkGroupBox(t,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,t);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__zk=this.__zy=this.__fH=this.__zz=null;}
});}
)();
(function(){var w="width:",v="top",u="Boolean",t="left",s="demobrowser.demo.bom.portal.dragdrop.Manager",r="height:",q="paddingTop",p="opacity:0.5;margin:0;position:absolute;",o="end",n="left:",d="div",m="demobrowser.demo.bom.portal.box.Box",h="paddingBottom",c="1px dashed red",b="ease-out",g="singleton",f="top:",k="border",a="px;",l="px";qx.Class.define(s,{type:g,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__zF={top:null,height:null};this.__zG={top:0,left:0};}
,properties:{activeBox:{check:m,init:null,nullable:true},sessionActive:{check:u,init:false}},members:{__zF:null,__zH:null,__zI:false,__zG:null,__zJ:null,__zK:null,startSession:function(x){this.setSessionActive(true);this.setActiveBox(x);this.__zH=x.getGroupBoxId();this.__zL();if(this.__zJ==null){this.__zJ={};var y=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=y.length;i<j;i++){this.__zJ[y[i].element.id]={left:qx.bom.element.Location.getLeft(y[i].element),right:qx.bom.element.Location.getLeft(y[i].element)+qx.bom.element.Dimension.getWidth(y[i].element)};}
;}
;}
,__zL:function(){if(!this.__zK){this.__zK=qx.dom.Element.create(d);}
;var B=this.getActiveBox().getElement();var z=qx.bom.element.Dimension.getContentSize(B);this.__zM(B,this.__zK);qx.bom.element.Class.add(this.__zK,qx.bom.element.Class.get(B));var A=p+f+qx.bom.element.Location.getTop(B)+a+n+qx.bom.element.Location.getLeft(B)+a+w+z.width+a+r+z.height+l;qx.bom.element.Style.setCss(this.__zK,A);qx.bom.element.Style.set(B,k,c);qx.dom.Node.getBodyElement(B).appendChild(this.__zK);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__zK);}
,__zM:function(C,D){while(C.firstChild){D.appendChild(C.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var I=this.getActiveBox();var F=I.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(I.getGroupBoxId(),this.__zH,I);I.setGroupBoxId(this.__zH);var H={left:qx.bom.element.Location.getLeft(this.__zK)+l,top:qx.bom.element.Location.getTop(this.__zK)+l};var G={left:qx.bom.element.Location.getLeft(F)+l,top:qx.bom.element.Location.getTop(F)+l};var J={timing:b,duration:300,keep:100,keyFrames:{'0':H,'100':G}};var E=qx.bom.element.Animation.animate(this.__zK,J);E.addListener(o,function(){this.__zM(this.__zK,F);qx.bom.element.Style.reset(F,k);this.__zK.parentNode.removeChild(this.__zK);if(I.isActive()){I._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(I);}
;}
,this);}
,onDragMove:function(top,K){if(this.__zG.left!=K){qx.bom.element.Style.set(this.__zK,t,K+l);}
;if(this.__zG.top!=top){qx.bom.element.Style.set(this.__zK,v,top+l);}
;var L=this.getActiveBox().getElement();if(this.__zF.top==null){this.__zF.top=qx.bom.element.Location.getTop(L);}
;if(this.__zF.height==null){this.__zF.height=qx.bom.element.Dimension.getHeight(L);}
;if(this.__zI==false&&top>=this.__zF.top&&top<=(this.__zF.top+this.__zF.height)){return;}
;var M;if(this.__zI){M=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__zH));while(M!=null){if(this.__zN(true,top,L,M)){this.__zI=false;return;}
;M=qx.dom.Hierarchy.getNextElementSibling(M);}
;}
else {M=L;}
;if(top-this.__zG.top>0){M=qx.dom.Hierarchy.getNextElementSibling(M);while(M!=null){if(M){if(this.__zN(true,top,L,M)){return;}
;}
;M=qx.dom.Hierarchy.getNextElementSibling(M);}
;}
else {var M=qx.dom.Hierarchy.getPreviousElementSibling(M);while(M!=null){if(M){if(this.__zN(false,top,L,M)){return;}
;}
;M=qx.dom.Hierarchy.getPreviousElementSibling(M);}
;}
;this.__zG.left=K;this.__zG.top=top;}
,__zN:function(N,top,O,P){var Q=qx.bom.element.Location.getTop(P);var S=parseInt(qx.bom.element.Style.get(P,q));var T=parseInt(qx.bom.element.Style.get(P,h));var R=qx.bom.element.Dimension.getContentHeight(P)+T+S;var U;if(N){if(top>=(Q+(R/3))){U=qx.dom.Hierarchy.getNextElementSibling(P);if(U!=O||U==null){qx.dom.Element.insertAfter(O,P);this.__zF.top=qx.bom.element.Location.getTop(O);}
;return true;}
;}
else {if(top<=(Q+R*2/3)){U=qx.dom.Hierarchy.getPreviousElementSibling(P);if(U!=O||U==null){qx.dom.Element.insertBefore(O,P);this.__zF.top=qx.bom.element.Location.getTop(O);}
;return true;}
;}
;return false;}
,checkGroupBox:function(V,W){if(this.__zJ[this.__zH].left<=V&&this.__zJ[this.__zH].right>=V){return;}
;for(var X in this.__zJ){if(X!=this.__zH){if(this.__zJ[X].left<=V+W&&this.__zJ[X].right>=V){this.__zH=X;this.__zI=true;return;}
;}
;}
;}
},destruct:function(){this.__zF=this.__zG=this.__zH=null;this.__zO=this.__zK=this.__zJ=null;}
});}
)();
