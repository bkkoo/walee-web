...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.a9c71cd6f5f1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Open Native Window",p="Open Native Modal Window",o="demobrowser.demo.bom.Window",n="Modal Window closed?",m="http://sourceforge.net",l="window1",k="window3",j="http://slashdot.org",i="Window closed?",h="http://qooxdoo.org",c="demobrowser/demo/html/ModalWindow.html",g="Open Faked Native Modal Window",f="window2",b="#eee",a="click",d="button";qx.Class.define(o,{extend:qx.application.Native,members:{__Ab:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__Ab=[h,m,j,r.toUri(c)];var u=qx.bom.Input.create(d);qx.bom.Input.setValue(u,q);document.body.appendChild(u);qx.event.Registration.addListener(u,a,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__Ab[0],l,x);}
...
,this);var s=qx.bom.Input.create(d);qx.bom.Input.setValue(s,p);document.body.appendChild(s);qx.event.Registration.addListener(s,a,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__Ab[3],f,y,true);}
...
,this);var v=qx.bom.Input.create(d);qx.bom.Input.setValue(v,g);document.body.appendChild(v);qx.event.Registration.addListener(v,a,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(b);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__Ab[0],k,A,true,false);}
,this);}
...
(function(){var t="dialogHeight",s="no",r="yes",q="",p="qx.bom.Window",o="interval",n="dialogWidth",m="dialogLeft",l="px",k="javascript:/",d=":",j=";",g="dialogTop",c="qxNativeWindow",b="scrollbars",f="scroll",e=",",h='load',a="resizable",i="=";qx.Class.define(p,{statics:{__kP:null,__Ac:null,__jQ:null,__Ad:{"top":g,left:m,width:n,height:t,scrollbars:f,resizable:a},__Ae:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Af:function(){return window.showModalDialog!=null;}
,open:function(u,name,v,w,x,y,self){var C=null;if(u==null){u=k;}
;if(name==null){name=c+new Date().getTime();}
;if(x==null){x=true;}
;var z=this.__Ag(v,w&&x);if(w){if(this.__Af()&&x){C=window.showModalDialog(u,[window.self],z);}
else {this.getBlocker().block();if(this.__jQ==null){this.__jQ=new qx.event.Timer(500);this.__jQ.addListener(o,this.__Ah,this);}
;this.__Ac=window.open(u,name,z);this.__jQ.restart();C=this.__Ac;}
;}
...
;return C;}
,__Ag:function(D,E){var F;var I;var G=[];if(E&&this.__Af()){for(var H in D){if(qx.bom.Window.__Ad[H]){var J=q;if(H!=b&&H!=a){J=l;}
;I=qx.bom.Window.__Ad[H]+d+D[H]+J;G.push(I);}
else {qx.log.Logger.warn("Option '"+H+"' is not supported for modal windows.");}
;}
;F=G.join(j);}
else {for(var H in D){if(qx.bom.Window.__Ae[H]){if(qx.lang.Type.isBoolean(D[H])){I=H+i+(D[H]?r:s);}
else {I=H+i+D[H];}
;G.push(I);}
...
;F=G.join(e);}
;return F;}
,__Ah:function(){if(this.isClosed(this.__Ac)){this.getBlocker().unblock();this.__jQ.stop();}
;}
,getBlocker:function(){if(this.__kP==null){this.__kP=new qx.bom.Blocker;}
;return this.__kP;}
...
,members:{__vS:null,__uA:null,__vT:null,__vU:false,__vV:10000,__vW:0,__vX:p,block:function(q){if(!this.__vU){this.__vT=q;var r=this.__wb();this.__wc(r);this.__vU=true;}
;}
,unblock:function(){if(this.__vU){this.__wd();this.__vU=false;}
;}
,isBlocked:function(){return this.__vU;}
,getBlockerElement:function(){return this.__uA;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__uA,h,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__uA,h);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__uA,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__uA);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__uA,c,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__uA,c);}
,__bf:function(){this.__vY();if((qx.core.Environment.get(d)==f)){this.__wa();}
;qx.event.Registration.addListener(window,i,this.__kW,this);}
,__vY:function(){this.__uA=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__uA,{display:g,opacity:this.__vW,backgroundColor:this.__vX});this.setBlockerZIndex(this.__vV);}
,__wa:function(){this.__vS=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__vS,n,false);qx.bom.element.Attribute.set(this.__vS,o,l);qx.bom.element.Style.setStyles(this.__vS,{display:g,opacity:this.__vW});}
,__wb:function(){var v={position:j};if(this.__wf()){v.left=b;v.top=b;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+a;v.height=qx.bom.Document.getHeight()+a;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__vT)+a;v.height=qx.bom.element.Dimension.getHeight(this.__vT)+a;v.left=qx.bom.element.Location.getLeft(this.__vT)+a;v.top=qx.bom.element.Location.getTop(this.__vT)+a;}
;return v;}
,__wc:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__uA,w);qx.dom.Element.insertEnd(this.__uA,x);if((qx.core.Environment.get(d)==f)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__vS,w);qx.dom.Element.insertEnd(this.__vS,document.body);}
;}
,__wd:function(){qx.dom.Element.remove(this.__uA);if((qx.core.Environment.get(d)==f)){qx.dom.Element.remove(this.__vS);}
;}
,__kW:function(e){if(this.__wf()){this.__we({width:b,height:b});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+a,height:qx.bom.Document.getHeight()+a};this.__we(y);}
,this,0);}
;}
,__we:function(z){qx.bom.element.Style.setStyles(this.__uA,z);if((qx.core.Environment.get(d)==f)){qx.bom.element.Style.setStyles(this.__vS,z);}
;}
,__wf:function(){return (this.__vT==null||qx.dom.Node.isWindow(this.__vT)||qx.dom.Node.isDocument(this.__vT));}
},destruct:function(){qx.event.Registration.removeListener(window,i,this.__kW,this);this.__vS=this.__uA=this.__vT=null;}
});}
)();
