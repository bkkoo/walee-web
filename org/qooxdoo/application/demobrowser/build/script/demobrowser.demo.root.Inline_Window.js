...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.b68e1439c03a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="resize",l="qx.ui.root.Page",k="mshtml",j="gecko",i="paddingLeft",h="$$widget",g="left",f="paddingTop",d="qxIsRootPage",c="absolute",a="engine.name",b="div";qx.Class.define(l,{extend:qx.ui.root.Abstract,construct:function(n){this.__lw=n;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(m,this.__kW,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(a)==k)){this.setKeepFocus(true);}
;}
,members:{__jQ:null,__lw:null,_createContainerElement:function(){var p=this.__lw.createElement(b);this.__lw.body.appendChild(p);var o=new qx.html.Root(p);o.setStyles({position:c,textAlign:g});o.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(a)==j)){o.setAttribute(d,1);}
;return o;}
...
,__kW:function(e){this.getContainerElement().setStyles({width:0,height:0});this.getContentElement().setStyles({width:0,height:0});}
...
;this.__Fy=r;r.style.overflow=k;r.style.textAlign=g;this.__Fz=s||false;this.__FA=t||false;this.__FB();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;var window=qx.dom.Node.getWindow(r);qx.event.Registration.addListener(window,b,this._onWindowResize,this);}
,members:{__Fz:false,__FA:false,__Fy:null,__FB:function(){if(this.__Fz||this.__FA){var u=qx.bom.element.Dimension.getSize(this.__Fy);if(this.__Fz&&u.width<1){throw new Error("The root element "+this.__Fy+" of "+this+" needs a width when its width size should be used!");}
;if(this.__FA){if(u.height<1){throw new Error("The root element "+this.__Fy+" of "+this+" needs a height when its height size should be used!");}
;if(u.height>=1&&qx.bom.element.Style.get(this.__Fy,"height",3)==""){qx.bom.element.Style.set(this.__Fy,"height",u.height+"px");}
;}
;qx.event.Registration.addListener(this.__Fy,"resize",this._onResize,this);}
;}
,_createContainerElement:function(){var v=this.__Fy;if(this.__Fz||this.__FA){var z=document.createElement(h);v.appendChild(z);if((qx.core.Environment.get(c)==d)&&qx.core.Environment.get(n)==6){var y=qx.dom.Node.getBodyElement(v);var x;var B;var A=false;var w=qx.dom.Hierarchy.getAncestors(v);for(var i=0,j=w.length;i<j;i++){x=w[i];if(x!=y){B=qx.bom.element.Style.get(x,p);if(B==a){A=true;break;}
;}
else {break;}
;}
...
,this,0);return C;}
,_onResize:function(e){var D=e.getData();if((D.oldWidth!==D.width)&&this.__Fz||(D.oldHeight!==D.height)&&this.__FA){qx.ui.core.queue.Layout.add(this);}
;}
,_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();}
;if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();}
;}
,_computeSizeHint:function(){var I=this.__Fz;var F=this.__FA;if(!I||!F){var E=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {E={};}
;var J=qx.bom.element.Dimension;if(I){var H=J.getContentWidth(this.__Fy);E.width=H;E.minWidth=H;E.maxWidth=H;}
;if(F){var G=J.getContentHeight(this.__Fy);E.height=G;E.minHeight=G;E.maxHeight=G;}
;return E;}
},defer:function(K,L){qx.ui.core.MLayoutHandling.remap(L);}
,destruct:function(){qx.event.Registration.removeListener(this.__Fy,b,this._onResize,this);this.__Fy=null;}
});}
)();
(function(){var f="resize",d="interval",c="__jQ",b="body",a="qx.event.handler.ElementResize";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__fx=g;this.__DM={};this.__jQ=new qx.event.Timer(200);this.__jQ.addListener(d,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__DM:null,__fx:null,__jQ:null,canHandleEvent:function(h,i){return h.tagName.toLowerCase()!==b;}
,registerEvent:function(j,k,l){var n=qx.core.ObjectRegistry.toHashCode(j);var m=this.__DM;if(!m[n]){m[n]={element:j,width:qx.bom.element.Dimension.getWidth(j),height:qx.bom.element.Dimension.getHeight(j)};this.__jQ.start();}
;}
,unregisterEvent:function(o,p,q){var s=qx.core.ObjectRegistry.toHashCode(o);var r=this.__DM;if(r[s]){delete r[s];if(qx.lang.Object.isEmpty(r)){this.__jQ.stop();}
;}
;}
,_onInterval:function(e){var u=this.__DM;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,f,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__fx=this.__DM=null;this._disposeObjects(c);}
