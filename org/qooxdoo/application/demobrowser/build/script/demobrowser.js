...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.00d2132242e0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="qx.core.BaseInit",f="engine.name",d="demobrowser.Application",c="os.name",b="engine.version",a="";qx.Class.define(g,{statics:{__iS:null,getApplication:function(){return this.__iS||null;}
...
;qx.log.Logger.debug(this,"Load runtime: "+(new Date-qx.Bootstrap.LOADSTART)+"ms");var i=d;var j=qx.Class.getByName(i);if(j){this.__iS=new j;var h=new Date;this.__iS.main();qx.log.Logger.debug(this,"Main runtime: "+(new Date-h)+"ms");var h=new Date;this.__iS.finalize();qx.log.Logger.debug(this,"Finalize runtime: "+(new Date-h)+"ms");}
...
(function(){var dT="-",dS="src",dR="__tw",dQ="Demos",dP='</div>',dO="Simple Theme",dN="^.*",dM="filled",dL="http://demo.qooxdoo.org/2.1.1/apiviewer/",dK="__tE",cx="Display HTML source",cv="?qxenv:demobrowser.withTests:true",cu="browser.name",ct="dblclick",cs="icon/22/actions/media-playback-start.png",cr="Open the qooxdoo Manual",cq="_runbutton",cp="app-header",co="demobrowser.DemoBrowser",cn="HTML Code",eb="_infosplit",ec='</span>=<span class="string">',dY="Run previous demo",ea="//",dW="icon/22/actions/media-seek-forward.png",dX="ie",dU="icon/22/actions/help-contents.png",dV="__lK",ed="_leftComposite",ee="icon/22/apps/utilities-color-chooser.png",dt="_status",ds="Ctrl+N",dv="Previous",du='.html',dx="Run",dw='<span class="html-tag-name">',dz="<div class='script'>The sample source will be displayed here.</div>",dy="__tx",dr="_searchTextField",dq="__lI",q="Open demo in the playground",v="tree1",w="icon/22/actions/help-about.png",x="f1",y="Debug",z="__tq",A="Display log file",B="script/demobrowser.demo",C="Run the selected demo",D="icon/22/apps/utilities-log-viewer.png",es="Ctrl+O",er="Log File",eq="qx.theme.Classic",ep='"',ey="Get Demo Link",ew='<div class="script">',eu="logappender",et="<pre class='script'>",eA="Choose theme",ez="Demo has been disposed.",bw="icon/22/apps/internet-web-browser.png",bx="f2",bu="JS Code",bv="icon/22/mimetypes/executable.png",bA="ig",bB="Unable to access namespace. Maybe no demo loaded.",by="Hide/Show Tests Demos",bz='excluded',bs='"}',bt="_urlWindow",X="icon/22/actions/edit-redo.png",W='_cmdDisposeSample',ba="qx.theme.Modern",Y="demobrowser.withTests",T="toolbar",S="icon/22/apps/office-spreadsheet.png",V="__tz",U="To Playground",R="demo/welcome.html",Q='_cmdSampleInOwnWindow',bH=".*",bI="right-top",bJ='js',bK="__tr",bD="app-splitpane",bE="</pre>",bF="hideItem",bG="Open the qooxdoo API Viewer",bL="__tA",bM="default",bl="Debugging options",bk="index.html",bj="file:",bi="Filter...",bh="Manual",bg="showItem",bf="http://demo.qooxdoo.org/2.1.1/playground/",be="<pre ><div class='script'>",bp="Demo Browser",bo="Dispose Demo",bN='{"code": ',bO="changeState",bP="Classic Theme",bQ="toolbar-button",bR='html',bS='log',bT="icon/16/actions/edit-find.png",bU="__tB",bV="treeview.flat",bW="http://manual.qooxdoo.org/",cF="Own Window",cE="right",cD="main",cC='_cmdObjectSummary',cJ="Info",cI="2.1.1",cH="_prevButton",cG='/',cN="/demo/",cM='_cmdNextSample',dl="_history",dm="Indigo Theme",dj='&gt;',dk="Unable to access application.",dh="Run next demo",di='_cmdPrevSample',df=" Start",dg="\"",dn="Ctrl+Left",dp="demo-tree",dD="Display JavaScript source",dC='_cmdRunSample',dF="Next",dE="excluded",dH="__tC",dG="F5",dJ="__tm",dI="__ty",dB="_demoView",dA="icon/22/actions/application-exit.png",el="Modern Theme",em="Open demo in new window",en="bottom-left",eo="string",eh="API Viewer",ei="runbutton",ej="<div class='script'>The sample JS source will be displayed here.</div>",ek="Ctrl+Right",ef="_navPart",eg="textfield",p="_tree",o="Ctrl+D",n="mainsplit",h="Could not open the Playground.",g="icon/22/actions/go-previous.png",f="Object Summary",d='label',c="_nextButton",b='demo/',a=' <span class="keyword">',G="</div></pre>",H="left",E="icon/22/actions/go-next.png",F="Demo Link",K="qx.theme.Simple",L="Theme",I="_iframe",J='</span>',N="changeValue",O="node",cR="load",cL="changeSelection",cY='execute',cU="white",cA="id",cy='changeSelection',bc=".src.js",cB="_blank",bn=" Demo Browser ",bm='value',cf=".html",cg="#",ch="visibility",ci="visible",cj="html",ck="noPlayground",cl="<script",cm="horizontal",cd="?qxenv:qx.theme:",ce="javascript",cz="qx.theme.Indigo",cX="qooxdoo ",cW="qx_srcview",cV="js",dd="\n",dc="outputviews.sourcepage.html.page",db="widget",da="interval",cT="icon/22/mimetypes/text-html.png",cS="outputviews.sourcepage.js.page",M="?",br="monospace",bq="log",cK="success",bC='\n',cQ="fail",cP="modelLink",cO="tags",bb="auto",de="~",P=".",bd=" ",bX="enabled",bY="",ca="/",cb="value",cc="execute";qx.Class.define(co,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__lI={};var eE=new qx.ui.layout.VBox;this.setLayout(eE);this.add(this._createHeader());this.widgets={};this.tests={};this.__tl=cz;this.__tF();this.__tm=this.__tO();this.add(this.__tm);var eI=new qx.ui.splitpane.Pane(cm);eI.setAppearance(bD);this.mainsplit=eI;var eF=new qx.ui.splitpane.Pane(cm);eF.setDecorator(null);this._infosplit=eF;this.add(eI,{flex:1});var eK=this._leftComposite=new qx.ui.container.Composite();eK.setLayout(new qx.ui.layout.VBox(3));eI.add(eK,0);{}
;var eD=new qx.ui.container.Composite();eD.setLayout(new qx.ui.layout.HBox(3));eD.setAppearance(eg);eK.add(eD);var eL=new qx.ui.basic.Image(bT);eD.add(eL);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(db);this._searchTextField.setPlaceholder(bi);var eJ=new qx.event.Timer(500);eJ.addListener(da,function(eM){this.filter(this._searchTextField.getValue());eJ.stop();}
,this);this._searchTextField.addListener(N,function(eN){eJ.restart();}
,this);eD.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(bY);this._status.setAppearance(db);this._status.setWidth(80);this._status.setTextAlign(cE);eD.add(this._status);eI.add(eF,1);this._tree=this.__tS();eK.add(this._tree,{flex:1});this.__tT();this._demoView=this.__tP();{eF.add(this._demoView,2);}
;var eB=this.__tn=this.__tQ();var eC=this.__to=this.__tR();var eG=this.__tp=new qxc.ui.logpane.LogView();eG.setDecorator(null);var eH=this.__cG=new qx.ui.container.Stack();eH.setDecorator(cD);eH.add(eB);eH.add(eC);eH.add(eG);eF.add(eH,1);eH.resetSelection();eH.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(bO,function(e){var eO=e.getData().replace(de,ca);if(this._currentSample!=eO){this.setCurrentSample(eO);}
;}
,this);this.__tq=[this.__tw,this.__tx,this.__tA];{this.__tq.push(this.__tu);this.__tq.push(this.__ty);this.__tq.push(this.__tC);}
;this.__tr=new qx.event.Timer(250);this.__tr.addListener(da,this.__tV,this);this.__tr.start();this.__ts=new demobrowser.InfoWindow(this.tr(cJ));this.__ts.setAutoCenter(true);}
,members:{_iframe:null,__tl:null,__tr:null,__tt:null,_tree:null,_status:null,_searchTextField:null,__tu:null,__tv:null,__tq:null,_versionFilter:null,_navPart:null,__tw:null,__tx:null,__ty:null,__tz:null,__tA:null,__tB:null,__tC:null,__tm:null,_leftComposite:null,_infosplit:null,_demoView:null,__lK:null,__lI:null,__tD:null,_urlWindow:null,__ts:null,__cG:null,__tn:null,__to:null,__tp:null,__tE:null,defaultUrl:R,playgroundUrl:bf,__tF:function(){this._cmdObjectSummary=new qx.ui.core.Command(es);this._cmdObjectSummary.addListener(cc,this.__tH,this);this._cmdRunSample=new qx.ui.core.Command(dG);this._cmdRunSample.addListener(cc,this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command(dn);this._cmdPrevSample.addListener(cc,this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command(ek);this._cmdNextSample.addListener(cc,this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command(ds);this._cmdSampleInOwnWindow.addListener(cc,this.__tI,this);this._cmdDisposeSample=new qx.ui.core.Command(o);this._cmdDisposeSample.addListener(cc,this.__tN,this);}
,__tG:function(e){var eR=e.getTarget()===this.__tE?this.__tD:this.__tE;var eQ=e.getData()[0];if(eR&&eQ){eR.setModelSelection([eQ.getModel()]);}
;var eP=eQ!=null?eQ.getUserData(cb):bY;switch(eP){case cj:this.__cG.setSelection([this.__tn]);this.__cG.show();break;case cV:this.__cG.setSelection([this.__to]);this.__cG.show();break;case bq:this.__cG.setSelection([this.__tp]);this.__cG.show();break;default:this.__cG.resetSelection();this.__cG.exclude();};}
,__tH:function(){var eT=this._iframe.getWindow();var eS;if(eT&&eT.qx){eS=eT.qx.dev.ObjectSummary.getInfo();}
else {eS=bB;}
;var eU=new qx.ui.form.TextArea(eS);eU.setDecorator(null);eU.setAutoSize(true);eU.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__ts.setContent(eU);this.__ts.setWidth(400);this.__ts.show();}
,__tI:function(){var eV=this._iframe.getSource();eV=eV.substr(0,eV.indexOf(M));{eV+=cd+this.__tl;}
;window.open(eV,cB);}
,__tJ:function(eW){var eX=!!eW;var eY=this._tree.getSelection()[0].getUserData(cO);if(eY){eX=eX&&!qx.lang.Array.contains(eY,ck);}
;this.__tu.setEnabled(eX);this.__tv=eW;}
,__tK:function(){if(this.__tv){var fc=this.__tv;var fb=bN+ep+encodeURIComponent(fc)+bs;var fa=this.playgroundUrl+cg+encodeURIComponent(fb);window.open(fa,cB);}
else {var fd=new qx.ui.basic.Label(this.tr(h));this.__ts.setContent(fd);this.__ts.setWidth(200);this.__ts.show();}
;}
,__tL:function(){window.open(dL);}
,__tM:function(){var fe=(cI.split(dT)[0]);window.open(bW+fe);}
,_onHideShowTests:function(event){var fg=window.location.search;var fh=window.location.hash;var ff=bk;if(fg==bY){ff+=cv;}
;ff+=fh;location.replace(ff);}
,__tN:function(e){var fj=this._iframe.getWindow();var fi;if(fj&&fj.qx){fj.qx.core.ObjectRegistry.shutdown();fi=this.tr(ez);}
else {fi=this.tr(dk);}
;var fk=new qx.ui.basic.Label(fi);fk.setRich(true);fk.setWrap(true);this.__ts.setContent(fk);this.__ts.setWidth(350);this.__ts.show();}
,__tO:function(){var fH=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr(dx),cs);this._runbutton.addListener(cc,this.runSample,this);this._runbutton.setToolTipText(C);fH.add(this._runbutton);var fK=new qx.ui.toolbar.Part();fH.add(fK);var ft=new qx.ui.toolbar.Button(this.tr(dv),g);ft.addListener(cc,this.playPrev,this);ft.setToolTipText(dY);fK.add(ft);this._prevButton=ft;var fF=new qx.ui.toolbar.Button(this.tr(dF),E);fF.addListener(cc,this.playNext,this);fF.setToolTipText(dh);fK.add(fF);this._nextButton=fF;var fw={converter:function(fP){return fP==ci;}
};qx.data.SingleValueBinding.bind(this._runbutton,ch,ft,bX,fw);qx.data.SingleValueBinding.bind(this._runbutton,ch,fF,bX,fw);var fN=this._navPart=new qx.ui.toolbar.Part();fH.add(fN);var fO=new qx.ui.toolbar.Button(this.tr(cF),X);fO.addListener(cc,this.__tI,this);fO.setToolTipText(em);this.__tw=fO;fN.add(fO);{var fC=new qx.ui.toolbar.Button(this.tr(U),dA);fC.addListener(cc,this.__tK,this);fC.setToolTipText(q);fC.setEnabled(false);if(qx.core.Environment.get(cu)==dX){fC.exclude();}
;this.__tu=fC;fN.add(fC);var fo=new qx.ui.toolbar.Part();fH.add(fo);var fA=new qx.ui.toolbar.Button(this.tr(eh),dU);fo.add(fA);fA.setToolTipText(this.tr(bG));fA.addListener(cc,this.__tL,this);var fm=new qx.ui.toolbar.Button(this.tr(bh),w);fo.add(fm);fm.setToolTipText(this.tr(cr));fm.addListener(cc,this.__tM,this);}
;var fI=new qx.ui.toolbar.Part;fH.add(fI);{var fE=new qx.ui.menu.Menu;this.__tz=fE;var fu=new qx.ui.menu.RadioButton(el);var fL=new qx.ui.menu.RadioButton(bP);var fM=new qx.ui.menu.RadioButton(dO);var fJ=new qx.ui.menu.RadioButton(dm);fu.setUserData(cb,ba);fL.setUserData(cb,eq);fM.setUserData(cb,K);fJ.setUserData(cb,cz);fJ.setValue(true);var fx=new qx.ui.form.RadioGroup(fu,fL,fM,fJ);fx.addListener(cL,this.__ua,this);fE.add(fJ);fE.add(fu);fE.add(fL);fE.add(fM);var fv=new qx.ui.toolbar.MenuButton(this.tr(L),ee,fE);this.__ty=fI;fv.setToolTipText(eA);fI.add(fv);}
;var fy=new qx.ui.menu.Menu;{var fz=new qx.ui.menu.Button(this.tr(f));this.__tC=fz;fz.setCommand(this._cmdObjectSummary);fy.add(fz);}
;var fr=new qx.ui.menu.Button(this.tr(bo));this.__tA=fr;fr.setCommand(this._cmdDisposeSample);fy.add(fr);{fy.addSeparator();var fp=new qx.ui.menu.CheckBox(this.tr(by));fp.setValue(!!qx.core.Environment.get(Y));fp.addListener(N,this._onHideShowTests,this);fy.add(fp);}
;var fs=new qx.ui.toolbar.MenuButton(this.tr(y),S,fy);this.__tB=fs;fs.setToolTipText(bl);fI.add(fs);var fB=new qx.ui.toolbar.Part;this.__tx=fB;fH.addSpacer();fH.add(fB);{var fG=new qx.ui.toolbar.RadioButton(cn,bw);fG.setToolTipText(cx);fG.setModel(bR);var fq=new qx.ui.toolbar.RadioButton(bu,bv);fq.setToolTipText(dD);fq.setModel(bJ);fG.setUserData(cb,cj);fq.setUserData(cb,cV);fB.add(fG);fB.add(fq);}
;var fD=new qx.ui.toolbar.RadioButton(er,D);fD.setToolTipText(A);fD.setUserData(cb,bq);fD.setModel(bS);fB.add(fD);var fl=this.__tE=new qx.ui.form.RadioGroup;fl.setAllowEmptySelection(true);fl.add(fD);fl.addListener(cy,this.__tG,this);{fl.add(fG,fq);}
;fH.setOverflowHandling(true);var fn=new qx.ui.toolbar.MenuButton(null,dW);fn.setAppearance(bQ);fH.add(fn);fH.setOverflowIndicator(fn);fH.setRemovePriority(fB,6);fH.setRemovePriority(fI,5);fH.setRemovePriority(fo,4);fH.setRemovePriority(fN,3);fH.setRemovePriority(fK,2);fH.setRemovePriority(this._navPart,1);this.__lK=new qx.ui.menu.Menu();fn.setMenu(this.__lK);fH.addListener(bF,this._onHideItem,this);fH.addListener(bg,this._onShowItem,this);return fH;}
,_onHideItem:function(e){var fQ=e.getData();var fR=this._getMenuItems(fQ);for(var i=0,l=fR.length;i<l;i++){fR[i].setVisibility(ci);if(fQ===this.__ty&&!(fR[i] instanceof qx.ui.menu.Separator)){fR[i].getMenu().setPosition(bI);}
;}
;}
,_onShowItem:function(e){var fS=e.getData();var fU=this._getMenuItems(fS);for(var i=0,l=fU.length;i<l;i++){fU[i].setVisibility(dE);}
;if(fS===this.__ty){var fT=fS.getMenuButtons();for(var i=0,l=fT.length;i<l;i++){fT[i].getMenu().setPosition(en);}
;}
;}
,_getMenuItems:function(fV){var fX=[];if(fV instanceof qx.ui.toolbar.Part){var gd=fV.getChildren();var gc=null;var fW=false;var fY=this.__lK.getChildren();if(fV!=this.__tx){gc=this.__lI[fV.toHashCode()];if(!gc){gc=new qx.ui.menu.Separator();this.__lK.addBefore(gc,fY[0]);this.__lI[fV.toHashCode()]=gc;}
;fX.push(gc);}
else {fW=true;}
;for(var i=0,l=gd.length;i<l;i++){if(gd[i].getVisibility()==bz){continue;}
;var ga=this.__lI[gd[i].toHashCode()];if(!ga){if(gd[i] instanceof qx.ui.toolbar.RadioButton){ga=new qx.ui.menu.RadioButton(gd[i].getLabel());ga.setToolTipText(gd[i].getToolTipText());ga.setEnabled(gd[i].getEnabled());ga.setUserData(bm,gd[i].getUserData(bm));ga.setModel(gd[i].getModel());gd[i].bind(bX,ga,bX);gd[i].bind(cb,ga,cb);ga.bind(cb,gd[i],cb);if(!this.__tD){this.__tD=new qx.ui.form.RadioGroup();this.__tD.setAllowEmptySelection(true);this.__tD.addListener(cy,this.__tG,this);}
;this.__tD.add(ga);}
else if(gd[i] instanceof qx.ui.toolbar.MenuButton){ga=new qx.ui.menu.Button(gd[i].getLabel().translate(),gd[i].getIcon(),gd[i].getCommand(),gd[i].getMenu());ga.setToolTipText(gd[i].getToolTipText());ga.setEnabled(gd[i].getEnabled());gd[i].bind(bX,ga,bX);}
else if(gd[i] instanceof qx.ui.toolbar.Button){ga=new qx.ui.menu.Button(gd[i].getLabel().translate(),gd[i].getIcon());ga.getChildControl(d,false).setRich(true);ga.setTextColor(gd[i].getTextColor());ga.setToolTipText(gd[i].getToolTipText());ga.setEnabled(gd[i].getEnabled());gd[i].bind(bX,ga,bX);var gb=qx.event.Registration.getManager(gd[i]).getListeners(gd[i],cY);if(gb&&gb.length>0){for(var j=0,k=gb.length;j<k;j++){ga.addListener(cY,qx.lang.Function.bind(gb[j].handler,gb[j].context));}
;}
;}
else if(gd[i] instanceof qx.ui.toolbar.CheckBox){ga=new qx.ui.menu.CheckBox(gd[i].getLabel());ga.setToolTipText(gd[i].getToolTipText());ga.setEnabled(gd[i].getEnabled());gd[i].bind(bX,ga,bX);}
else {ga=new qx.ui.menu.Separator();}
;if(fW){this.__lK.add(ga);}
else {this.__lK.addBefore(ga,gc);}
;this.__lI[gd[i].toHashCode()]=ga;}
;fX.push(ga);}
;}
;return fX;}
,__tP:function(){var ge=new qx.ui.embed.Iframe().set({nativeContextMenu:true});ge.addListener(cR,this.__tU,this);this._iframe=ge;return ge;}
,__tQ:function(){var gf=new qx.ui.embed.Html(dz);gf.setOverflow(bb,bb);gf.setFont(br);gf.setBackgroundColor(cU);this.widgets[dc]=gf;gf.getContentElement().setAttribute(cA,cW);return gf;}
,__tR:function(){var gg=new qx.ui.embed.Html(ej);gg.setOverflow(bb,bb);gg.setFont(br);gg.setBackgroundColor(cU);this.widgets[cS]=gg;gg.getContentElement().setAttribute(cA,cW);return gg;}
,__tS:function(){var gi=new qx.ui.tree.Tree();var gh=new qx.ui.tree.TreeFolder(dQ);gi.setAppearance(dp);gi.setRoot(gh);this.tree=this.widgets[bV]=gi;gi.addListener(cL,this.treeGetSelection,this);gi.addListener(ct,function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return gi;}
,__tT:function(){var gj=new qx.ui.window.Window(this.tr(F),cT);gj.setLayout(new qx.ui.layout.VBox(10));gj.setAllowMaximize(false);gj.setAllowMinimize(false);var gm=new qx.ui.basic.Label(bY);gm.setSelectable(true);gm.setNativeContextMenu(true);gj.add(gm);this._urlWindow=gj;var gn=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(gn<0){gn=0;}
;var top=Math.ceil((qx.bom.Viewport.getHeight()/2)-25);if(top<0){top=0;}
;gj.moveTo(gn,top);this.getApplicationRoot().add(gj);var gk=new qx.ui.menu.Menu();var gl=new qx.ui.menu.Button(this.tr(ey),cT);gl.addListener(cc,function(e){var gp=this.tree.getSelection()[0];var gr=gp.getUserData(cP);var go=this.tests.handler.getFullName(gr);go=go.replace(P,de);var gq=location.protocol+ea+location.host+location.pathname+cg+go;this._urlWindow.getChildren()[0].setValue(gq);this._urlWindow.open();}
,this);gk.add(gl);this._tree.setContextMenu(gk);}
,treeGetSelection:function(e){var gs=this.tree.getSelection()[0];this._runbutton.setEnabled(!gs.hasChildren());var gt=gs.getUserData(cP);this.tests.selected=this.tests.handler.getFullName(gt);}
,leftReloadTree:function(e){this._sampleToTreeNodeMap={};var gu=this._sampleToTreeNodeMap;var gA=null;var gC=null;var gz=this._history.getState();var gx=gz.match(/([^~]+)~/);if(gx){gA=gx[1];}
else {var gv=gz.match(/([^~][\w]*)/);if(gv){gA=gv[1];}
;}
;function gB(gD,gE){var gI=gE.getChildren();var t;for(var i=0;i<gI.length;i++){var gF=gI[i];if(gF.hasChildren()){t=new qx.ui.tree.TreeFolder(gw.polish(gF.label));t.setUserData(dM,false);t.setUserData(O,gF);gB(t,t.getUserData(O));if(gF.label==gA){gC=t;t.setOpen(true);}
;}
else {if(!gF.type){continue;}
;t=new qx.ui.tree.TreeFile(gw.polish(gF.label));var gH=gF.pwd().slice(1).join(ca)+ca+gF.label;if(gF.tags){var j,m,gG;t.setUserData(cO,gF.tags);{}
;}
;gu[gH]=t;}
;gD.add(t);t.setUserData(cP,gF);gF.widgetLinkFull=t;}
;}
;var gy=this.tests.handler.ttree;var gw=this;this.tree.setUserData(cP,gy);this.tree.getRoot().setOpen(true);gB(this.tree.getRoot(),gy);{}
;if(gC!=null){this.tree.setSelection([gC]);}
else {this.tree.setSelection([this.tree.getRoot()]);}
;}
,runSample:function(e){if(this.tests.selected&&this.tests.selected!=bY){var gJ=this.tests.selected.replace(P,ca);this.setCurrentSample(gJ);}
else {this.playNext();}
;}
,setCurrentSample:function(gK){if(!gK){return;}
;if(!this._sampleToTreeNodeMap){return;}
;var gL;var gN=this._sampleToTreeNodeMap[gK];if(gN){gN.getTree().setSelection([gN]);gL=b+gK;{gL+=cd+this.__tl;}
;var gM=gN.getUserData(cO);if(gM){this.__tu.setEnabled(!qx.lang.Array.contains(gM,ck));}
;}
else {gL=this.defaultUrl;}
;if(this._iframe.getSource()==gL){this._iframe.reload();}
else {this.__tt=false;this.__ty.getChildren()[0].setEnabled(false);this.__ty.getChildren()[1].setEnabled(false);this._iframe.setSource(gL);this._iframe.addListener(cR,function(){window.setTimeout(function(){var gO=this._iframe.getWindow();if(gO&&gO.qx&&gO.qx.theme&&gO.qx.theme.manager&&gO.qx.theme.manager.Meta){this.__ty.getChildren()[0].setEnabled(true);this.__ty.getChildren()[1].setEnabled(true);}
;}
.bind(this),333);}
,this);}
;if(gL==this.defaultUrl){this.disableMenuButtons();}
else {this.enableMenuButtons();}
;this._currentSample=gK;this._currentSampleUrl=gL;}
,__tU:function(){var gS=this._iframe.getWindow();var gY=this._iframe.getSource();if(gY!=null&&gY!=this.defaultUrl){var gR;try{gR=gS.location.href;}
catch(hb){gR=window.location.href;var ha=gR.lastIndexOf(ca);if(ha!=-1){gR=gR.substring(0,ha+1);}
;gR+=gY;}
;var gW=gR.indexOf(cN)+6;var gT=gR.indexOf(M);gT=gT==-1?gR.length:gT;var gU=gR.substring(gW,gT).split(ca);var gX=String.fromCharCode(187);if(gU.length==2){var gP=gU[0];gP=gP.charAt(0).toUpperCase()+gP.substring(1);var gV=gU[1].replace(cf,bY).replace(/_/g,bd);gV=gV.charAt(0).toUpperCase()+gV.substring(1);var gQ=cX+gX+bn+gX+bd+gP+bd+gX+bd+gV;}
else {var gQ=cX+gX+bn+gX+df;}
;document.title=gQ;}
;}
,__tV:function(e){var hc=this._iframe.getWindow();try{if(hc&&hc.qx&&hc.qx.log&&hc.qx.log.appender){if(!this.__tt){this.__tt=true;this.debug("Demo loaded: "+this._currentSample);this.__tp.clear();try{this.__tp.fetch(hc.qx.log.Logger);}
catch(hd){return;}
;this._history.addToHistory(this._currentSample.replace(ca,de),document.title);if(this._currentSampleUrl!=this.defaultUrl){this.__tW(this._currentSampleUrl);}
;}
;}
else {this.__tt=false;}
;}
catch(he){this.__tt=false;}
;}
,filter:function(hf){var hn=new RegExp(dN+hf+bH,bA);var hl=this._tree.getRoot().getItems(true,true);var hm=0;var hg=0;for(var i=0;i<hl.length;i++){var ho=hl[i];var parent=ho.getParent();var hk=ho.getUserData(cO);var hh=false;if(hk!=null){for(var j=0;j<hk.length;j++){hh=!!hk[j].match(hn);if(hh){break;}
;}
;}
;if(ho.getChildren().length==0){hg++;}
;if((hh||(ho.getLabel().search(hn)!=-1)||(parent.getLabel().search(hn)!=-1))){if(ho.getChildren().length==0){hm++;}
;ho.show();ho.getParent().setOpen(true);ho.getParent().show();}
else {ho.exclude();}
;}
;if(hf==bY){var hj=this._tree.getRoot().getItems(false,true);var hi=this._tree.getSelection();for(var i=0;i<hj.length;i++){if(hj[i]==hi[0]||hj[i]==hi[0].getParent()){continue;}
;hj[i].setOpen(false);}
;}
;this._status.setValue(hm+ca+hg);}
,__tW:function(hp){if(typeof (hp)!=eo){return;}
;var hq=new qx.io.request.Xhr(hp);hq.setTimeout(180000);hq.addListener(cK,function(hr){var content=hr.getTarget().getResponse();if(content){{var hu=content.indexOf(cl,content.indexOf(cl)+7);var hA=content.indexOf(dS,hu);var ht=content.indexOf(dg,hA+5);var hv=content.substring(hA+5,ht);var hy=hv.substring(4,hv.length-3)+bc;var u=B;var hx=hp.split(cG);var hw=hx[1];var hz=hx[2];hz=hz.substr(0,hz.indexOf(du));u+=P+hw+P+hz+bc;hy=u;var hs=new qx.io.request.Xhr(hy);hs.setTimeout(18000);hs.addListener(cK,function(){var hB=hs.getResponse();this.__tJ(hB);if(hB){this.widgets[cS].setHtml(this.__tX(hB,ce));}
;}
,this);hs.addListener(cQ,function(){this.error("Couldn't load file: "+hp);}
,this);hs.send();this.widgets[dc].setHtml(this.__tX(content));}
;}
;}
,this);hq.addListener(cQ,function(hC){this.error("Couldn't load file: "+hp);}
,this);hq.send();}
,dataLoader:function(hD){var hE=new qx.io.request.Xhr(hD);hE.setTimeout(180000);hE.addListener(cK,function(hF){var content=hF.getTarget().getResponse();if(!content){if(window.location.protocol==bj){alert("Failed to load demo data from the file system.\n\n"+"The security settings of your browser may prohibit AJAX "+"when using the file protocol. Please try the http protocol "+"instead.");}
;return;}
;var hG=eval(content);qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(hG);this.leftReloadTree();var hH=this._history.getState();if(hH){this.setCurrentSample(hH.replace(de,ca));}
else {this.setCurrentSample(this.defaultUrl);}
;}
,this,0);}
,this);hE.addListener(cQ,function(hI){this.error("Couldn't load file: "+hD);}
,this);hE.send();}
,playPrev:function(e){var hM=this.tree.getSelection()[0];if(hM){var hJ=this.tree.getPreviousNodeOf(hM,false);if(!hJ||hJ==this.tree.getRoot()){return;}
;while(hJ.isVisible&&!hJ.isVisible()){hJ=this.tree.getPreviousNodeOf(hJ,false);}
;if(hJ.getParent()==this.tree.getRoot()){var hL=this.tree.getPreviousNodeOf(hJ,false);while(hL.isVisible&&!hL.isVisible()){hL=this.tree.getPreviousNodeOf(hL,false);}
;if(hL.getParent()==this.tree.getRoot()){hL.setOpen(true);var hK=this.tree.getPreviousNodeOf(hJ,false);while(hK.isVisible&&!hK.isVisible()){hK=this.tree.getPreviousNodeOf(hK,false);}
;if(hL!==hK){hJ=hK;}
;}
else {hJ=hL;}
;}
;if(!hJ||hJ===hM){return;}
else {this.tree.setSelection([hJ]);this.runSample();}
;}
;}
,playNext:function(e){this._nextButton.setEnabled(true);this._prevButton.setEnabled(true);var hP=this.tree.getSelection()[0];if(hP){var hN=this.tree.getNextNodeOf(hP);if(!hN){return;}
;if(hN.getParent()==this.tree.getRoot()){hN.setOpen(true);hN=this.tree.getNextNodeOf(hN);}
;if(!hN){return;}
;while(!hN.isVisible()){var hO=this.tree.getNextNodeOf(hN);if(!hO){return;}
;if(hO.getParent()==this.tree.getRoot()){hN.setOpen(true);var hO=this.tree.getNextNodeOf(hO);}
;hN=hO;}
;if(hN){this.tree.setSelection([hN]);this.runSample();}
;}
;}
,__tX:function(hQ,hR){var hS=new qx.util.StringBuilder(et);var hU=[];var hV=new qx.util.StringBuilder();var hW=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var hT=/^\s*<\/script>\s*$/i;hQ=hQ.replace(/\r\n/g,dd).replace(/\r/g,dd);var hU=hQ.split(bC);if(hR==ce){return be+qx.dev.Tokenizer.javaScriptToHtml(hQ)+G;}
;for(var i=0;i<hU.length;i++){if(hW.exec(hU[i])){hS.add(this.__tY(qx.bom.String.escape(hV.get()+hU[i])));hV.clear();}
else if(hT.exec(hU[i])){var hX=qx.dev.Tokenizer.javaScriptToHtml(hV.get());hS.add(ew,hX,dP);hV.clear();hV.add(hU[i],bC);}
else {hV.add(hU[i],bC);}
;}
;hS.add(this.__tY(qx.bom.String.escape(hV.get())),bE);return hS.get();}
,disableMenuButtons:function(){var hY=this.__tq;for(var i=0;i<hY.length;i++){hY[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var ia=this.__tq;for(var i=0;i<ia.length;i++){ia[i].setEnabled(true);}
;}
,__tY:function(ib){var id=ib;function ic(ie){var s=new qx.util.StringBuilder(arguments[1],dw,arguments[2],J);var ig;var ih=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){ig=arguments[i];if(ig==ca){ih=true;break;}
else {var m=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;var r;while((r=m.exec(ig))!=null){s.add(a,r[1],ec,r[2].replace(/\s*$/,bY),J);}
;}
;}
;s.add((ih?ca:bY));}
;s.add(dj);return s.get();}
;id=id.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,ic);return id;}
,polish:function(ii){return ii.replace(cf,bY).replace(/_/g,bd);}
,__ua:function(e){this.__tl=e.getData()[0].getUserData(cb);var ik=this._iframe.getWindow();var ij=ik.qx.Theme.getByName(this.__tl);if(ij&&ik.qx.theme.manager&&ik.qx.theme.manager.Meta){ik.qx.theme.manager.Meta.getInstance().setTheme(ij);}
;}
,_createHeader:function(){var io=new qx.ui.layout.HBox();var il=new qx.ui.container.Composite(io);il.setAppearance(cp);var ip=new qx.ui.basic.Label(bp);var im=new qxc.ui.versionlabel.VersionLabel();im.setFont(bM);il.add(ip);il.add(new qx.ui.core.Spacer,{flex:1});il.add(im);return il;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(n,v,H,ei,T,x,bx,dl,eu,cC,dC,di,cM,Q,W,bL,bU,ef,cq,dR,dI,V,dy,dK,dJ,eb,dr,dt,p,I,dB,z,dH,bK,ed,bt,c,cH,dq,dV);}
});}
)();
...
;}
,properties:{alignY:{check:[e,a,o],init:e,apply:d},alignX:{check:[f,r,c],init:f,apply:d},spacing:{check:j,init:0,apply:d},separator:{check:s,nullable:true,apply:d},reversed:{check:g,init:false,apply:q}},members:{__lS:null,__lT:null,__lU:null,__fU:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__lV:function(){var B=this._getLayoutChildren();var length=B.length;var x=false;var w=this.__lS&&this.__lS.length!=length&&this.__lT&&this.__lS;var z;var y=w?this.__lS:new Array(length);var A=w?this.__lT:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__lS=y;this.__lT=A;}
;this.__lU=x;this.__fU=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(E,F){if(this._invalidChildrenCache){this.__lV();}
;var M=this.__fU;var length=M.length;var W=qx.ui.layout.Util;var V=this.getSpacing();var ba=this.getSeparator();if(ba){var J=W.computeVerticalSeparatorGaps(M,V,ba);}
else {var J=W.computeVerticalGaps(M,V,true);}
;var i,H,I,Q;var R=[];var X=J;for(i=0;i<length;i+=1){Q=this.__lS[i];I=Q!=null?Math.floor((F-J)*Q):M[i].getSizeHint().height;R.push(I);X+=I;}
;if(this.__lU&&X!=F){var O={};var U,Y;for(i=0;i<length;i+=1){U=this.__lT[i];if(U>0){N=M[i].getSizeHint();O[i]={min:N.minHeight,value:R[i],max:N.maxHeight,flex:U};}
;}
...
;var bj=qx.ui.layout.Util;var br=this.__fU;var bf=0,bi=0,bh=0;var bd=0,bk=0;var bo,be,bq;for(var i=0,l=br.length;i<l;i+=1){bo=br[i];be=bo.getSizeHint();bi+=be.height;var bn=this.__lT[i];var bg=this.__lS[i];if(bn){bf+=be.minHeight;}
...
},destruct:function(){this.__lS=this.__lT=this.__fU=null;}
});}
)();
(function(){var k="mousedown",j="mouseout",i="Integer",h="height",g="mousemove",f="move",d="maxHeight",c="resize",b="width",a="_applyOrientation",D="_applyOffset",C="splitpane",B="qx.ui.splitpane.Pane",A="top",z="minHeight",w="mouseup",v="minWidth",u="appear",t="losecapture",s="left",q="maxWidth",r="px",o="vertical",p="knob",m="horizontal",n="slider",l="splitter";qx.Class.define(B,{extend:qx.ui.core.Widget,construct:function(E){qx.ui.core.Widget.call(this);this.__fU=[];if(E){this.setOrientation(E);}
else {this.initOrientation();}
;this.__kP.addListener(k,this._onMouseDown,this);this.__kP.addListener(w,this._onMouseUp,this);this.__kP.addListener(g,this._onMouseMove,this);this.__kP.addListener(j,this._onMouseOut,this);this.__kP.addListener(t,this._onMouseUp,this);}
,properties:{appearance:{refine:true,init:C},offset:{check:i,init:6,apply:D},orientation:{init:m,check:[m,o],apply:a}},members:{__rX:null,__rY:false,__sa:null,__sb:null,__ng:null,__sc:null,__sd:null,__fU:null,__kP:null,_createChildControlImpl:function(F,G){var H;switch(F){case n:H=new qx.ui.splitpane.Slider(this);H.exclude();this._add(H,{type:F});break;case l:H=new qx.ui.splitpane.Splitter(this);this._add(H,{type:F});H.addListener(f,this.__se,this);break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);}
,__se:function(e){this.__sg(e.getData());}
,__sf:function(I){this.__kP=new qx.ui.splitpane.Blocker(I);this.getContentElement().add(this.__kP);var J=this.getChildControl(l);var K=J.getWidth();if(!K){J.addListenerOnce(u,function(){this.__sg();}
,this);}
;J.addListener(c,function(e){var L=e.getData();if(L.height==0||L.width==0){this.__kP.hide();}
else {this.__kP.show();}
;}
,this);}
,getBlocker:function(){return this.__kP;}
,_applyOrientation:function(M,N){var O=this.getChildControl(n);var R=this.getChildControl(l);this.__ng=M===m;if(!this.__kP){this.__sf(M);}
;this.__kP.setOrientation(M);var Q=this._getLayout();if(Q){Q.dispose();}
;var P=M===o?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;this._setLayout(P);R.removeState(N);R.addState(M);R.getChildControl(p).removeState(N);R.getChildControl(p).addState(M);O.removeState(N);O.addState(M);qx.ui.core.queue.Manager.flush();this.__sg();}
,_applyOffset:function(S,T){this.__sg();}
,__sg:function(U){var V=this.getChildControl(l);var ba=this.getOffset();var bb=V.getBounds();var Y=V.getContainerElement().getDomElement();if(!Y){return;}
;if(this.__ng){var X=null;if(U){X=U.width;}
else if(bb){X=bb.width;}
;var bc=U&&U.left;if(X){if(isNaN(bc)){bc=qx.bom.element.Location.getPosition(Y).left;}
;this.__kP.setWidth(ba,X);this.__kP.setLeft(ba,bc);}
;}
...
;this.__kP.setHeight(ba,W);this.__kP.setTop(ba,top);}
;}
;}
,add:function(bd,be){if(be==null){this._add(bd);}
else {this._add(bd,{flex:be});}
;this.__fU.push(bd);}
,remove:function(bf){this._remove(bf);qx.lang.Array.remove(this.__fU,bf);}
,getChildren:function(){return this.__fU;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;var bg=this.getChildControl(l);var bi=bg.getContainerLocation();var bh=this.getContentLocation();this.__rX=this.__ng?e.getDocumentLeft()-bi.left+bh.left:e.getDocumentTop()-bi.top+bh.top;var bk=this.getChildControl(n);var bj=bg.getBounds();bk.setUserBounds(bj.left,bj.top,bj.width,bj.height);bk.setZIndex(bg.getZIndex()+1);bk.show();this.__rY=true;this.__kP.capture();e.stop();}
,_onMouseMove:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__rY){this.__sh();var bl=this.getChildControl(n);var bm=this.__sc;if(this.__ng){bl.setDomLeft(bm);this.__kP.setStyle(s,(bm-this.getOffset())+r);}
else {bl.setDomTop(bm);this.__kP.setStyle(A,(bm-this.getOffset())+r);}
;e.stop();}
;}
,_onMouseOut:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onMouseUp:function(e){if(!this.__rY){return;}
;this._finalizeSizes();var bn=this.getChildControl(n);bn.exclude();this.__rY=false;this.releaseCapture();e.stop();}
,_finalizeSizes:function(){var br=this.__sc;var bo=this.__sd;if(br==null){return;}
...
else {if(this.__ng){bs.setWidth(br);bp.setWidth(bo);}
else {bs.setHeight(br);bp.setHeight(bo);}
;}
;}
,__sh:function(){if(this.__ng){var bx=v,bE=b,by=q,bC=this.__sa;}
else {var bx=z,bE=h,by=d,bC=this.__sb;}
;var bD=this._getChildren();var bv=bD[2].getSizeHint();var bA=bD[3].getSizeHint();var bB=bD[2].getBounds()[bE]+bD[3].getBounds()[bE];var bz=bC-this.__rX;var bw=bB-bz;if(bz<bv[bx]){bw-=bv[bx]-bz;bz=bv[bx];}
else if(bw<bA[bx]){bz-=bA[bx]-bw;bw=bA[bx];}
;if(bz>bv[by]){bw+=bz-bv[by];bz=bv[by];}
else if(bw>bA[by]){bz+=bw-bA[by];bw=bA[by];}
;this.__sc=bz;this.__sd=bw;}
,_isActiveDragSession:function(){return this.__rY;}
,_setLastMousePosition:function(x,y){this.__sa=x;this.__sb=y;}
},destruct:function(){this.__fU=null;}
});}
)();
...
;if(v){this.setSeparator(v);}
;}
,properties:{alignX:{check:[e,b,j],init:e,apply:d},alignY:{check:[a,r,o],init:a,apply:d},spacing:{check:h,init:0,apply:d},separator:{check:s,nullable:true,apply:d},reversed:{check:m,init:false,apply:q}},members:{__mA:null,__lT:null,__lU:null,__fU:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__lV:function(){var B=this._getLayoutChildren();var length=B.length;var y=false;var w=this.__mA&&this.__mA.length!=length&&this.__lT&&this.__mA;var z;var x=w?this.__mA:new Array(length);var A=w?this.__lT:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__mA=x;this.__lT=A;}
;this.__lU=y;this.__fU=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(E,F){if(this._invalidChildrenCache){this.__lV();}
;var L=this.__fU;var length=L.length;var U=qx.ui.layout.Util;var T=this.getSpacing();var X=this.getSeparator();if(X){var I=U.computeHorizontalSeparatorGaps(L,T,X);}
else {var I=U.computeHorizontalGaps(L,T,true);}
;var i,G,R,Q;var W=[];var M=I;for(i=0;i<length;i+=1){Q=this.__mA[i];R=Q!=null?Math.floor((E-I)*Q):L[i].getSizeHint().width;W.push(R);M+=R;}
;if(this.__lU&&M!=E){var O={};var S,V;for(i=0;i<length;i+=1){S=this.__lT[i];if(S>0){N=L[i].getSizeHint();O[i]={min:N.minWidth,value:W[i],max:N.maxWidth,flex:S};}
;}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__lV();}
;var bj=qx.ui.layout.Util;var br=this.__fU;var bd=0,bk=0,bh=0;var bg=0,bi=0;var bo,be,bq;for(var i=0,l=br.length;i<l;i+=1){bo=br[i];be=bo.getSizeHint();bk+=be.width;var bn=this.__lT[i];var bf=this.__mA[i];if(bn){bd+=be.minWidth;}
...
},destruct:function(){this.__mA=this.__lT=this.__fU=null;}
});}
)();
...
(function(){var m="separator-vertical",k="_applyShowLogLevel",j="Boolean",h="qxc.ui.logpane.LogView",g='',f="Debug",d="Log",c="auto",b="icon/16/actions/edit-clear.png",a="Clear",K="DIV",J="middle",I="icon/16/status/dialog-information.png",H="Warning",G="Log Level",F="Error",E="appear",D="__ud",C="main",B="changeLogLevel",t="Info",u="bold",r="icon/16/status/dialog-error.png",s="monospace",p="icon/16/status/dialog-warning.png",q="scroll",n="warn",o="execute",v="error",w="info",y="model",x="icon/16/categories/system.png",A="white",z="debug";qx.Class.define(h,{extend:qx.ui.container.Composite,construct:function(){this.__ub=[[z,f,x],[w,t,I],[n,H,p],[v,F,r]];var O=new qx.ui.layout.VBox();O.setSeparator(m);qx.ui.container.Composite.call(this,O);this.setDecorator(C);var M=new qx.ui.basic.Label(this.tr(d)).set({font:u,padding:10,alignY:J,allowGrowX:true,allowGrowY:true});this.__uc=new qx.ui.toolbar.ToolBar();this.__uc.add(M);this.__uc.addSpacer();this.__uc.setBackgroundColor(A);var L=new qx.ui.toolbar.Button(this.tr(a),b);L.addListener(o,function(e){this.clear();}
,this);this.__uc.add(L);this.add(this.__uc);var N=new qx.ui.embed.Html(g);N.set({backgroundColor:A,overflowY:q,overflowX:c,font:s,padding:3});this.add(N,{flex:1});this.__ud=new qx.log.appender.Element();qx.log.Logger.unregister(this.__ud);this.__ue=document.createElement(K);this.__ud.setElement(this.__ue);N.addListenerOnce(E,function(){N.getContentElement().getDomElement().appendChild(this.__ue);}
,this);}
,properties:{showLogLevel:{check:j,apply:k,init:false},logLevel:{check:[z,w,n,v],init:z,event:B}},members:{__ue:null,__ud:null,__ub:null,__uf:null,__uc:null,clear:function(){this.__ud.clear();}
,fetch:function(P){if(!P){P=qx.log.Logger;}
;P.register(this.__ud);P.clear();}
,getAppenderElement:function(){return this.__ue;}
,_applyShowLogLevel:function(Q,R){if(!this.__uf){this.__uf=this.__ug();this.__uc.add(this.__uf);}
;if(Q){this.__uf.show();}
else {this.__uf.exclude();}
;}
,__ug:function(){var S=new qx.ui.menu.Menu();var V=new qx.ui.toolbar.MenuButton(G,x);V.setMenu(S);for(var i=0,l=this.__ub.length;i<l;i++){var U=this.__ub[i];var T=new qx.ui.menu.Button(U[1],U[2]);T.setUserData(y,U[0]);T.addListener(o,function(W){var X=W.getTarget();this.setLogLevel(X.getUserData(y));V.setIcon(X.getIcon());}
,this);S.add(T);}
;return V;}
},destruct:function(){this._disposeObjects(D);this.__ue=null;}
});}
)();
...
;var N=L.getMarginLeft()+L.getMarginRight();N=Math.max(N,this.getSpacing());var I=L.getSizeHint().width+N;this.__pI(L);D-=I;if(E&&E.getVisibility()!=o){E.setVisibility(o);D+=K;var G=E.getMarginLeft()+E.getMarginRight();D+=Math.max(G,this.getSpacing());}
;}
while(D>C);}
else if(this.__pF.length>0){do {var O=this.__pF[0];if(O){var N=O.getMarginLeft()+O.getMarginRight();N=Math.max(N,this.getSpacing());if(O.getDecoratorElement()==null){O.syncAppearance();O.invalidateLayoutCache();}
;var H=O.getSizeHint().width;var M=false;if(this.__pF.length==1&&K>0){var F=N-this.getSpacing();var J=D-K+H+F;M=C>J;}
;if(C>D+H+N||M){this.__pH(O);D+=H;if(E&&this.__pF.length==0){E.setVisibility(n);}
;}
else {return;}
;}
;}
while(C>=D&&this.__pF.length>0);}
;}
,__pH:function(P){P.setVisibility(o);this.__pF.shift();this.fireDataEvent(c,P);}
,__pI:function(Q){if(!Q){return;}
;this.__pF.unshift(Q);Q.setVisibility(n);this.fireDataEvent(t,Q);}
,_getNextToHide:function(){for(var i=this.__pG.length-1;i>=0;i--){var R=this.__pG[i];if(R&&R.getVisibility&&R.getVisibility()==o){return R;}
;}
...
;}
;}
,setRemovePriority:function(U,V,W){if(!W&&this.__pG[V]!=undefined){throw new Error("Priority already in use!");}
;this.__pG[V]=U;}
...
;bc.setVisibility(n);}
;}
,__pJ:false,_setAllowMenuOpenHover:function(be){this.__pJ=be;}
...
(function(){var w="blur",v="Enter",u="__oI",t="mousewheel",s="Up",r="__pq",q="Space",p="Escape",o="event.touch",n="qx.ui.menu.Manager",f="Left",m="__pp",j="Down",c="Right",b="singleton",h="mousedown",g="interval",k="keydown",a="keyup",l="qx.debug",d="keypress";qx.Class.define(n,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__oI=[];var x=document.body;var y=qx.event.Registration;y.addListener(window.document.documentElement,h,this._onMouseDown,this,true);y.addListener(x,t,this._onMouseWheel,this,true);y.addListener(x,k,this._onKeyUpDown,this,true);y.addListener(x,a,this._onKeyUpDown,this,true);y.addListener(x,d,this._onKeyPress,this,true);if(!qx.core.Environment.get(o)){qx.bom.Element.addListener(window,w,this.hideAll,this);}
;this.__pp=new qx.event.Timer;this.__pp.addListener(g,this._onOpenInterval,this);this.__pq=new qx.event.Timer;this.__pq.addListener(g,this._onCloseInterval,this);}
,members:{__pr:null,__ps:null,__pp:null,__pq:null,__oI:null,_getChild:function(z,A,B,C){var D=z.getChildren();var length=D.length;var E;for(var i=A;i<length&&i>=0;i+=B){E=D[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
...
;}
;var I=this.__oI;I.push(H);H.setZIndex(1e6+I.length);}
,remove:function(J){if(qx.core.Environment.get(l)){if(!(J instanceof qx.ui.menu.Menu)){throw new Error("Object is no menu: "+J);}
;}
;var K=this.__oI;if(K){qx.lang.Array.remove(K,J);}
;}
,hideAll:function(){var L=this.__oI;if(L){for(var i=L.length-1;i>=0;i--){L[i].exclude();}
;}
;}
,getActiveMenu:function(){var M=this.__oI;return M.length>0?M[M.length-1]:null;}
,scheduleOpen:function(N){this.cancelClose(N);if(N.isVisible()){if(this.__pr){this.cancelOpen(this.__pr);}
;}
else if(this.__pr!=N){this.__pr=N;this.__pp.restartWith(N.getOpenInterval());}
;}
,scheduleClose:function(O){this.cancelOpen(O);if(!O.isVisible()){if(this.__ps){this.cancelClose(this.__ps);}
;}
else if(this.__ps!=O){this.__ps=O;this.__pq.restartWith(O.getCloseInterval());}
;}
,cancelOpen:function(P){if(this.__pr==P){this.__pp.stop();this.__pr=null;}
;}
,cancelClose:function(Q){if(this.__ps==Q){this.__pq.stop();this.__ps=null;}
;}
,_onOpenInterval:function(e){this.__pp.stop();this.__pr.open();this.__pr=null;}
,_onCloseInterval:function(e){this.__pq.stop();this.__ps.exclude();this.__ps=null;}
...
;if(this.__oI.length>0&&!this._isInMenu(R)){this.hideAll();}
;}
,__pt:{"Enter":1,"Space":1},__ms:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var S=this.getActiveMenu();if(!S){return;}
;var T=e.getKeyIdentifier();if(this.__ms[T]||(this.__pt[T]&&S.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var U=this.getActiveMenu();if(!U){return;}
;var V=e.getKeyIdentifier();var X=this.__ms[V];var W=this.__pt[V];if(X){switch(V){case s:this._onKeyPressUp(U);break;case j:this._onKeyPressDown(U);break;case f:this._onKeyPressLeft(U);break;case c:this._onKeyPressRight(U);break;case p:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(W){var Y=U.getSelectedButton();if(Y){switch(V){case v:this._onKeyPressEnter(U,Y,e);break;case q:this._onKeyPressSpace(U,Y,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
...
;}
,_onMouseWheel:function(e){var bF=e.getTarget();bF=qx.ui.core.Widget.getWidgetByElement(bF,true);if(this.__oI.length>0&&!this._isInMenu(bF)){this.hideAll();}
;}
},destruct:function(){var bH=qx.event.Registration;var bG=document.body;bH.removeListener(window.document.documentElement,h,this._onMouseDown,this,true);bH.removeListener(bG,k,this._onKeyUpDown,this,true);bH.removeListener(bG,a,this._onKeyUpDown,this,true);bH.removeListener(bG,d,this._onKeyPress,this,true);this._disposeObjects(m,r);this._disposeArray(u);}
});}
)();
(function(){var l="indexOf",k="addAfter",j="add",i="addBefore",h="_",g="addAt",f="hasChildren",e="removeAt",d="removeAll",c="getChildren",a="remove",b="qx.ui.core.MRemoteChildrenHandling";qx.Mixin.define(b,{members:{__pu:function(m,n,o,p){var q=this.getChildrenContainer();if(q===this){m=h+m;}
;return (q[m])(n,o,p);}
,getChildren:function(){return this.__pu(c);}
,hasChildren:function(){return this.__pu(f);}
,add:function(r,s){return this.__pu(j,r,s);}
,remove:function(t){return this.__pu(a,t);}
,removeAll:function(){return this.__pu(d);}
,indexOf:function(u){return this.__pu(l,u);}
,addAt:function(v,w,x){this.__pu(g,v,w,x);}
,addBefore:function(y,z,A){this.__pu(i,y,z,A);}
,addAfter:function(B,C,D){this.__pu(k,B,C,D);}
,removeAt:function(E){return this.__pu(e,E);}
}});}
)();
...
;this.__px();}
,__px:function(){if(this.isVisible()){if(this.getBlockBackground()){var S=this.getZIndex();this._blocker.blockContent(S-1);}
;}
...
,__py:function(){var bk=this._getMenuBounds();if(!bk){this.addListenerOnce(o,this.__py,this);return;}
...
;this.__pw=bm;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bn){this.getChildControl(m);if(this.__pw){this.__pw.call(this);delete this.__pw;}
;}
...
;this.__py();}
;}
,_onMouseOver:function(e){var bq=qx.ui.menu.Manager.getInstance();bq.cancelClose(this);var br=e.getTarget();if(br.isEnabled()&&br instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(br);var bp=br.getMenu&&br.getMenu();if(bp){bp.setOpener(br);bq.scheduleOpen(bp);this.__pv=bp;}
else {var bs=this.getOpenedButton();if(bs){bq.scheduleClose(bs.getMenu());}
;if(this.__pv){bq.cancelOpen(this.__pv);this.__pv=null;}
;}
;}
...
;if(this.__pv){bt.cancelOpen(this.__pv);}
;}
;}
...
;var u=this.__pA(w[0]);var x=u.getColumnSizes();var r=u.getSpacingX();var q=qx.lang.Array.sum(x)+r*(x.length-1);if(q<k){x[1]+=k-q;}
...
;}
;}
,__pA:function(z){while(!(z instanceof qx.ui.menu.Menu)){z=z.getLayoutParent();}
;return z;}
...
(function(){var n="press",m="qx.ui.form.RepeatButton",l="release",k="interval",j="__jQ",i="execute",h="Enter",g="Space",f="hovered",d="qx.event.type.Event",a="Integer",c="abandoned",b="pressed";qx.Class.define(m,{extend:qx.ui.form.Button,construct:function(o,p){qx.ui.form.Button.call(this,o,p);this.__jQ=new qx.event.AcceleratingTimer();this.__jQ.addListener(k,this._onInterval,this);}
,events:{"execute":d,"press":d,"release":d},properties:{interval:{check:a,init:100},firstInterval:{check:a,init:500},minTimer:{check:a,init:20},timerDecrease:{check:a,init:2}},members:{__pB:null,__jQ:null,press:function(){if(this.isEnabled()){if(!this.hasState(b)){this.__pC();}
;this.removeState(c);this.addState(b);}
;}
,release:function(q){if(!this.isEnabled()){return;}
;if(this.hasState(b)){if(!this.__pB){this.execute();}
;}
;this.removeState(b);this.removeState(c);this.__pD();}
,_applyEnabled:function(r,s){qx.ui.form.Button.prototype._applyEnabled.call(this,r,s);if(!r){this.removeState(b);this.removeState(c);this.__pD();}
;}
,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;if(this.hasState(c)){this.removeState(c);this.addState(b);this.__jQ.start();}
;this.addState(f);}
,_onMouseOut:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.removeState(f);if(this.hasState(b)){this.removeState(b);this.addState(c);this.__jQ.stop();}
;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;this.capture();this.__pC();e.stopPropagation();}
,_onMouseUp:function(e){this.releaseCapture();if(!this.hasState(c)){this.addState(f);if(this.hasState(b)&&!this.__pB){this.execute();}
;}
;this.__pD();e.stopPropagation();}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case h:case g:if(this.hasState(b)){if(!this.__pB){this.execute();}
;this.removeState(b);this.removeState(c);e.stopPropagation();this.__pD();}
;};}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case h:case g:this.removeState(c);this.addState(b);e.stopPropagation();this.__pC();};}
,_onInterval:function(e){this.__pB=true;this.fireEvent(i);}
,__pC:function(){this.fireEvent(n);this.__pB=false;this.__jQ.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.removeState(c);this.addState(b);}
,__pD:function(){this.fireEvent(l);this.__jQ.stop();this.removeState(c);this.removeState(b);}
},destruct:function(){this._disposeObjects(j);}
});}
)();
(function(){var e="qx.event.type.Event",d="__jQ",c="qx.event.AcceleratingTimer",b="interval",a="Integer";qx.Class.define(c,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__jQ=new qx.event.Timer(this.getInterval());this.__jQ.addListener(b,this._onInterval,this);}
,events:{"interval":e},properties:{interval:{check:a,init:100},firstInterval:{check:a,init:500},minimum:{check:a,init:20},decrease:{check:a,init:2}},members:{__jQ:null,__pE:null,start:function(){this.__jQ.setInterval(this.getFirstInterval());this.__jQ.start();}
,stop:function(){this.__jQ.stop();this.__pE=null;}
,_onInterval:function(){this.__jQ.stop();if(this.__pE==null){this.__pE=this.getInterval();}
;this.__pE=Math.max(this.getMinimum(),this.__pE-this.getDecrease());this.__jQ.setInterval(this.__pE);this.__jQ.start();this.fireEvent(b);}
...
,events:{update:d,scrollAnimationEnd:d},properties:{scrollX:{check:k,apply:m,event:n,init:0},scrollY:{check:i,apply:l,event:p,init:0}},members:{__mW:null,add:function(r){var s=this._getChildren()[0];if(s){this._remove(s);s.removeListener(a,this._onUpdate,this);}
...
;if(M){if(this.__mW){return;}
;var O=this.getScrollX();this.__mW=new qx.bom.AnimationFrame();this.__mW.on(b,function(){this.setScrollX(L);this.__mW=null;this.fireEvent(c);}
,this);this.__mW.on(f,function(P){var Q=parseInt(P/M*(L-O)+O);this.setScrollX(Q);}
,this);this.__mW.startSequence(M);}
else {this.setScrollX(L);}
;}
,scrollToY:function(R,S){var T=this.getScrollMaxY();if(R<0){R=0;}
else if(R>T){R=T;}
;if(S){if(this.__mW){return;}
;var U=this.getScrollY();this.__mW=new qx.bom.AnimationFrame();this.__mW.on(b,function(){this.setScrollY(R);this.__mW=null;this.fireEvent(c);}
,this);this.__mW.on(f,function(V){var W=parseInt(V/S*(R-U)+U);this.setScrollY(W);}
,this);this.__mW.startSequence(S);}
...
(function(){var i="hover-button",h="interval",g="mouseover",f="mouseout",d="qx.ui.form.HoverButton",c="__jQ",b="hovered",a="Integer";qx.Class.define(d,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(g,this._onMouseOver,this);this.addListener(f,this._onMouseOut,this);this.__jQ=new qx.event.AcceleratingTimer();this.__jQ.addListener(h,this._onInterval,this);}
,properties:{appearance:{refine:true,init:i},interval:{check:a,init:80},firstInterval:{check:a,init:200},minTimer:{check:a,init:20},timerDecrease:{check:a,init:2}},members:{__jQ:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__jQ.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(b);}
,_onMouseOut:function(e){this.__jQ.stop();this.removeState(b);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
,__pK:function(){var x=this.getChildrenContainer().getChildren();x=x.filter(function(y){return y.getVisibility()==k;}
...
,members:{__fH:null,setElement:function(t){this.clear();if(t){qx.bom.element.Class.add(t,k);}
;this.__fH=t;}
,clear:function(){var u=this.__fH;if(u){u.innerHTML=d;}
;}
,process:function(v){var w=this.__fH;if(!w){return;}
...
,__oa:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
(function(){var i="qx.blankpage",h="undefined",g="#",f="hidden",e="qx.bom.HashHistory",d="absolute",c="interval",b="-1000px",a="";qx.Class.define(e,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this._baseUrl=null;this.__sP();}
,members:{__sM:null,__sN:null,__sO:false,addToHistory:function(j,k){if(!qx.lang.Type.isString(j)){j=j+a;}
;if(qx.lang.Type.isString(k)){this.setTitle(k);this._titles[j]=k;}
;if(this.getState()!==j){this._writeState(j);}
;}
,__sP:function(){this.__sN=this.__sQ();document.body.appendChild(this.__sN);this.__sR(function(){this._baseUrl=this.__sN.contentWindow.document.location.href;this.__sS();}
,this);}
,__sQ:function(){var l=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(i))+g});l.style.visibility=f;l.style.position=d;l.style.left=b;l.style.top=b;return l;}
,__sR:function(m,n,o){if(typeof o===h){o=0;}
;if(!this.__sN.contentWindow||!this.__sN.contentWindow.document){if(o>20){throw new Error("can't initialize iframe");}
;qx.event.Timer.once(function(){this.__sR(m,n,++o);}
,this,10);return;}
;this.__sO=true;m.call(n||window);}
,__sS:function(){qx.event.Idle.getInstance().addListener(c,this.__sU,this);}
,__sT:function(){qx.event.Idle.getInstance().removeListener(c,this.__sU,this);}
,__sU:function(){var p=this._readState();if(qx.lang.Type.isString(p)&&p!=this.getState()){this._onHistoryLoad(p);}
;}
,_readState:function(){var q=!this._getHash()?a:this._getHash().substr(1);return this._decode(q);}
,_getHash:function(){if(!this.__sO){return null;}
;return this.__sN.contentWindow.document.location.hash;}
,_writeState:function(r){this._setHash(this._encode(r));}
,_setHash:function(s){if(!this.__sN||!this._baseUrl){return;}
;var t=!this.__sN.contentWindow.document.location.hash?a:this.__sN.contentWindow.document.location.hash.substr(1);if(s!=t){this.__sN.contentWindow.document.location.hash=s;}
;}
},destruct:function(){this.__sT();this.__sN=null;}
});}
)();
...
;return h;}
,__rP:function(F){var G=function(){qx.bom.Event.removeNativeListener(F,a,G);F.$$url=qx.bom.Iframe.queryCurrentUrl(F);}
;qx.bom.Event.addNativeListener(F,a,G);}
}});}
)();
(function(){var p="qx.bom.IframeHistory",o="engine.name",n="mshtml",m="state",l='<html><body><div id="state">',k="browser.version",j="hidden",i="qx.blankpage",h="undefined",g='</div></body></html>',c="absolute",f="request",d="",b="interval",a="-1000px";qx.Class.define(p,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__ta();}
,members:{__sN:null,__sO:false,__sV:null,__sW:null,__sX:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);this.__sX=this._getHash();}
,_setHash:function(q){qx.bom.History.prototype._setHash.call(this,q);this.__sX=this._encode(q);}
...
;}
,_setState:function(u){this.__sW=true;this.setState(u);this.__sW=false;}
,_applyState:function(v,w){if(this.__sW){return;}
;this._writeState(v);}
,_readState:function(){if(!this.__sO){return this._decode(this._getHash());}
;var x=this.__sN.contentWindow.document;var y=x.getElementById(m);return y?this._decode(y.innerText):d;}
,_writeState:function(z){if(!this.__sO){this.__sY();this.__sV=qx.event.Timer.once(function(){this._writeState(z);}
,this,50);return;}
;this.__sY();var z=this._encode(z);if(qx.core.Environment.get(o)==n&&qx.core.Environment.get(k)!=8){this._setHash(z);}
;var A=this.__sN.contentWindow.document;A.open();A.write(l+z+g);A.close();}
,__sY:function(){if(this.__sV){this.__sV.stop();this.__sV.dispose();}
;}
,__ta:function(){this.__sP(function(){qx.event.Idle.getInstance().addListener(b,this.__sU,this);}
);}
,__sU:function(e){var C=null;var B=this._getHash();if(!this.__tc(B)){C=this.__tb(B);}
else {C=this._readState();}
;if(qx.lang.Type.isString(C)&&C!=this.getState()){this._onHistoryLoad(C);}
;}
,__tb:function(D){D=this._decode(D);this._writeState(D);return D;}
,__tc:function(E){return qx.lang.Type.isString(E)&&E==this.__sX;}
,__sP:function(F){this.__sN=this.__sQ();document.body.appendChild(this.__sN);this.__sR(function(){this._writeState(this.getState());if(F){F.call(this);}
;}
,this);}
,__sQ:function(){var G=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(i))});G.style.visibility=j;G.style.position=c;G.style.left=a;G.style.top=a;return G;}
,__sR:function(H,I,J){if(typeof J===h){J=0;}
;if(!this.__sN.contentWindow||!this.__sN.contentWindow.document){if(J>20){throw new Error("can't initialize iframe");}
;qx.event.Timer.once(function(){this.__sR(H,I,++J);}
,this,10);return;}
;this.__sO=true;H.call(I||window);}
},destruct:function(){this.__sN=null;if(this.__sV){this.__sV.dispose();this.__sV=null;}
;qx.event.Idle.getInstance().removeListener(b,this.__sU,this);}
});}
)();
(function(){var d="qx.bom.NativeHistory",c="engine.name",b="hashchange",a="interval";qx.Class.define(d,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__sS();}
,members:{__sM:null,__sS:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__sM=qx.lang.Function.bind(this.__sU,this);qx.bom.Event.addNativeListener(window,b,this.__sM);}
else {qx.event.Idle.getInstance().addListener(a,this.__sU,this);}
;}
,__sT:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,b,this.__sM);}
else {qx.event.Idle.getInstance().removeListener(a,this.__sU,this);}
;}
,__sU:function(){var e=this._readState();if(qx.lang.Type.isString(e)&&e!=this.getState()){this._onHistoryLoad(e);}
;}
...
(function(){var b="__qJ",a="qx.ui.window.Manager";qx.Class.define(a,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__qJ:null,setDesktop:function(c){this.__qJ=c;this.updateStack();}
...
,syncWidget:function(){this.__qJ.forceUnblockContent();var f=this.__qJ.getWindows();var h=this._minZIndex;var m=h+f.length*2;var j=h+f.length*4;var k=null;for(var i=0,l=f.length;i<l;i++){var g=f[i];if(!g.isVisible()){continue;}
;k=k||g;if(g.isModal()){g.setZIndex(j);this.__qJ.blockContent(j-1);j+=2;k=g;}
else if(g.isAlwaysOnTop()){g.setZIndex(m);m+=2;}
else {g.setZIndex(h);h+=2;}
;if(!k.isModal()&&g.isActive()||g.getZIndex()>k.getZIndex()){k=g;}
;}
;this.__qJ.setActiveWindow(k);}
,bringToFront:function(n){var o=this.__qJ.getWindows();var p=qx.lang.Array.remove(o,n);if(p){o.push(n);this.updateStack();}
;}
,sendToBack:function(q){var r=this.__qJ.getWindows();var s=qx.lang.Array.remove(r,q);if(s){r.unshift(q);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(b);}
});}
)();
(function(){var l="__qK",k="__qL",j="mouseup",i="mousedown",h="losecapture",g="qx.ui.core.MMovable",f="mousemove",d="maximized",c="move-frame",b="Boolean",a="move";qx.Mixin.define(g,{properties:{movable:{check:b,init:true},useMoveFrame:{check:b,init:false}},members:{__qK:null,__qL:null,__qM:null,__qN:null,__qO:null,__qP:null,__qQ:null,__qR:false,__qS:null,__qT:0,_activateMoveHandle:function(m){if(this.__qK){throw new Error("The move handle could not be redefined!");}
;this.__qK=m;m.addListener(i,this._onMoveMouseDown,this);m.addListener(j,this._onMoveMouseUp,this);m.addListener(f,this._onMoveMouseMove,this);m.addListener(h,this.__qX,this);}
,__qU:function(){var n=this.__qL;if(!n){n=this.__qL=new qx.ui.core.Widget();n.setAppearance(c);n.exclude();qx.core.Init.getApplication().getRoot().add(n);}
;return n;}
,__qV:function(){var location=this.getContainerLocation();var p=this.getBounds();var o=this.__qU();o.setUserBounds(location.left,location.top,p.width,p.height);o.show();o.setZIndex(this.getZIndex()+1);}
,__qW:function(e){var r=this.__qM;var u=Math.max(r.left,Math.min(r.right,e.getDocumentLeft()));var t=Math.max(r.top,Math.min(r.bottom,e.getDocumentTop()));var q=this.__qN+u;var s=this.__qO+t;return {viewportLeft:q,viewportTop:s,parentLeft:q-this.__qP,parentTop:s-this.__qQ};}
,_onMoveMouseDown:function(e){if(!this.getMovable()||this.hasState(d)){return;}
;var parent=this.getLayoutParent();var w=parent.getContentLocation();var x=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isContentBlocked()){this.__qS=parent.getBlockerColor();this.__qT=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__qR=true;}
;}
;this.__qM={left:w.left,top:w.top,right:w.left+x.width,bottom:w.top+x.height};var v=this.getContainerLocation();this.__qP=w.left;this.__qQ=w.top;this.__qN=v.left-e.getDocumentLeft();this.__qO=v.top-e.getDocumentTop();this.addState(a);this.__qK.capture();if(this.getUseMoveFrame()){this.__qV();}
;e.stop();}
,_onMoveMouseMove:function(e){if(!this.hasState(a)){return;}
;var y=this.__qW(e);if(this.getUseMoveFrame()){this.__qU().setDomPosition(y.viewportLeft,y.viewportTop);}
else {this.setDomPosition(y.parentLeft,y.parentTop);}
;e.stopPropagation();}
,_onMoveMouseUp:function(e){if(!this.hasState(a)){return;}
;this.removeState(a);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__qR){parent.unblockContent();parent.setBlockerColor(this.__qS);parent.setBlockerOpacity(this.__qT);this.__qS=null;this.__qT=0;this.__qR=false;}
;}
;this.__qK.releaseCapture();var z=this.__qW(e);this.setLayoutProperties({left:z.parentLeft,top:z.parentTop});if(this.getUseMoveFrame()){this.__qU().exclude();}
;e.stopPropagation();}
,__qX:function(e){if(!this.hasState(a)){return;}
;this.removeState(a);if(this.getUseMoveFrame()){this.__qU().exclude();}
;}
},destruct:function(){this._disposeObjects(k,l);this.__qM=null;}
});}
)();
(function(){var j="resetPaddingRight",i="setPaddingTop",h="setPaddingBottom",g="resetThemed",f="contentPaddingRight",e="contentPaddingLeft",d="setThemedPaddingLeft",c="resetPaddingTop",b="shorthand",a="setThemedPaddingRight",v="setThemed",u="setPaddingRight",t="contentPaddingBottom",s="resetPaddingBottom",r="qx.ui.core.MContentPadding",q="resetPaddingLeft",p="setThemedPaddingTop",o="setPaddingLeft",n="setThemedPaddingBottom",m="contentPaddingTop",k="_applyContentPadding",l="Integer";qx.Mixin.define(r,{properties:{contentPaddingTop:{check:l,init:0,apply:k,themeable:true},contentPaddingRight:{check:l,init:0,apply:k,themeable:true},contentPaddingBottom:{check:l,init:0,apply:k,themeable:true},contentPaddingLeft:{check:l,init:0,apply:k,themeable:true},contentPadding:{group:[m,f,t,e],mode:b,themeable:true}},members:{__nw:{contentPaddingTop:i,contentPaddingRight:u,contentPaddingBottom:h,contentPaddingLeft:o},__nx:{contentPaddingTop:p,contentPaddingRight:a,contentPaddingBottom:n,contentPaddingLeft:d},__ny:{contentPaddingTop:c,contentPaddingRight:j,contentPaddingBottom:s,contentPaddingLeft:q},_applyContentPadding:function(w,x,name,y){var z=this._getContentPaddingTarget();if(w==null){var A=this.__ny[name];z[A]();}
else {if(y==v||y==g){var B=this.__nx[name];z[B](w);}
else {var B=this.__nw[name];z[B](w);}
;}
;}
}});}
)();
(function(){var k="mousedown",j="w-resize",i="sw-resize",h="n-resize",g="resizableRight",f="ne-resize",d="se-resize",c="Integer",b="e-resize",a="resizableLeft",z="mousemove",y="move",x="shorthand",w="maximized",v="nw-resize",u="mouseout",t="qx.ui.core.MResizable",s="mouseup",r="losecapture",q="resize-frame",o="resizableBottom",p="s-resize",m="resizableTop",n="Boolean",l="resize";qx.Mixin.define(t,{construct:function(){var A=this.getContainerElement();A.addListener(k,this.__rm,this,true);A.addListener(s,this.__rn,this);A.addListener(z,this.__rp,this);A.addListener(u,this.__rq,this);A.addListener(r,this.__ro,this);var B=this.getContainerElement().getDomElement();if(B==null){B=window;}
;this.__qY=qx.event.Registration.getManager(B).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:n,init:true},resizableRight:{check:n,init:true},resizableBottom:{check:n,init:true},resizableLeft:{check:n,init:true},resizable:{group:[m,g,o,a],mode:x},resizeSensitivity:{check:c,init:5},useResizeFrame:{check:n,init:true}},members:{__qY:null,__ra:null,__rb:null,__rc:null,__rd:null,__re:null,__rf:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var C=this.__ra;if(!C){C=this.__ra=new qx.ui.core.Widget();C.setAppearance(q);C.exclude();qx.core.Init.getApplication().getRoot().add(C);}
;return C;}
,__rg:function(){var location=this.__rj();var D=this._getResizeFrame();D.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);D.show();D.setZIndex(this.getZIndex()+1);}
,__rh:function(e){var F=this.__rb;var G=this.getSizeHint();var K=this.__rf;var J=this.__re;var E=J.width;var I=J.height;var H=J.containerWidth;var M=J.containerHeight;var N=J.left;var top=J.top;var L;if((F&this.RESIZE_TOP)||(F&this.RESIZE_BOTTOM)){L=Math.max(K.top,Math.min(K.bottom,e.getDocumentTop()))-this.__rd;if(F&this.RESIZE_TOP){I-=L;M-=L;}
else {I+=L;M+=L;}
...
;}
;if((F&this.RESIZE_LEFT)||(F&this.RESIZE_RIGHT)){L=Math.max(K.left,Math.min(K.right,e.getDocumentLeft()))-this.__rc;if(F&this.RESIZE_LEFT){E-=L;H-=L;}
else {E+=L;H+=L;}
...
,__ri:{'1':h,'2':p,'4':j,'8':b,'5':v,'6':i,'9':f,'10':d},__rj:function(){var O=this.getDecoratorElement();if(O&&O.getDomElement()){return qx.bom.element.Location.get(O.getDomElement());}
else {return this.getContentLocation();}
;}
,__rk:function(e){var location=this.__rj();var P=this.getResizeSensitivity();var S=e.getDocumentLeft();var R=e.getDocumentTop();var Q=this.__rl(location,S,R,P);if(Q>0){Q=Q|this.__rl(location,S,R,P*2);}
;this.__rb=Q;}
,__rl:function(location,T,U,V){var W=0;if(this.getResizableTop()&&Math.abs(location.top-U)<V&&T>location.left-V&&T<location.right+V){W+=this.RESIZE_TOP;}
...
;return W;}
,__rm:function(e){if(!this.__rb||!this.getEnabled()){return;}
;this.addState(l);this.__rc=e.getDocumentLeft();this.__rd=e.getDocumentTop();var bb=this.getContainerLocation();var X=this.__rj();var ba=this.getBounds();this.__re={top:X.top,left:X.left,containerWidth:bb.right-bb.left,containerHeight:bb.bottom-bb.top,width:X.right-X.left,height:X.bottom-X.top,bounds:qx.lang.Object.clone(ba)};var parent=this.getLayoutParent();var bc=parent.getContentLocation();var Y=parent.getBounds();this.__rf={left:bc.left,top:bc.top,right:bc.left+Y.width,bottom:bc.top+Y.height};if(this.getUseResizeFrame()){this.__rg();}
;this.capture();e.stop();}
,__rn:function(e){if(!this.hasState(l)||!this.getEnabled()){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var bd=this.__rh(e);this.setWidth(bd.containerWidth);this.setHeight(bd.containerHeight);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:bd.parentLeft,top:bd.parentTop});}
;this.__rb=0;this.removeState(l);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__ro:function(e){if(!this.__rb){return;}
...
;}
,__rp:function(e){if(!this.getEnabled()){return;}
;if(this.hasState(l)){var bh=this.__rh(e);if(this.getUseResizeFrame()){var bf=this._getResizeFrame();bf.setUserBounds(bh.viewportLeft,bh.viewportTop,bh.width,bh.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(w)&&!this.__qY.isSessionActive()){this.__rk(e);var bi=this.__rb;var bg=this.getApplicationRoot();if(bi){var be=this.__ri[bi];this.setCursor(be);bg.setGlobalCursor(be);}
else if(this.getCursor()){this.resetCursor();bg.resetGlobalCursor();}
;}
;}
,__rq:function(e){if(this.getCursor()&&!this.hasState(l)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__ra!=null&&!qx.core.ObjectRegistry.inShutDown){this.__ra.destroy();this.__ra=null;}
;this.__qY=null;}
});}
)();
...
;var bm=this.getLayoutProperties();this.__rs=bm.left===undefined?0:bm.left;this.__rr=bm.top===undefined?0:bm.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(z);this._updateCaptionBar();this.fireEvent(p);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(j,qx.event.type.Event,[false,true])){var bn=this.getLayoutProperties();this.__rs=bn.left===undefined?0:bn.left;this.__rr=bn.top===undefined?0:bn.top;this.removeState(z);this.hide();this.fireEvent(V);}
;}
...
;var bo=this.__rs;var top=this.__rr;this.setLayoutProperties({edge:null,left:bo,top:top});this.removeState(z);this._updateCaptionBar();this.fireEvent(q);}
;}
...
(function(){var g="resize",f="demobrowser.InfoWindow",e="Boolean",d="_applyContent",c="center",b="OK",a="execute";qx.Class.define(f,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);this.setLayout(new qx.ui.layout.VBox(10));this.setMinWidth(200);this.setMaxWidth(qx.bom.Viewport.getWidth()-10);this.setMaxHeight(qx.bom.Viewport.getHeight()-10);this.setShowMinimize(false);this.setShowMaximize(false);this.add(this._getContentContainer(),{flex:1});this.add(this._makeOkButton(),{flex:0});this.addListener(g,this.__ui,this);}
,properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__uh:null,_getContentContainer:function(){if(!this.__uh){this.__uh=new qx.ui.container.Composite(new qx.ui.layout.Canvas());this.__uh.setMinHeight(20);}
;return this.__uh;}
...
,__ui:function(){if(this.getAutoCenter()){this.center();}
;}
}});}
)();
...
(function(){var m="-",l="PageUp",k="Escape",j="qx.event.type.Data",h="_applyShortcut",g="PrintScreen",f="NumLock",d="5",c="8",b="execute",S="Meta",R="0",Q="2",P="Shift",O="You can only specify one non modifier key!",N="3",M="/",L="Delete",K="String",J="changeEnabled",t="*",u="qx.bom.Shortcut",r="6",s="4",p="1",q="Alt",n="Not a valid key name for a shortcut: ",o="PageDown",v="Whitespaces are not allowed within shortcuts",w="_applyEnabled",B="7",A="a",D="z",C="9",F="Boolean",E="+",y="short",I="keydown",H="",G="Control",x="keypress",z="Unidentified";qx.Class.define(u,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__uj={};this.__uk=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":j},properties:{enabled:{init:true,check:F,event:J,apply:w},shortcut:{check:K,apply:h,nullable:true},autoRepeat:{check:F,init:false}},members:{__uj:H,__uk:H,execute:function(U){this.fireDataEvent(b,U);}
,__ul:function(event){if(this.getEnabled()&&this.__um(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__gH:function(event){if(this.getEnabled()&&this.__um(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(V,W){if(V){qx.event.Registration.addListener(document.documentElement,I,this.__ul,this);qx.event.Registration.addListener(document.documentElement,x,this.__gH,this);}
else {qx.event.Registration.removeListener(document.documentElement,I,this.__ul,this);qx.event.Registration.removeListener(document.documentElement,x,this.__gH,this);}
;}
,_applyShortcut:function(X,Y){if(X){if(X.search(/[\s]+/)!=-1){var bc=v;this.error(bc);throw new Error(bc);}
;this.__uj={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__uk=null;var ba;var a=[];while(X.length>0&&ba!=-1){ba=X.search(/[-+]+/);a.push((X.length==1||ba==-1)?X:X.substring(0,ba));X=X.substring(ba+1);}
;var bb=a.length;for(var i=0;i<bb;i++){var bd=this.__uo(a[i]);switch(bd){case G:case P:case S:case q:this.__uj[bd]=true;break;case z:var bc=n+a[i];this.error(bc);throw bc;default:if(this.__uk){var bc=O;this.error(bc);throw bc;}
;this.__uk=bd;};}
;}
;return true;}
,__um:function(e){var be=this.__uk;if(!be){return false;}
;if((!this.__uj.Shift&&e.isShiftPressed())||(this.__uj.Shift&&!e.isShiftPressed())||(!this.__uj.Control&&e.isCtrlPressed())||(this.__uj.Control&&!e.isCtrlPressed())||(!this.__uj.Meta&&e.isMetaPressed())||(this.__uj.Meta&&!e.isMetaPressed())||(!this.__uj.Alt&&e.isAltPressed())||(this.__uj.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__un:{esc:k,ctrl:G,print:g,del:L,pageup:l,pagedown:o,numlock:f,numpad_0:R,numpad_1:p,numpad_2:Q,numpad_3:N,numpad_4:s,numpad_5:d,numpad_6:r,numpad_7:B,numpad_8:c,numpad_9:C,numpad_divide:M,numpad_multiply:t,numpad_minus:m,numpad_plus:E},__uo:function(bf){var bg=qx.event.util.Keyboard;var bh=z;if(bg.isValidKeyIdentifier(bf)){return bf;}
;if(bf.length==1&&bf>=A&&bf<=D){return bf.toUpperCase();}
;bf=bf.toLowerCase();var bh=this.__un[bf]||qx.lang.String.firstUp(bf);if(bg.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bk=this.__uk;var bj=[];for(var bi in this.__uj){if(this.__uj[bi]){bj.push(qx.locale.Key.getKeyName(y,bi));}
;}
;if(bk){bj.push(qx.locale.Key.getKeyName(y,bk));}
;return bj.join(E);}
},destruct:function(){this.setEnabled(false);this.__uj=this.__uk=null;}
});}
)();
...
;this._getIframeElement().addListener(b,this.__uy,this);}
...
,__uy:function(e){var q=e.getData();if(q){this.setSource(q);}
;this.fireDataEvent(b,q);}
}});}
)();
(function(){var k="no",j="Boolean",i="px",h="event.help",g="__uA",f="gecko",d="auto",c="_applyScrollbar",b="qx.debug",a="DOMNodeInserted",B="_applyNativeHelp",A="yes",z="scrolling",y="/",x="appear",w="engine.name",v="block",u="qx.ui.embed.Iframe",t="iframe",s="mousedown",q="load",r="help",o="mouseup",p="losecapture",m="contextmenu",n="none",l="display";qx.Class.define(u,{extend:qx.ui.embed.AbstractIframe,construct:function(C){if(C!=null){this.__uz=C;}
;qx.ui.embed.AbstractIframe.call(this,C);qx.event.Registration.addListener(document.body,s,this.block,this,true);qx.event.Registration.addListener(document.body,o,this.release,this,true);qx.event.Registration.addListener(document.body,p,this.release,this,true);this.__uA=this._createBlockerElement();this.getContainerElement().add(this.__uA);if((qx.core.Environment.get(w)==f)){this.addListenerOnce(x,function(e){var D=this.getContainerElement().getDomElement();qx.bom.Event.addNativeListener(D,a,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:t},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:j,init:false,apply:B},scrollbar:{check:[d,k,A],nullable:true,themeable:true,apply:c}},members:{__uz:null,__uA:null,renderLayout:function(E,top,F,G){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,E,top,F,G);var I=i;var H=this.getInsets();this.__uA.setStyles({"left":H.left+I,"top":H.top+I,"width":(F-H.left-H.right)+I,"height":(G-H.top-H.bottom)+I});}
,_createContentElement:function(){var J=new qx.html.Iframe(this.__uz);J.addListener(q,this._onIframeLoad,this);return J;}
...
,block:function(){this.__uA.setStyle(l,v);}
,release:function(){this.__uA.setStyle(l,n);}
...
;}
catch(e){if(qx.core.Environment.get(b)){this.warn("Unable to set 'nativeHelp' property, possibly due to security restrictions");}
;}
;}
;}
...
},destruct:function(){this._disposeObjects(g);qx.event.Registration.removeListener(document.body,s,this.block,this,true);qx.event.Registration.removeListener(document.body,o,this.release,this,true);qx.event.Registration.removeListener(document.body,p,this.release,this,true);}
});}
)();
(function(){var i="element",h="qx.event.type.Event",g="iframe",f="qx.html.Iframe",d="navigate",c="qx.event.type.Data",b="name",a="source";qx.Class.define(f,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,g,k,l);this.setSource(j);this.addListener(d,this.__uy,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(i);}
...
;}
,__uy:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
(function(){var v="mouseup",u="mousedown",t="__fx",s="losecapture",r="multi",q="_applyQuickSelection",p="mouseover",o="_applySelectionMode",n="_applyDragSelection",m="qx.ui.core.MMultiSelectionHandling",d="removeItem",l="keypress",h="qx.event.type.Data",c="addItem",b="additive",g="mousemove",f="Boolean",j="one",a="changeSelection",k="single";qx.Mixin.define(m,{construct:function(){var x=this.SELECTION_MANAGER;var w=this.__fx=new x(this);this.addListener(u,w.handleMouseDown,w);this.addListener(v,w.handleMouseUp,w);this.addListener(p,w.handleMouseOver,w);this.addListener(g,w.handleMouseMove,w);this.addListener(s,w.handleLoseCapture,w);this.addListener(l,w.handleKeyPress,w);this.addListener(c,w.handleAddItem,w);this.addListener(d,w.handleRemoveItem,w);w.addListener(a,this._onSelectionChange,this);}
,events:{"changeSelection":h},properties:{selectionMode:{check:[k,r,b,j],init:k,apply:o},dragSelection:{check:f,init:false,apply:n},quickSelection:{check:f,init:false,apply:q}},members:{__fx:null,selectAll:function(){this.__fx.selectAll();}
...
;return this.__fx.isItemSelected(y);}
...
;this.__fx.removeItem(A);}
,selectRange:function(B,C){this.__fx.selectItemRange(B,C);}
,resetSelection:function(){this.__fx.clearSelection();}
...
else {var E=this.getSelection();if(!qx.lang.Array.equals(E,D)){this.__fx.replaceSelection(D);}
;}
;}
,getSelection:function(){return this.__fx.getSelection();}
,getSortedSelection:function(){return this.__fx.getSortedSelection();}
,isSelectionEmpty:function(){return this.__fx.isSelectionEmpty();}
,getSelectionContext:function(){return this.__fx.getSelectionContext();}
,_getManager:function(){return this.__fx;}
,getSelectables:function(F){return this.__fx.getSelectables(F);}
,invertSelection:function(){this.__fx.invertSelection();}
,_getLeadItem:function(){var G=this.__fx.getMode();if(G===k||G===j){return this.__fx.getSelectedItem();}
else {return this.__fx.getLeadItem();}
;}
,_applySelectionMode:function(H,I){this.__fx.setMode(H);}
,_applyDragSelection:function(J,K){this.__fx.setDrag(J);}
,_applyQuickSelection:function(L,M){this.__fx.setQuick(L);}
,_onSelectionChange:function(e){this.fireDataEvent(a,e.getData());}
},destruct:function(){this._disposeObjects(t);}
});}
)();
(function(){var o="Escape",n="A",m="Space",k="_applyMode",j="interval",h="changeSelection",g="qx.event.type.Data",f="quick",d="key",c="__ma",O="abstract",N="drag",M="qx.ui.core.selection.Abstract",L="under",K="PageUp",J="Left",I="lead",H="Down",G="Up",F="Boolean",v="PageDown",w="anchor",t="End",u="Home",r="Right",s="right",p="click",q="above",x="left",y="os.name",A="osx",z="multi",C="selected",B="additive",E="single",D="one";qx.Class.define(M,{type:O,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__fB={};}
,events:{"changeSelection":g},properties:{mode:{check:[E,z,B,D],init:E,apply:k},drag:{check:F,init:false},quick:{check:F,init:false}},members:{__lX:0,__lY:0,__ma:null,__mb:null,__mc:null,__md:null,__me:null,__mf:null,__mg:null,__mh:null,__mi:null,__mj:null,__mk:null,__ml:null,__mm:null,__mn:null,__mo:null,__fB:null,__mp:null,__mq:null,_userInteraction:false,__mr:null,getSelectionContext:function(){return this.__mn;}
...
,getSelection:function(){return qx.lang.Object.getValues(this.__fB);}
,getSortedSelection:function(){var bg=this.getSelectables();var bf=qx.lang.Object.getValues(this.__fB);bf.sort(function(a,b){return bg.indexOf(a)-bg.indexOf(b);}
);return bf;}
,isItemSelected:function(bh){var bi=this._selectableToHashCode(bh);return this.__fB[bi]!==undefined;}
,isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__fB);}
...
;this._fireChange();}
,_setLeadItem:function(bl){var bm=this.__mo;if(bm!==null){this._styleSelectable(bm,I,false);}
;if(bl!==null){this._styleSelectable(bl,I,true);}
;this.__mo=bl;}
,getLeadItem:function(){return this.__mo!==null?this.__mo:null;}
,_setAnchorItem:function(bn){var bo=this.__mp;if(bo!=null){this._styleSelectable(bo,w,false);}
;if(bn!=null){this._styleSelectable(bn,w,true);}
;this.__mp=bn;}
,_getAnchorItem:function(){return this.__mp!==null?this.__mp:null;}
...
;this._fireChange();}
,handleMouseOver:function(event){if(this.__mr!=null&&this.__mr!=this._getScroll().top){this.__mr=null;return;}
...
;var bO=event.isCtrlPressed()||(qx.core.Environment.get(y)==A&&event.isMetaPressed());var bL=event.isShiftPressed();if(this.isItemSelected(bM)&&!bL&&!bO&&!this.getDrag()){this.__mq=bM;this._userInteraction=false;return;}
else {this.__mq=null;}
...
;break;};var bP=this.getMode();if(this.getDrag()&&bP!==E&&bP!==D&&!bL&&!bO){this.__me=this._getLocation();this.__mb=this._getScroll();this.__mf=event.getDocumentLeft()+this.__mb.left;this.__mg=event.getDocumentTop()+this.__mb.top;this.__mh=true;this._capture();}
;this._fireChange(p);this._userInteraction=false;}
,handleMouseUp:function(event){this._userInteraction=true;var bT=event.isCtrlPressed()||(qx.core.Environment.get(y)==A&&event.isMetaPressed());var bQ=event.isShiftPressed();if(!bT&&!bQ&&this.__mq!=null){var bR=this._getSelectableFromMouseEvent(event);if(bR===null||!this.isItemSelected(bR)){this._userInteraction=false;return;}
...
,handleMouseMove:function(event){if(!this.__mh){return;}
;this.__mi=event.getDocumentLeft();this.__mj=event.getDocumentTop();this._userInteraction=true;var bV=this.__mi+this.__mb.left;if(bV>this.__mf){this.__mk=1;}
else if(bV<this.__mf){this.__mk=-1;}
else {this.__mk=0;}
;var bU=this.__mj+this.__mb.top;if(bU>this.__mg){this.__ml=1;}
else if(bU<this.__mg){this.__ml=-1;}
else {this.__ml=0;}
;var location=this.__me;if(this.__mi<location.left){this.__lX=this.__mi-location.left;}
else if(this.__mi>location.right){this.__lX=this.__mi-location.right;}
else {this.__lX=0;}
;if(this.__mj<location.top){this.__lY=this.__mj-location.top;}
else if(this.__mj>location.bottom){this.__lY=this.__mj-location.bottom;}
else {this.__lY=0;}
;if(!this.__ma){this.__ma=new qx.event.Timer(100);this.__ma.addListener(j,this._onInterval,this);}
;this.__ma.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
,handleAddItem:function(e){var bW=e.getData();if(this.getMode()===D&&this.isSelectionEmpty()){this.addItem(bW);}
;}
,handleRemoveItem:function(e){this.removeItem(e.getData());}
,_cleanup:function(){if(!this.getDrag()&&this.__mh){return;}
;if(this.__mm){this._fireChange(p);}
;delete this.__mh;delete this.__mc;delete this.__md;this._releaseCapture();if(this.__ma){this.__ma.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__lX,this.__lY);this.__mb=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cg=this._getDimension();var bY=Math.max(0,Math.min(this.__mi-this.__me.left,cg.width))+this.__mb.left;var bX=Math.max(0,Math.min(this.__mj-this.__me.top,cg.height))+this.__mb.top;if(this.__mc===bY&&this.__md===bX){return;}
;this.__mc=bY;this.__md=bX;var ci=this._getAnchorItem();var cb=ci;var ce=this.__mk;var ch,ca;while(ce!==0){ch=ce>0?this._getRelatedSelectable(cb,s):this._getRelatedSelectable(cb,x);if(ch!==null){ca=this._getSelectableLocationX(ch);if((ce>0&&ca.left<=bY)||(ce<0&&ca.right>=bY)){cb=ch;continue;}
;}
;break;}
;var cf=this.__ml;var cd,cc;while(cf!==0){cd=cf>0?this._getRelatedSelectable(cb,L):this._getRelatedSelectable(cb,q);if(cd!==null){cc=this._getSelectableLocationY(cd);if((cf>0&&cc.top<=bX)||(cf<0&&cc.bottom>=bX)){cb=cd;continue;}
;}
;break;}
...
;cn=true;}
;}
else if(this.__ms[cr]){cn=true;if(cq===E||cq==D){cp=this._getSelectedItem();}
...
;}
;break;};this.__mr=this._getScroll().top;this._scrollItemIntoView(co);}
;}
...
;}
,_clearSelection:function(){var cu=this.__fB;for(var cv in cu){this._removeFromSelection(cu[cv]);}
;this.__fB={};}
,_selectItemRange:function(cw,cx,cy){var cB=this._getSelectableRange(cw,cx);if(!cy){var cA=this.__fB;var cC=this.__mt(cB);for(var cz in cA){if(!cC[cz]){this._removeFromSelection(cA[cz]);}
;}
;}
...
;}
,__mt:function(cG){var cI={};var cH;for(var i=0,l=cG.length;i<l;i++){cH=cG[i];cI[this._selectableToHashCode(cH)]=cH;}
;return cI;}
,_getSelectedItem:function(){for(var cJ in this.__fB){return this.__fB[cJ];}
;return null;}
,_setSelectedItem:function(cK){if(this._isSelectable(cK)){var cL=this.__fB;var cM=this._selectableToHashCode(cK);if(!cL[cM]||(cL.length>=2)){this._clearSelection();this._addToSelection(cK);}
;}
;}
,_addToSelection:function(cN){var cO=this._selectableToHashCode(cN);if(this.__fB[cO]==null&&this._isSelectable(cN)){this.__fB[cO]=cN;this._styleSelectable(cN,C,true);this.__mm=true;}
;}
,_toggleInSelection:function(cP){var cQ=this._selectableToHashCode(cP);if(this.__fB[cQ]==null){this.__fB[cQ]=cP;this._styleSelectable(cP,C,true);}
else {delete this.__fB[cQ];this._styleSelectable(cP,C,false);}
;this.__mm=true;}
,_removeFromSelection:function(cR){var cS=this._selectableToHashCode(cR);if(this.__fB[cS]!=null){delete this.__fB[cS];this._styleSelectable(cR,C,false);this.__mm=true;}
;}
...
;}
;var db=cT[0];var cV=da;var cX=this.__fB;for(var cY in cX){if(cU[cY]){delete cU[cY];}
...
;if(!cW){return false;}
;this._scrollItemIntoView(cV);this._setLeadItem(db);this._setAnchorItem(db);this.__mm=true;this._fireChange();}
,_fireChange:function(dc){if(this.__mm){this.__mn=dc||null;this.fireDataEvent(h,this.getSelection());delete this.__mm;}
;}
...
;return de;}
;return null;}
},destruct:function(){this._disposeObjects(c);this.__fB=this.__mq=this.__mp=null;this.__mo=null;}
});}
)();
(function(){var f="vertical",e="under",d="above",c="qx.ui.core.selection.Widget",b="left",a="right";qx.Class.define(c,{extend:qx.ui.core.selection.Abstract,construct:function(g){qx.ui.core.selection.Abstract.call(this);this.__lx=g;}
,members:{__lx:null,_isSelectable:function(h){return this._isItemSelectable(h)&&h.getLayoutParent()===this.__lx;}
,_selectableToHashCode:function(j){return j.$$hash;}
,_styleSelectable:function(k,m,n){n?k.addState(m):k.removeState(m);}
,_capture:function(){this.__lx.capture();}
,_releaseCapture:function(){this.__lx.releaseCapture();}
,_isItemSelectable:function(o){if(this._userInteraction){return o.isVisible()&&o.isEnabled();}
else {return o.isVisible();}
;}
,_getWidget:function(){return this.__lx;}
,_getLocation:function(){var p=this.__lx.getContentElement().getDomElement();return p?qx.bom.element.Location.get(p):null;}
,_getDimension:function(){return this.__lx.getInnerSize();}
...
,_scrollItemIntoView:function(w){this.__lx.scrollChildIntoView(w);}
,getSelectables:function(x){var y=false;if(!x){y=this._userInteraction;this._userInteraction=true;}
;var B=this.__lx.getChildren();var z=[];var A;for(var i=0,l=B.length;i<l;i++){A=B[i];if(this._isItemSelectable(A)){z.push(A);}
;}
;this._userInteraction=y;return z;}
,_getSelectableRange:function(C,D){if(C===D){return [C];}
;var H=this.__lx.getChildren();var E=[];var G=false;var F;for(var i=0,l=H.length;i<l;i++){F=H[i];if(F===C||F===D){if(G){E.push(F);break;}
else {G=true;}
;}
;if(G&&this._isItemSelectable(F)){E.push(F);}
;}
;return E;}
,_getFirstSelectable:function(){var I=this.__lx.getChildren();for(var i=0,l=I.length;i<l;i++){if(this._isItemSelectable(I[i])){return I[i];}
;}
;return null;}
,_getLastSelectable:function(){var J=this.__lx.getChildren();for(var i=J.length-1;i>0;i--){if(this._isItemSelectable(J[i])){return J[i];}
;}
;return null;}
,_getRelatedSelectable:function(K,L){var O=this.__lx.getOrientation()===f;var N=this.__lx.getChildren();var M=N.indexOf(K);var P;if((O&&L===d)||(!O&&L===b)){for(var i=M-1;i>=0;i--){P=N[i];if(this._isItemSelectable(P)){return P;}
;}
;}
...
(function(){var k="_applyIconOpened",j="Boolean",i="__mw",h="changeIcon",g="changeIconOpened",f="changeLabel",d="Integer",c="_applyIndent",b="changeOpenSymbolMode",a="_applyOpenSymbolMode",D="resize",C="",B="iconOpened",A="abstract",z="never",y="_applyIcon",x="_applyOpen",w="changeIndent",v="qx.ui.tree.core.AbstractItem",u="_applyLabel",r="changeOpen",s="opened",p="always",q="auto",n="middle",o="String",l="label",m="open",t="icon";qx.Class.define(v,{extend:qx.ui.core.Widget,type:A,include:[qx.ui.form.MModelProperty],implement:[qx.ui.form.IModel],construct:function(E){qx.ui.core.Widget.call(this);if(E!=null){this.setLabel(E);}
;this._setLayout(new qx.ui.layout.HBox());this._addWidgets();this.initOpen();}
,properties:{open:{check:j,init:false,event:r,apply:x},openSymbolMode:{check:[p,z,q],init:q,event:b,apply:a},indent:{check:d,init:19,apply:c,event:w,themeable:true},icon:{check:o,apply:y,event:h,nullable:true,themeable:true},iconOpened:{check:o,apply:k,event:g,nullable:true,themeable:true},label:{check:o,apply:u,event:f,init:C}},members:{__mu:null,__mv:null,__mw:null,_addWidgets:function(){throw new Error("Abstract method call.");}
,_createChildControlImpl:function(F,G){var H;switch(F){case l:H=new qx.ui.basic.Label().set({alignY:n,anonymous:true,value:this.getLabel()});break;case t:H=new qx.ui.basic.Image().set({alignY:n,anonymous:true,source:this.getIcon()});break;case m:H=new qx.ui.tree.core.FolderOpenButton().set({alignY:n});H.addListener(r,this._onChangeOpen,this);H.addListener(D,this._updateIndent,this);break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);}
,addWidget:function(I,J){this._add(I,J);}
,addSpacer:function(){if(!this.__mw){this.__mw=new qx.ui.core.Spacer();}
else {this._remove(this.__mw);}
;this._add(this.__mw);}
,addOpenButton:function(){this._add(this.getChildControl(m));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var K=this.getChildControl(t);if(this.__mv){this._remove(K);}
;this._add(K);this.__mv=true;}
,addLabel:function(L){var M=this.getChildControl(l);if(this.__mu){this._remove(M);}
;if(L){this.setLabel(L);}
else {M.setValue(this.getLabel());}
;this._add(M);this.__mu=true;}
,_applyIcon:function(N,O){if(!this.__my()){this.__mz(N);}
else if(!this.isOpen()){this.__mz(N);}
;}
,_applyIconOpened:function(P,Q){if(this.isOpen()){if(this.__mx()&&this.__my()){this.__mz(P);}
else if(!this.__mx()&&this.__my()){this.__mz(P);}
;}
;}
...
;var W;if(U){W=this.__my()?this.getIconOpened():null;}
else {W=this.getIcon();}
;if(W){this.__mz(W);}
;U?this.addState(s):this.removeState(s);}
,__mx:function(){return qx.util.PropertyUtil.getUserValue(this,t);}
,__my:function(){return qx.util.PropertyUtil.getUserValue(this,B);}
,__mz:function(X){var Y=this.getChildControl(t,true);if(Y){Y.setSource(X);}
;}
...
;}
;if(this.__mw){this.__mw.setWidth((this.getLevel()+1)*this.getIndent()-be);}
;}
...
(function(){var m="open",k="abstract",j="addItem",h="__fU",g="__mU",f="removeItem",e="Invalid child index: ",d="visible",c="excluded",b="qx.ui.tree.core.AbstractTreeItem",a="qx.debug";qx.Class.define(b,{extend:qx.ui.tree.core.AbstractItem,type:k,construct:function(n){qx.ui.tree.core.AbstractItem.call(this,n);this.__fU=[];}
,properties:{parent:{check:b,nullable:true}},members:{__fU:null,__mU:null,getTree:function(){var p=this;while(p.getParent()){p=p.getParent();}
...
;}
;}
,getChildrenContainer:function(){if(!this.__mU){this.__mU=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?d:c});}
;return this.__mU;}
...
;}
,getChildren:function(){return this.__fU;}
,hasChildren:function(){return this.__fU?this.__fU.length>0:false;}
...
;}
,__mV:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);}
;}
...
;this.__fU.push(P);if(!M){this.__mV();}
;if(O){P.recursiveAddToWidgetQueue();O.fireNonBubblingEvent(j,qx.event.type.Data,[P]);}
;}
;if(O){qx.ui.core.queue.Widget.add(this);}
;}
,addAt:function(Q,R){if(qx.core.Environment.get(a)){this.assert(R<=this.__fU.length&&R>=0,e+R);}
;if(R==this.__fU.length){this.add(Q);return;}
;var V=Q.getParent();if(V){V.remove(Q);}
;var T=this.getChildrenContainer();Q.setParent(this);var U=this.hasChildren();var S=this.__fU[R];T.addBefore(Q,S);if(Q.hasChildren()){T.addAfter(Q.getChildrenContainer(),Q);}
;qx.lang.Array.insertAt(this.__fU,Q,R);if(!U){this.__mV();}
;if(this.getTree()){Q.recursiveAddToWidgetQueue();qx.ui.core.queue.Widget.add(this);}
;}
,addBefore:function(W,X){if(qx.core.Environment.get(a)){this.assert(this.__fU.indexOf(X)>=0);}
;var Y=W.getParent();if(Y){Y.remove(W);}
;this.addAt(W,this.__fU.indexOf(X));}
,addAfter:function(ba,bb){if(qx.core.Environment.get(a)){this.assert(this.__fU.indexOf(bb)>=0);}
;var bc=ba.getParent();if(bc){bc.remove(ba);}
;this.addAt(ba,this.__fU.indexOf(bb)+1);}
,addAtBegin:function(bd){this.addAt(bd,0);}
,remove:function(be){for(var i=0,l=arguments.length;i<l;i++){var bi=arguments[i];if(this.__fU.indexOf(bi)==-1){this.warn("Cannot remove treeitem '"+bi+"'. It is not a child of this tree item.");return;}
...
;}
;qx.lang.Array.remove(this.__fU,bi);bi.setParent(null);bf.remove(bi);}
;var bg=this.getTree();if(bg){bg.fireNonBubblingEvent(f,qx.event.type.Data,[bi]);}
;qx.ui.core.queue.Widget.add(this);}
,removeAt:function(bj){var bk=this.__fU[bj];if(bk){this.remove(bk);}
;}
,removeAll:function(){var bl=this.__fU.concat();for(var i=this.__fU.length-1;i>=0;i--){this.remove(this.__fU[i]);}
;return bl;}
},destruct:function(){this._disposeArray(h);this._disposeObjects(g);}
});}
)();
...
(function(){var k="mousedown",j="qx.ui.core.scroll.NativeScrollBar",i="PositiveNumber",h="Integer",g="__nh",f="mousemove",d="_applyMaximum",c="_applyOrientation",b="scrollAnimationEnd",a="appear",A="PositiveInteger",z='qx.event.type.Event',y="mshtml",x="engine.name",w="mouseup",v="Number",u="_applyPosition",t="scrollbar",s="native",r="-1px",p="0",q="hidden",n="vertical",o="px",l="scroll",m="horizontal";qx.Class.define(j,{extend:qx.ui.core.Widget,implement:qx.ui.core.scroll.IScrollBar,construct:function(B){qx.ui.core.Widget.call(this);this.addState(s);this.getContentElement().addListener(l,this._onScroll,this);this.addListener(k,this._stopPropagation,this);this.addListener(w,this._stopPropagation,this);this.addListener(f,this._stopPropagation,this);this.addListener(a,this._onAppear,this);this.getContentElement().add(this._getScrollPaneElement());if(B!=null){this.setOrientation(B);}
else {this.initOrientation();}
;}
,events:{scrollAnimationEnd:z},properties:{appearance:{refine:true,init:t},orientation:{check:[m,n],init:m,apply:c},maximum:{check:A,apply:d,init:100},position:{check:v,init:0,apply:u,event:l},singleStep:{check:h,init:20},knobFactor:{check:i,nullable:true}},members:{__ng:null,__nh:null,__ni:null,_getScrollPaneElement:function(){if(!this.__nh){this.__nh=new qx.html.Element();}
;return this.__nh;}
...
,_getContentHint:function(){var G=qx.bom.element.Scroll.getScrollbarWidth();return {width:this.__ng?100:G,maxWidth:this.__ng?null:G,minWidth:this.__ng?null:G,height:this.__ng?G:100,maxHeight:this.__ng?G:null,minHeight:this.__ng?G:null};}
...
,_applyPosition:function(K){var content=this.getContentElement();if(this.__ng){content.scrollToX(K);}
else {content.scrollToY(K);}
;}
,_applyOrientation:function(L,M){var N=this.__ng=L===m;this.set({allowGrowX:N,allowShrinkX:N,allowGrowY:!N,allowShrinkY:!N});if(N){this.replaceState(n,m);}
...
,_updateScrollBar:function(){var P=this.__ng;var Q=this.getBounds();if(!Q){return;}
...
;var U=+(new Date());var V=this.getPosition();var W=function(X){if(X>=U+T){this.setPosition(Math.max(0,Math.min(this.getMaximum(),S)));this.__ni=null;this.fireEvent(b);}
...
,_onScroll:function(e){var bh=this.getContentElement();var bg=this.__ng?bh.getScrollX():bh.getScrollY();this.setPosition(bg);}
...
;}
,events:{"scrollAnimationEnd":f},properties:{appearance:{refine:true,init:A},orientation:{check:[t,o],init:t,apply:a},maximum:{check:C,apply:z,init:100},position:{check:h,init:0,apply:B,event:y},singleStep:{check:x,init:20},pageStep:{check:x,init:10,apply:D},knobFactor:{check:j,apply:g,nullable:true}},members:{__uB:2,__uC:0,_computeSizeHint:function(){var G=qx.ui.core.Widget.prototype._computeSizeHint.call(this);if(this.getOrientation()===t){this.__uC=G.minWidth;G.minWidth=0;}
else {this.__uC=G.minHeight;G.minHeight=0;}
;return G;}
,renderLayout:function(H,top,I,J){var L=qx.ui.core.Widget.prototype.renderLayout.call(this,H,top,I,J);var K=this.getOrientation()===t;if(this.__uC>=(K?I:J)){this.getChildControl(l).setVisibility(r);this.getChildControl(m).setVisibility(r);}
...
,_onResizeSlider:function(e){var be=this.getChildControl(u).getChildControl(d);var bh=be.getSizeHint();var bf=false;var bg=this.getChildControl(u).getInnerSize();if(this.getOrientation()==o){if(bg.height<bh.minHeight+this.__uB){bf=true;}
;}
else {if(bg.width<bh.minWidth+this.__uB){bf=true;}
;}
;if(bf){be.exclude();}
else {be.show();}
;}
...
,_onMouseDown:function(e){if(this.__uG){return;}
;var bm=this.__ng;var bk=this.getChildControl(z);var bl=bm?F:H;var bo=bm?e.getDocumentLeft():e.getDocumentTop();var bp=this.__uD=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bl];var bn=this.__uE=qx.bom.element.Location.get(bk.getContainerElement().getDomElement())[bl];if(e.getTarget()===bk){this.__uG=true;if(!this.__uL){this.__uL=new qx.event.Timer(100);this.__uL.addListener(x,this._fireValue,this);}
;this.__uL.start();this.__uH=bo+bp-bn;bk.addState(P);}
else {this.__uI=true;this.__uJ=bo<=bn?-1:1;this.__uP(e);this._onInterval();if(!this.__jQ){this.__jQ=new qx.event.Timer(100);this.__jQ.addListener(x,this._onInterval,this);}
;this.__jQ.start();}
;this.addListener(A,this._onMouseMove);this.capture();e.stopPropagation();}
,_onMouseUp:function(e){if(this.__uG){this.releaseCapture();delete this.__uG;this.__uL.stop();this._fireValue();delete this.__uH;this.getChildControl(z).removeState(P);if(e.getType()===J){var br;var bs;var bq;if(this.__ng){br=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__uD);bq=qx.bom.element.Location.get(this.getContentElement().getDomElement())[H];bs=e.getDocumentTop()-(bq+this.getChildControl(z).getBounds().top);}
else {br=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__uD);bq=qx.bom.element.Location.get(this.getContentElement().getDomElement())[F];bs=e.getDocumentLeft()-(bq+this.getChildControl(z).getBounds().left);}
;if(bs<0||bs>this.__uF||br<0||br>this.__uF){this.getChildControl(z).removeState(D);}
;}
;}
else if(this.__uI){this.__jQ.stop();this.releaseCapture();delete this.__uI;delete this.__uJ;delete this.__uK;}
;this.removeListener(A,this._onMouseMove);if(e.getType()===J){e.stopPropagation();}
;}
,_onMouseMove:function(e){if(this.__uG){var bu=this.__ng?e.getDocumentLeft():e.getDocumentTop();var bt=bu-this.__uH;this.slideTo(this._positionToValue(bt));}
else if(this.__uI){this.__uP(e);}
;e.stopPropagation();}
,_onInterval:function(e){var bv=this.getValue()+(this.__uJ*this.getPageStep());if(bv<this.getMinimum()){bv=this.getMinimum();}
else if(bv>this.getMaximum()){bv=this.getMaximum();}
;var bw=this.__uJ==-1;if((bw&&bv<=this.__uK)||(!bw&&bv>=this.__uK)){bv=this.__uK;}
;this.slideTo(bv);}
,_onUpdate:function(e){var by=this.getInnerSize();var bz=this.getChildControl(z).getBounds();var bx=this.__ng?Q:T;this._updateKnobSize();this.__uO=by[bx]-bz[bx];this.__uF=bz[bx];this._updateKnobPosition();}
,__ng:false,__uO:0,__uP:function(e){var bA=this.__ng;var bH=bA?e.getDocumentLeft():e.getDocumentTop();var bJ=this.__uD;var bB=this.__uE;var bL=this.__uF;var bI=bH-bJ;if(bH>=bB){bI-=bL;}
;var bF=this._positionToValue(bI);var bC=this.getMinimum();var bD=this.getMaximum();if(bF<bC){bF=bC;}
else if(bF>bD){bF=bD;}
else {var bG=this.getValue();var bE=this.getPageStep();var bK=this.__uJ<0?q:w;bF=bG+(Math[bK]((bF-bG)/bE)*bE);}
;if(this.__uK==null||(this.__uJ==-1&&bF<=this.__uK)||(this.__uJ==1&&bF>=this.__uK)){this.__uK=bF;}
;}
,_positionToValue:function(bM){var bN=this.__uO;if(bN==null||bN==0){return 0;}
;var bP=bM/bN;if(bP<0){bP=0;}
else if(bP>1){bP=1;}
;var bO=this.getMaximum()-this.getMinimum();return this.getMinimum()+Math.round(bO*bP);}
,_valueToPosition:function(bQ){var bR=this.__uO;if(bR==null){return 0;}
...
,_setKnobPosition:function(bU){var bV=this.getChildControl(z).getContainerElement();if(this.__ng){bV.setStyle(F,bU+O,true);}
...
;if(this.__ng){this.getChildControl(z).setWidth(Math.round(bX*bW.width));}
...
;if(cg){this.__uQ(cf,cg);}
else {this.setValue(cf);}
;}
,__uQ:function(ch,ci){if(this.__ni){return;}
...
,_applyOrientation:function(co,cp){var cq=this.getChildControl(z);this.__ng=co===u;if(this.__ng){this.removeState(t);cq.removeState(t);this.addState(u);cq.addState(u);cq.setLayoutProperties({top:0,right:null,bottom:0});}
...
else {if(this.__ng){this.getChildControl(z).resetWidth();}
else {this.getChildControl(z).resetHeight();}
;}
;}
,_applyValue:function(ct,cu){if(ct!=null){this._updateKnobPosition();if(this.__uG){this.__uN=[ct,cu];}
else {this.fireEvent(N,qx.event.type.Data,[ct,cu]);}
;}
else {this.resetValue();}
;}
,_fireValue:function(){if(!this.__uN){return;}
;var cv=this.__uN;this.__uN=null;this.fireEvent(N,qx.event.type.Data,cv);}
...
;this.__cS[bg]=e[p+bh]();bj.scrollBy(bi);if(this.__nj[bg]){clearTimeout(this.__nj[bg]);this.__nj[bg]=null;}
...
(function(){var l="_applyOpenMode",k="Space",j="Left",h="Enter",g="changeOpenMode",f="_applyRootOpenClose",d="changeSelection",c="qx.ui.tree.Tree",b="qx.ui.tree.core.AbstractTreeItem",a="tree",z="__nz",y="_applyHideRoot",x="changeRoot",w="_applyRoot",v="keypress",u="none",t="pane",s="Right",r="Boolean",q="excluded",o="visible",p="qx.event.type.Data",m="click",n="dblclick";qx.Class.define(c,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__nz=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(t).add(this.__nz);this.initOpenMode();this.initRootOpenClose();this.addListener(d,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:p,removeItem:p},properties:{openMode:{check:[m,n,u],init:n,apply:l,event:g,themeable:true},root:{check:b,init:null,nullable:true,event:x,apply:w},hideRoot:{check:r,init:false,apply:y},rootOpenClose:{check:r,init:false,apply:f},appearance:{refine:true,init:a},focusable:{refine:true,init:true}},members:{__nz:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__nz;}
...
,_getContentPaddingTarget:function(){return this.__nz;}
...
;this.__rC={};var E=this._transport=this._createTransport();this._setPhase(x);this.__uR=qx.lang.Function.bind(this._onReadyStateChange,this);this.__uS=qx.lang.Function.bind(this._onLoad,this);this.__uT=qx.lang.Function.bind(this._onLoadEnd,this);this.__uU=qx.lang.Function.bind(this._onAbort,this);this.__uV=qx.lang.Function.bind(this._onTimeout,this);this.__uW=qx.lang.Function.bind(this._onError,this);E.onreadystatechange=this.__uR;E.onload=this.__uS;E.onloadend=this.__uT;E.onabort=this.__uU;E.ontimeout=this.__uV;E.onerror=this.__uW;}
...
,nullable:true},authentication:{check:f,nullable:true}},members:{__uR:null,__uS:null,__uT:null,__uU:null,__uV:null,__uW:null,__uX:null,__uY:null,__va:null,__rC:null,__vb:null,_transport:null,_createTransport:function(){throw new Error("Abstract method call");}
...
;this.__uY=true;this.__va=n;this._transport.abort();}
,_setRequestHeaders:function(){var N=this._transport,L=this._getAllRequestHeaders();for(var M in L){N.setRequestHeader(M,L[M]);}
;}
,_getAllRequestHeaders:function(){var O={};qx.lang.Object.mergeWith(O,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(O,this.__vc());qx.lang.Object.mergeWith(O,this.__vb);qx.lang.Object.mergeWith(O,this.__rC);return O;}
,__vc:function(){var Q=this.getAuthentication(),P={};if(Q){Q.getAuthHeaders().forEach(function(R){P[R.key]=R.value;}
);return P;}
;}
,setRequestHeader:function(S,T){this.__rC[S]=T;}
,getRequestHeader:function(U){return this.__rC[U];}
,removeRequestHeader:function(V){if(this.__rC[V]){delete this.__rC[V];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__va;}
...
,getResponse:function(){return this.__uX;}
,_setResponse:function(X){var Y=X;if(this.__uX!==X){this.__uX=X;this.fireEvent(w,qx.event.type.Data,[this.__uX,Y]);}
;}
,_onReadyStateChange:function(){var ba=this.getReadyState();if(qx.core.Environment.get(l)){this.debug("Fire readyState: "+ba);}
;this.fireEvent(z);if(this.__uY){return;}
;if(ba===3){this._setPhase(d);}
;if(this.isDone()){this.__vd();}
;}
,__vd:function(){var bb;if(qx.core.Environment.get(l)){this.debug("Request completed with HTTP status: "+this.getStatus());}
...
,_setPhase:function(bd){var be=this.__va;if(qx.core.Environment.get(p)){qx.core.Assert.assertString(bd);qx.core.Assert.assertMatch(bd,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__va=bd;this.fireDataEvent(h,bd,be);}
...
;var y=v[f+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(y)){var A=qx.data&&qx.data.IListData&&qx.Class.hasInterface(y&&y.constructor,qx.data.IListData);for(var i=0;i<y.length;i++){var z=A?y.getItem(i):y[i];B+=this.__ve(name,z,w);}
;}
else if(qx.lang.Type.isDate(y)&&x!=null){B+=this.__ve(name,x.format(y),w);}
else {B+=this.__ve(name,y,w);}
;}
;return B.substring(0,B.length-1);}
,__ve:function(name,D,E){if(D instanceof qx.core.Object&&E!=null){var F=encodeURIComponent(E(D));if(F===undefined){var F=encodeURIComponent(D);}
;}
...
,init:true}},members:{__vf:null,_createTransport:function(){return new qx.bom.request.Xhr();}
...
;}
;return A;}
,setParser:function(B){var C=qx.io.request.Xhr;if(typeof C.PARSER[B]===b){return this.__vf=C.PARSER[B];}
;if(qx.core.Environment.get(n)){qx.core.Assert.assertFunction(B);}
;return this.__vf=B;}
,_getParser:function(){var D=this.__vf,E;if(D){return D;}
...
(function(){var k="activex",j="If-None-Match",i="xhr",h="engine.version",g="GET",f="-1",d="load",c="abort",b="Microsoft.XMLHTTP",a="browser.version",G="If-Match",F="Microsoft.XMLDOM",E="If-Range",D="Content-Type",C="io.xhr",B="on",A="timeout",z="If-Modified-Since",y="onunload",x="browser.documentmode",r="loadend",s="opera",p="gecko",q="file:",n="error",o="mshtml",l="undefined",m="qx.debug.io",t="",u="readystatechange",w="qx.bom.request.Xhr",v="engine.name";qx.Bootstrap.define(w,{construct:function(){this.__vg=qx.Bootstrap.bind(this.__vt,this);this.__vh=qx.Bootstrap.bind(this.__vs,this);this.__uV=qx.Bootstrap.bind(this.__vx,this);this.__vr();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__vi=qx.Bootstrap.bind(this.__vA,this);window.attachEvent(y,this.__vi);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":w,"error":w,"loadend":w,"timeout":w,"abort":w,"load":w},members:{readyState:0,responseText:t,responseXML:null,status:0,statusText:t,timeout:0,open:function(H,I,J,K,L){this.__vC();if(typeof I===l){throw new Error("Not enough arguments");}
else if(typeof H===l){H=g;}
;this.__uY=false;this.__vj=false;this.__vk=false;this.__vl=I;if(typeof J==l){J=true;}
;this.__vm=J;if(!this.__vB()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__vr();}
;this.__vo.onreadystatechange=this.__vg;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Open native request with method: "+H+", url: "+I+", async: "+J);}
;this.__vo.open(H,I,J,K,L);}
catch(M){if(!qx.util.Request.isCrossDomain(I)){throw M;}
;if(!this.__vm){this.__vn=M;}
;if(this.__vm){if(window.XDomainRequest){this.readyState=4;this.__vo=new XDomainRequest();this.__vo.onerror=qx.Bootstrap.bind(function(){this._emit(u);this._emit(n);this._emit(r);}
...
;this.__vo.open(H,I,J,K,L);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__vq){return;}
;this.readyState=4;this._emit(u);this._emit(n);this._emit(r);}
,this));}
;}
;if(qx.core.Environment.get(v)===o&&qx.core.Environment.get(x)<9&&this.__vo.readyState>0){this.__vo.setRequestHeader(z,f);}
;if(qx.core.Environment.get(v)===p&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__vm){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(u);}
;}
,setRequestHeader:function(N,O){this.__vC();if(N==G||N==z||N==j||N==E){this.__vk=true;}
;this.__vo.setRequestHeader(N,O);return this;}
,send:function(P){this.__vC();if(!this.__vm&&this.__vn){throw this.__vn;}
;if(qx.core.Environment.get(v)===s&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__vp=window.setTimeout(this.__uV,this.timeout);}
;P=typeof P==l?null:P;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Send native request");}
;this.__vo.send(P);}
catch(R){if(!this.__vm){throw R;}
;if(this._getProtocol()===q){this.readyState=2;this.__vu();var Q=this;window.setTimeout(function(){if(Q.__vq){return;}
;Q.readyState=3;Q.__vu();Q.readyState=4;Q.__vu();}
);}
;}
;if(qx.core.Environment.get(v)===p&&!this.__vm){this.__vt();}
;this.__vj=true;return this;}
,abort:function(){this.__vC();this.__uY=true;this.__vo.abort();if(this.__vo){this.readyState=this.__vo.readyState;}
;return this;}
...
,getResponseHeader:function(U){this.__vC();return this.__vo.getResponseHeader(U);}
,getAllResponseHeaders:function(){this.__vC();return this.__vo.getAllResponseHeaders();}
,getRequest:function(){return this.__vo;}
,dispose:function(){if(this.__vq){return false;}
;window.clearTimeout(this.__vp);if(window.detachEvent){window.detachEvent(y,this.__vi);}
;try{this.__vo.onreadystatechange;}
catch(W){return false;}
;var V=function(){}
;this.__vo.onreadystatechange=V;this.__vo.onload=V;this.__vo.onerror=V;this.abort();this.__vo=null;this.__vq=true;return true;}
...
,_getProtocol:function(){var Y=this.__vl;var ba=/^(\w+:)\/\//;if(Y!==null&&Y.match){var bb=Y.match(ba);if(bb&&bb[1]){return bb[1];}
;}
;return window.location.protocol;}
,__vo:null,__vm:null,__vg:null,__vh:null,__vi:null,__uV:null,__vj:null,__vl:null,__uY:null,__fw:null,__vq:null,__vp:null,__vn:null,__vk:null,__vr:function(){this.__vo=this._createNativeXhr();this.__vo.onreadystatechange=this.__vg;if(this.__vo.onabort){this.__vo.onabort=this.__vh;}
;this.__vq=this.__vj=this.__uY=false;}
,__vs:function(){if(!this.__uY){this.abort();}
;}
,__vt:function(){var bc=this.__vo,bd=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Received native readyState: "+bc.readyState);}
;if(this.readyState==bc.readyState){return;}
;this.readyState=bc.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__uY&&!this.__vj){return;}
;if(!this.__vm&&(bc.readyState==2||bc.readyState==3)){return;}
...
;if(bd){this.__vy();this.__vz();}
;}
;this.__vu();if(this.readyState==qx.bom.request.Xhr.DONE){if(bc){bc.onreadystatechange=function(){}
;}
;}
;}
,__vu:function(){var bf=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__vp);}
;if(qx.core.Environment.get(v)==o&&qx.core.Environment.get(x)<8){if(this.__vm&&!this.__vj&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(bf.__vq){return;}
;bf.readyState=3;bf._emit(u);bf.readyState=4;bf._emit(u);bf.__vv();}
);return;}
;}
;}
;this._emit(u);if(this.readyState===qx.bom.request.Xhr.DONE){this.__vv();}
;}
,__vv:function(){if(this.__fw){this._emit(A);if(qx.core.Environment.get(v)===s){this._emit(n);}
;this.__fw=false;}
else {if(this.__uY){this._emit(c);}
else {if(this.__vw()){this._emit(n);}
else {this._emit(d);}
;}
;}
;this._emit(r);}
,__vw:function(){var bg;if(this._getProtocol()===q){bg=!this.responseText;}
else {bg=!this.statusText;}
;return bg;}
,__vx:function(){var bh=this.__vo;this.readyState=qx.bom.request.Xhr.DONE;this.__fw=true;bh.abort();this.responseText=t;this.responseXML=null;this.__vu();}
,__vy:function(){var bi=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===q&&this.status===0&&bi){if(!this.__vw()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(v)===s){if(bi&&this.__vk&&!this.__uY&&this.status===0){this.status=304;}
;}
;}
,__vz:function(){if(qx.core.Environment.get(v)==o&&(this.getResponseHeader(D)||t).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bj=new window.ActiveXObject(F);bj.async=false;bj.validateOnParse=false;bj.loadXML(this.responseText);this.responseXML=bj;}
;}
,__vA:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__vB:function(){var name=qx.core.Environment.get(v);var bk=qx.core.Environment.get(a);return !(name==o&&bk<9||name==p&&bk<3.5);}
,__vC:function(){if(this.__vq){throw new Error("Already disposed");}
;}
},defer:function(){qx.core.Environment.add(m,false);}
});}
)();
(function(){var o="^",n="demobrowser.TreeDataHandler",m="ttree",l="\\.[^\\.]+$",h="demobrowser.withTests",g="depth",f="All",e=".",d="",c="test";qx.Class.define(n,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.tmap=p;this.ttree=this.__vD(p);}
,members:{__vD:function(q){var s=q;function r(w,x){var A=x.classname;var y=A.split(e);function z(parent,C){if(!C.length){return parent;}
...
;}
,__ec:function(){{var bh=qx.theme.manager.Color.getInstance();var bj=bh.resolve(this.getStartColor());var bi=bh.resolve(this.getEndColor());}
;return {start:bj,end:bi};}
,_getContent:function(){if(qx.core.Environment.get(E)&&!qx.core.Environment.get(u)){var bm=this.__ec();var bp=this.getOrientation()==z?1:0;var bo=qx.util.ColorUtil.hex3StringToHex6String(bm.start);var bl=qx.util.ColorUtil.hex3StringToHex6String(bm.end);bo=bo.substring(1,bo.length);bl=bl.substring(1,bl.length);var bn=G;if(this.classname.indexOf(M)!=-1){var bk={};this._styleBoxShadow(bk);bn=e+qx.bom.element.Style.compile(bk)+b;}
...
;}
;}
,__ef:function(M){var Q=this._generateBackgroundMarkup(M,this._getContent?this._getContent():a);{var O=qx.theme.manager.Color.getInstance();var T=O.resolve(this.getColorTop());var P=O.resolve(this.getColorRight());var N=O.resolve(this.getColorBottom());var S=O.resolve(this.getColorLeft());}
...
;}
;M[z]=y;M[i]=0;M[D]=0;return this.__ed=this._generateBackgroundMarkup(M,Q);}
,__eg:function(U,V,W){var X=this.getInsets();V-=X.left+X.right;W-=X.top+X.bottom;var Y=X.left-this.getWidthLeft()-this.getInnerWidthLeft();var top=X.top-this.getWidthTop()-this.getInnerWidthTop();return {left:Y,top:top,width:V,height:W,elementToApplyDimensions:U.firstChild};}
