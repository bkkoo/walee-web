...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.c4c1ad61db58.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="one",m="_applySpacing",k="Integer",h="_applyDragSelection",g="String",f="resize",d="demobrowser.demo.virtual.list.List",c="list",b="multi",a="_applyQuickSelection",C="_applyItemHeight",B="_applySelectionMode",A="additive",z="changeName",y="Number",x="addItem",w="removeItem",v="changeSelection",u="row",t="single",r="changeHeight",s=",",p="Boolean",q="selected",o="qx.event.type.Data";qx.Class.define(d,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__GR=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__GR);this.getPane().addListener(f,this._onResize,this);this.__nY=[];this.__cQ=[];this.__pd=new qx.ui.virtual.selection.Row(this.getPane());this.__pd.addListener(v,this._onChangeSelection,this);this.__pd.attachMouseEvents();this.__pd.attachKeyEvents(this);this.__pd.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:o,removeItem:o,changeValue:o,changeSelection:o},properties:{appearance:{refine:true,init:c},focusable:{refine:true,init:true},spacing:{check:k,init:0,apply:m,themeable:true},enableInlineFind:{check:p,init:true},name:{check:g,nullable:true,event:z},itemHeight:{init:24,themeable:true,check:y,apply:C},selectionMode:{check:[t,b,A,n],init:t,apply:B},dragSelection:{check:p,init:false,apply:h},quickSelection:{check:p,init:false,apply:a}},members:{__nY:null,__cQ:null,__pd:null,__GR:null,syncWidget:function(){this.update();}
,update:function(){var E=this.getPane().getRowConfig();E.setItemCount(this.__nY.length);E.resetItemSizes();for(var i=0;i<this.__nY.length;i++){var D=this.__nY[i].getHeight();if(D!==null){E.setItemSize(i,D);}
;}
;}
,updateSelection:function(){var F=this.__GR.getChildren();for(var i=0;i<F.length;i++){var G=F[i];var H=G.getUserData(u);if(this.__pd.isItemSelected(H)){G.addState(q);}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(v,this.__GV(e.getData()));}
,getCellWidget:function(I,J){var L=this.__nY[I];if(!L){return null;}
;var K=this.__cQ.pop()||new qx.ui.form.ListItem();K.set({label:L.getLabel(),icon:L.getIcon()});if(this.__pd.isItemSelected(I)){K.addState(q);}
...
,hasChildren:function(){return this.__nY.length>0;}
...
,add:function(W){this.__nY.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__nY,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__nY.length;i<j;i++){this._removeHelper(this.__nY[i]);}
;this.__nY=[];}
,indexOf:function(Y){return this.__nY.indexOf(Y);}
,addAt:function(ba,bb){qx.lang.Array.insertAt(this.__nY,ba,bb);this._addHelper(ba);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__nY,bc,bd);this._addHelper(bc);}
,addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__nY,be,bf);this._addHelper(be);}
,removeAt:function(bg){this.__nY.splice(bg,1);this._removeHelper(this.__nY[bg]);}
,__GS:function(bh){var bi=this.__nY.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__GT:function(bj){var bk=this.__nY[bj];return bk;}
,__GU:function(bl){var bm=[];for(var i=0;i<bl.length;i++){bm.push(this.__GS(bl[i]));}
;return bm;}
,__GV:function(bn){var bo=[];for(var i=0;i<bn.length;i++){bo.push(this.__nY[bn[i]]);}
;return bo;}
,selectAll:function(){this.__pd.selectAll();}
,setSelected:function(bp){this.__pd.selectItem(this.__GS(bp));}
,isSelected:function(bq){return this.__pd.isItemSelected(this.__GS(bq));}
,addToSelection:function(br){this.__pd.addItem(this.__GS(br));}
,removeFromSelection:function(bs){this.__pd.removeItem(this.__GS(bs));}
,selectRange:function(bt,bu){this.__pd.selectItemRange(this.__GS(bt),this.__GS(bu));}
,resetSelection:function(){this.__pd.clearSelection();}
,setSelection:function(bv){this.__pd.replaceSelection(this.__GU(bv));}
,getSelectedItem:function(){return this.__nY[this.getSelected()];}
,getSelected:function(){return this.__nY[this.__pd.getSelectedItem()];}
,getSelection:function(){return this.__GV(this.__pd.getSelection());}
,getSortedSelection:function(){return this.__GV(this.__pd.getSortedSelection());}
,isSelectionEmpty:function(){return this.__pd.isSelectionEmpty();}
,getSelectionContext:function(){return this.__pd.getSelectionContext();}
,getSelectables:function(){return this.__GV(this.__pd.getSelectables());}
,_applySelectionMode:function(bw,bx){this.__pd.setMode(bw);}
,_applyDragSelection:function(by,bz){this.__pd.setDrag(by);}
,_applyQuickSelection:function(bA,bB){this.__pd.setQuick(bA);}
}});}
)();
