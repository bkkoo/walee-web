...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.4df59094e41e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="Window: ",d="interval",c="Label: ",b="__jQ",a="demobrowser.demo.test.Destructor";qx.Class.define(a,{extend:qx.application.Standalone,members:{__cR:null,__GD:0,__jQ:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cR=[];this.currentTest=this.testWindows;this.__jQ=new qx.event.Timer(1000);this.__jQ.addListener(d,this.runTest,this);this.__jQ.start();}
,runTest:function(){this.__GD++;var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug("Round: "+this.__GD+" (Registry: "+g+")");this.currentTest();qx.ui.core.queue.Manager.flush();var f=this.__cR;for(var i=0,l=f.length;i<l;i++){f[i].destroy();}
...
,testLabels:function(){for(var i=0;i<250;i++){var h=new qx.ui.basic.Label(c+i);this.getRoot().add(h,{left:50,top:50+i*20});this.__cR.push(h);}
;}
