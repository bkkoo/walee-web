...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.69d6a1120293.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(u);var D={"width":f,"height":w,"position":l,"left":o,"top":o,"background":i+G+n};this.__Ez=new qx.html.Element(m,D);this.__Ez.addListener(k,this.__Eu,this);this.__Ez.addListener(B,this.__EE,this);F.add(this.__Ez);}
,__Eu:function(e){if(e.isMultiTouch()){this.__EC=e.getRotation()+this.__EB;this.__ED=e.getScale()*this.__EA;this.__Ez.setStyle(C,r+this.__EC+g+this.__ED+n);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__Ez.getStyle(A))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__Ez.getStyle(j))/2);this.__Ez.setStyles({"left":I+q,"top":top+q});}
;}
,__EE:function(e){if(e.isMultiTouch()){this.__EB=this.__EC;this.__EA=this.__ED;}
;}
}});}
)();
