...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.5f9793fc1a69.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__JJ:4,__JK:0,add:function(B){this.container.add(B,{row:Math.floor(this.__JK/this.__JJ),column:this.__JK%this.__JJ});this.__JK+=1;}
