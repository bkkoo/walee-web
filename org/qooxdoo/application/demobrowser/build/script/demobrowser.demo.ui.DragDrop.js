...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop.984f94e331ac.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="drag",k="TextArea Target",j="solid",h="Copy Even Items",g="Reorderable",f="qx.ui.form.ListItem",d="droprequest",c="#33508D",b="Source",a="demobrowser.demo.ui.DragDrop",C="Simple Target",B="Enable drag",A="dragchange",z="__Cu",y="\n",x="dragend",w="icon/16/places/folder.png",v="dragstart",u="Item ",t="move",r="multi",s="copy",p="value",q="dragover",n="drop",o="items";qx.Class.define(a,{extend:qx.application.Standalone,members:{__Cu:null,__Hp:null,main:function(){qx.application.Standalone.prototype.main.call(this);var Q=this.getRoot();var I=new qx.ui.container.Scroll();var D=new qx.ui.layout.Basic();var G=new qx.ui.container.Composite(D).set({allowStretchY:false,allowStretchX:false});I.add(G);Q.add(I,{edge:0});var P=new qx.ui.basic.Label(b);G.add(P,{left:20,top:20});var N=new qx.ui.form.List;N.setDraggable(true);N.setSelectionMode(r);G.add(N,{left:20,top:40});for(var i=0;i<20;i++){N.add(new qx.ui.form.ListItem(u+i,w));}
;var R=new qx.ui.form.CheckBox(B);R.setValue(true);G.add(R,{left:20,top:260});N.addListener(v,function(e){if(!R.isValue()){e.preventDefault();}
...
;}
;e.addData(W,T);}
);var J=new qx.ui.basic.Label(C);G.add(J,{left:140,top:20});var H=new qx.ui.form.List;H.setDroppable(true);H.setSelectionMode(r);G.add(H,{left:140,top:40});H.addListener(n,function(e){this.debug("Related of drop: "+e.getRelatedTarget());var X=e.getData(o);for(var i=0,l=X.length;i<l;i++){this.add(X[i]);}
;}
...
;}
);M.addListener(A,function(e){if(e.getCurrentAction()!=s){e.preventDefault();}
;}
...
;}
);var L=new qx.ui.basic.Label(g);G.add(L,{left:600,top:20});var E=this.__Cu=new qx.ui.form.List;E.setDraggable(true);E.setDroppable(true);E.setSelectionMode(r);G.add(E,{left:600,top:40});for(var i=0;i<20;i++){E.add(new qx.ui.form.ListItem(u+i,w));}
...
);E.addListener(m,function(e){var bb=e.getOriginalTarget();if(bb instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Hp=bb;}
...
;}
);E.addListener(n,function(e){this.__Hq(e.getOriginalTarget());}
,this);F.addListener(n,function(e){this.__Hq(this.__Hp);}
,this);}
,__Hq:function(bc){if(bc.classname!=f){return;}
;var bd=this.__Cu.getSortedSelection();for(var i=0,l=bd.length;i<l;i++){this.__Cu.addBefore(bd[i],bc);this.__Cu.addToSelection(bd[i]);}
;}
