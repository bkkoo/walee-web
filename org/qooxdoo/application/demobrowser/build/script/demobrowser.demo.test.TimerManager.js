...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager.ee046dd6a722.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="One-shot 1-second timer: ",e="__GH",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";qx.Class.define(d,{extend:qx.application.Standalone,members:{__GH:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();i.start(function(j,k){this.__GI(c+k);}
,5000,this,null,0);i.start(function(l,m){this.__GI(f+m);}
,0,this,null,1000);i.start(function(n,o){this.__GI(g+o);if(++n.count==3){this.__GI(h);i.stop(o);}
;}
,2000,this,{count:0},2000);}
,__GI:function(p){p=Date.parse(new Date)+" "+p+"\n";this.__GH.setValue(this.__GH.getValue()+p);}
...
,this);var t=new qx.ui.form.TextArea();t.set({width:400,height:300});this.__GH=t;q.add(t);q.add(s);this.getRoot().add(q,{left:20,top:10});}
},destruct:function(){this._disposeObjects(e);}
});}
)();
