...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr.2ce67830663a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(C,{extend:qx.data.store.Jsonp,construct:function(R){this.setCallbackName(v);qx.data.store.Jsonp.call(this,this.__Br(R));}
,members:{searchForTag:function(S){if(S!=l){this.setUrl(this.__Br(S));}
;}
,__Br:function(T){if(!T){return;}
