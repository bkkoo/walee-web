...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList.b599465615cd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
};T.setDelegate(V);T.setSelection(this.__Cu.getSelection());return U;}
,createThirdExample:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var be=new qx.ui.basic.Label(z).set({font:n});bc.add(be);var bb=this.__IE=new qx.ui.list.List().set({height:280,width:150,labelPath:p,labelOptions:{converter:function(bf,bg){return bg?bf+o+bg.getLastname():v;}
...
};bb.setDelegate(bd);bb.setSelection(this.__Cu.getSelection());return bc;}
},destruct:function(){this.__Cu.dispose();this.__ID.dispose();this.__IE.dispose();this.__Cu=this.__ID=this.__IE=null;}
});}
)();
...
(function(){var g="scrollY",f="update",d="scrollX",c="pane",b="os.scrollBarOverlayed",a="qx.ui.virtual.core.Scroller";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(h,i,j,k){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__CE=new qx.ui.virtual.core.Pane(h,i,j,k);this.__CE.addListener(f,this._computeScrollbars,this);this.__CE.addListener(d,this._onScrollPaneX,this);this.__CE.addListener(g,this._onScrollPaneY,this);if(qx.core.Environment.get(b)){this._add(this.__CE,{edge:0});}
else {this._add(this.__CE,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__CE:null,getPane:function(){return this.__CE;}
,_createChildControlImpl:function(l,m){if(l==c){return this.__CE;}
...
,_onScrollBarX:function(e){this.__CE.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__CE.setScrollY(e.getData());}
},destruct:function(){this.__CE.dispose();this.__CE=null;}
});}
)();
(function(){var l="scrollY",k="mousedown",j="__CM",h="dblclick",g="qx.debug",f="qx.event.type.Event",d="__CF",c="cellContextmenu",b="resize",a="scrollX",x="cellDblclick",w="__CN",v="qx.ui.virtual.core.Pane",u="click",t="update",s="cellClick",r="contextmenu",q="__CG",p="qx.event.type.Data",o="change",m="qx.ui.virtual.core.CellEvent",n="appear";qx.Class.define(v,{extend:qx.ui.core.Widget,construct:function(y,z,A,B){qx.ui.core.Widget.call(this);this.__CF=new qx.ui.virtual.core.Axis(A,y);this.__CG=new qx.ui.virtual.core.Axis(B,z);this.__CH=0;this.__CI=0;this.__CJ=0;this.__CK=0;this.__CL={};this.__iL={};this.__CM=new qx.ui.container.Composite();this.__CM.setUserBounds(0,0,0,0);this._add(this.__CM);this.__CN=[];this.__CF.addListener(o,this.fullUpdate,this);this.__CG.addListener(o,this.fullUpdate,this);this.addListener(b,this._onResize,this);this.addListenerOnce(n,this._onAppear,this);this.addListener(k,this._onMouseDown,this);this.addListener(u,this._onClick,this);this.addListener(h,this._onDblclick,this);this.addListener(r,this._onContextmenu,this);}
,events:{cellClick:m,cellContextmenu:m,cellDblclick:m,update:f,scrollX:p,scrollY:p},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__CF:null,__CG:null,__CH:null,__CI:null,__CJ:null,__CK:null,__CL:null,__iL:null,__CM:null,__CN:null,__CO:null,__pz:null,__CP:null,__CQ:null,getRowConfig:function(){return this.__CF;}
,getColumnConfig:function(){return this.__CG;}
,getChildren:function(){return [this.__CM];}
,addLayer:function(C){if(qx.core.Environment.get(g)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__CN.push(C);C.setUserBounds(0,0,0,0);this.__CM.add(C);}
,getLayers:function(){return this.__CN;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__CN.length;i++){var E=this.__CN[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__CG.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__CF.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(H){var I=this.getScrollMaxY();if(H<0){H=0;}
else if(H>I){H=I;}
;if(this.__CH!==H){var J=this.__CH;this.__CH=H;this._deferredUpdateScrollPosition();this.fireDataEvent(l,H,J);}
;}
,getScrollY:function(){return this.__CH;}
,setScrollX:function(K){var L=this.getScrollMaxX();if(K<0){K=0;}
else if(K>L){K=L;}
;if(K!==this.__CI){var M=this.__CI;this.__CI=K;this._deferredUpdateScrollPosition();this.fireDataEvent(a,K,M);}
;}
,getScrollX:function(){return this.__CI;}
,getScrollSize:function(){return {width:this.__CG.getTotalSize(),height:this.__CF.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__CF.getItemPosition(N);var P=R+this.__CF.getItemSize(N);var O=this.getScrollY();if(R<O){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__CG.getItemPosition(S);var T=U+this.__CG.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bd=this.__CF.getItemAtPosition(this.getScrollY()+bc-bf.top);be=this.__CG.getItemAtPosition(this.getScrollX()+bb-bf.left);if(!bd||!be){return null;}
...
;var bn=this.__CI+bm.width;var bo=this.__CK-bn;if(this.__CI-this.__CL.left<Math.min(this.__CI,bg)||this.__CL.right-bn<Math.min(bo,bi)){var bp=Math.min(this.__CI,bh);var bl=Math.min(bo,bj);this._setLayerWindow(bk,this.__CI-bp,this.__CH,bm.width+bp+bl,bm.height,false);}
;}
,prefetchY:function(bq,br,bs,bt){var bu=this.getVisibleLayers();if(bu.length==0){return;}
;var bx=this.getBounds();if(!bx){return;}
;var bv=this.__CH+bx.height;var bw=this.__CJ-bv;if(this.__CH-this.__CL.top<Math.min(this.__CH,bq)||this.__CL.bottom-bv<Math.min(bw,bs)){var bz=Math.min(this.__CH,br);var by=Math.min(bw,bt);this._setLayerWindow(bu,this.__CI,this.__CH-bz,bx.width,bx.height+bz+by,false);}
;}
,_onResize:function(){if(this.getContainerElement().getDomElement()){this.__CO=true;this._updateScrollPosition();this.__CO=null;this.fireEvent(t);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onMouseDown:function(e){this.__CQ=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onClick:function(e){this.__CR(e,s);}
,_onContextmenu:function(e){this.__CR(e,c);}
,_onDblclick:function(e){this.__CR(e,x);}
,__CR:function(e,bA){var bC=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bC){return;}
;var bB=this.__CQ;if(bB==null||bB.row!==bC.row||bB.column!==bC.column){return;}
;this.fireNonBubblingEvent(bA,qx.ui.virtual.core.CellEvent,[this,e,bC.row,bC.column]);}
,syncWidget:function(bD){if(this.__iL._fullUpdate){this._fullUpdate();}
else if(this.__iL._updateScrollPosition){this._updateScrollPosition();}
;this.__iL={};}
,_setLayerWindow:function(bE,bF,top,bG,bH,bI){var bN=this.__CF.getItemAtPosition(top);if(bN){var bP=bN.index;var bT=this.__CF.getItemSizes(bP,bH+bN.offset);var bO=qx.lang.Array.sum(bT);var bV=top-bN.offset;var bS=top-bN.offset+bO;}
else {var bP=0;var bT=[];var bO=0;var bV=0;var bS=0;}
;var bR=this.__CG.getItemAtPosition(bF);if(bR){var bL=bR.index;var bK=this.__CG.getItemSizes(bL,bG+bR.offset);var bQ=qx.lang.Array.sum(bK);var bU=bF-bR.offset;var bM=bF-bR.offset+bQ;}
else {var bL=0;var bK=[];var bQ=0;var bU=0;var bM=0;}
;this.__CL={top:bV,bottom:bS,left:bU,right:bM};this.__CM.setUserBounds(this.__CL.left-this.__CI,this.__CL.top-this.__CH,bQ,bO);this.__pz=bK;this.__CP=bT;for(var i=0;i<this.__CN.length;i++){var bJ=this.__CN[i];bJ.setUserBounds(0,0,bQ,bO);if(bI){bJ.fullUpdate(bP,bL,bT,bK);}
else {bJ.updateLayerWindow(bP,bL,bT,bK);}
;}
;}
,__CS:function(){if(this.__CO){return;}
;var bW=this.getScrollSize();if(this.__CJ!==bW.height||this.__CK!==bW.width){this.__CJ=bW.height;this.__CK=bW.width;this.fireEvent("update");}
;}
,fullUpdate:function(){this.__iL._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__iL._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__CS();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__CI,this.__CH,bY.width,bY.height,true);this.__CS();}
,_deferredUpdateScrollPosition:function(){this.__iL._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__CS();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__CH,bottom:this.__CH+cc.height,left:this.__CI,right:this.__CI+cc.width};if(this.__CL.top<=cb.top&&this.__CL.bottom>=cb.bottom&&this.__CL.left<=cb.left&&this.__CL.right>=cb.right){this.__CM.setUserBounds(this.__CL.left-cb.left,this.__CL.top-cb.top,this.__CL.right-this.__CL.left,this.__CL.bottom-this.__CL.top);}
else {this._setLayerWindow(ca,this.__CI,this.__CH,cc.width,cc.height,false);}
;this.__CS();}
},destruct:function(){this._disposeArray(w);this._disposeObjects(d,q,j);this.__CL=this.__iL=this.__pz=this.__CP=null;}
});}
)();
...
,events:{"change":f},members:{__CT:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__CT=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__CT=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__CT=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__CT=null;this.fireNonBubblingEvent(c);}
,__CU:function(){if(this.__CT){return this.__CT;}
;var r=this.defaultItemSize;var y=this.itemCount;var t=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<y){t.push(p);}
;}
;if(t.length==0){var u=[{startIndex:0,endIndex:y-1,firstItemSize:r,rangeStart:0,rangeEnd:y*r-1}];this.__CT=u;return u;}
...
;var z=u[u.length-1];var w=(y-z.startIndex-1)*r;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=y-1;this.__CT=u;return u;}
,__CV:function(A){var B=this.__CT||this.__CU();var C=0;var E=B.length-1;while(true){var F=C+((E-C)>>1);var D=B[F];if(D.rangeEnd<A){C=F+1;}
else if(D.rangeStart>A){E=F-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(G){if(G<0||G>=this.getTotalSize()){return null;}
;var I=this.__CV(G);var K=I.rangeStart;var H=I.startIndex;var L=I.firstItemSize;if(K+L>G){return {index:H,offset:G-K};}
else {var J=this.defaultItemSize;return {index:H+1+Math.floor((G-K-L)/J),offset:(G-K-L)%J};}
;}
,__CW:function(M){var N=this.__CT||this.__CU();var O=0;var Q=N.length-1;while(true){var R=O+((Q-O)>>1);var P=N[R];if(P.endIndex<M){O=R+1;}
else if(P.startIndex>M){Q=R-1;}
else {return P;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__CW(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__CT||this.__CU();return U[U.length-1].rangeEnd+1;}
...
;}
;return Y;}
},destruct:function(){this.customSizes=this.__CT=null;}
});}
)();
...
,_onChangeSelection:function(e){if(this.__Da==true){return;}
;this.__CY=true;var F=this.getSelection();var H=[];for(var i=0;i<F.getLength();i++){var G=F.getItem(i);var I=this._getSelectables();var E=-1;if(I!=null){E=I.indexOf(G);}
...
;this.__Db();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__CY=false;}
,_onManagerChangeSelection:function(e){if(this.__CY==true){return;}
;this.__Da=true;this.__Db();this.__Da=false;}
,__Db:function(){if(this.__Dd()){return;}
;var L=this._manager.getSelection();var M=[];for(var i=0;i<L.length;i++){var N=this._getDataFromRow(L[i]);if(N!=null){M.push(N);}
;}
;this.__Dc(M);}
,__Dc:function(O){var P=this.getSelection();if(O.length>0){var R=[0,P.getLength()];R=R.concat(O);var Q=P.splice.apply(P,R);Q.dispose();}
else {P.removeAll();}
;}
,__Dd:function(){var T=this.getSelection();var V=this._manager.getSelection();if(T.getLength()!==V.length){return false;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__CX){this.__CX.dispose();}
;}
});}
)();
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__Ap=[];this.__Df=[];this.__Dg={};this.__Dh=false;this.__Di=false;this.__Dj=false;this.getPane().addListener(v,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__Ap;}
,_lookup:function(M){return this.__Ap[M];}
,_lookupGroup:function(N){return this.__Df.indexOf(N);}
,_reverseLookup:function(O){if(O<0){return -1;}
;return this.__Ap.indexOf(O);}
...
,_applyDelegate:function(bh,bi){this._provider.setDelegate(bh);this.__AD();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this.__AD();this._applyDefaultSelection();}
,__Dk:function(){this.getPane().getRowConfig().setItemCount(this.__Ap.length);this.getPane().fullUpdate();}
,__AD:function(){this.__Ap=[];this.__Df=[];this.__Dg={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var bj=this.getModel();if(bj!=null){this._runDelegateFilter(bj);this._runDelegateSorter(bj);this._runDelegateGroup(bj);}
;this._updateSelection();this.__Dk();}
,_runDelegateFilter:function(bk){var bl=qx.util.Delegate.getMethod(this.getDelegate(),g);for(var i=0,l=bk.length;i<l;++i){if(bl==null||bl(bk.getItem(i))){this.__Ap.push(i);}
;}
;}
,_runDelegateSorter:function(bm){if(this.__Ap.length==0){return;}
;var bn=qx.util.Delegate.getMethod(this.getDelegate(),c);if(bn!=null){this.__Ap.sort(function(a,b){return bn(bm.getItem(a),bm.getItem(b));}
);}
;}
,_runDelegateGroup:function(bo){var bs=qx.util.Delegate.getMethod(this.getDelegate(),r);if(bs!=null){for(var i=0,l=this.__Ap.length;i<l;++i){var bp=this.__Ap[i];var br=this.getModel().getItem(bp);var bq=bs(br);this.__Dl(bq,bp);}
;this.__Ap=this.__Dm();}
;}
,__Dl:function(bt,bu){if(bt==null){this.__Dj=true;bt=B;}
;var name=this.__Dn(bt);if(this.__Dg[name]==null){this.__Dg[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bt);}
;}
;this.__Dg[name].push(bu);}
,__Dm:function(){this.__Do();var by=[];var bA=0;var bw=this.getGroups();for(var i=0;i<bw.getLength();i++){var bv=bw.getItem(i);by.push(-1);this.__Df.push(bA);bA++;var bz=this.__Dn(bv);var bx=this.__Dg[bz];if(bx!=null){for(var k=0;k<bx.length;k++){by.push(bx[k]);bA++;}
;}
;}
;return by;}
,__Dn:function(bB){var name=null;if(!qx.lang.Type.isString(bB)){var bC=this.getGroups().indexOf(bB);this.__Di=true;name=r;if(bC==-1){name+=this.getGroups().getLength();}
else {name+=bC;}
;}
else {this.__Dh=true;var name=bB;}
;return name;}
,__Do:function(){if(this.__Di&&this.__Dj||this.__Di&&this.__Dh){throw new Error("GroupingTypeError: You can't mix 'Objects' and 'Strings' as"+" group identifier!");}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__Ap=this.__Df=this.__Dg=null;if(this.__De){this.__De.dispose();}
;}
});}
)();
(function(){var b="qx.ui.virtual.layer.Abstract",a="abstract";qx.Class.define(b,{extend:qx.ui.core.Widget,type:a,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__iL={};}
,properties:{anonymous:{refine:true,init:true}},members:{__iL:null,__cx:null,__Dp:null,__Dq:null,__CP:null,__pz:null,getFirstRow:function(){return this.__Dp;}
,getFirstColumn:function(){return this.__Dq;}
,getRowSizes:function(){return this.__CP||[];}
,getColumnSizes:function(){return this.__pz||[];}
,syncWidget:function(c){if(!this.getContentElement().getDomElement()){return;}
;if(this.__iL.fullUpdate||this.__iL.updateLayerWindow&&this.__iL.updateLayerData){this._fullUpdate.apply(this,this.__cx);}
else if(this.__iL.updateLayerWindow){this._updateLayerWindow.apply(this,this.__cx);}
else if(this.__iL.updateLayerData&&this.__CP){this._updateLayerData();}
;if(this.__iL.fullUpdate||this.__iL.updateLayerWindow){var d=this.__cx;this.__Dp=d[0];this.__Dq=d[1];this.__CP=d[2];this.__pz=d[3];}
;this.__iL={};}
,_updateLayerData:function(){this._fullUpdate(this.__Dp,this.__Dq,this.__CP,this.__pz);}
...
,updateLayerData:function(){this.__iL.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(m,n,o,p){this.__cx=arguments;this.__iL.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(q,r,s,t){this.__cx=arguments;this.__iL.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__iL=this.__cx=this.__CP=this.__pz=null;}
});}
)();
...
;this.__Dr={};this.__Ds={};}
,properties:{colorEven:{nullable:true,check:a,apply:c,themeable:true},colorOdd:{nullable:true,check:a,apply:d,themeable:true}},members:{__Dt:null,__Du:null,__Dr:null,__Ds:null,setColor:function(g,h){if(h){this.__Dr[g]=qx.theme.manager.Color.getInstance().resolve(h);}
else {delete (this.__Dr[g]);}
;}
,clearCustomColors:function(){this.__Dr={};this.updateLayerData();}
,getColor:function(i){var j=this.__Dr[i];if(j){return j;}
else {return i%2==0?this.__Dt:this.__Du;}
;}
,_applyColorEven:function(k,l){if(k){this.__Dt=qx.theme.manager.Color.getInstance().resolve(k);}
else {this.__Dt=null;}
;this.updateLayerData();}
,_applyColorOdd:function(m,n){if(m){this.__Du=qx.theme.manager.Color.getInstance().resolve(m);}
else {this.__Du=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__Ds[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__Ds[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__Ds[q];}
...
;}
,setColor:function(J,K){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,K);if(this.__Dv(J)){this.updateLayerData();}
;}
,setBackground:function(L,M){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,L,M);if(this.__Dv(L)){this.updateLayerData();}
;}
,__Dv:function(N){var P=this.getFirstRow();var O=P+this.getRowSizes().length-1;return N>=P&&N<=O;}
}});}
)();
...
(function(){var p="model[",o="groups[",n="model",m="changeDelegate",l="label",k="qx.ui.list.core.MWidgetController",j="icon",i="value",h=".",g="",c="]",f="BindingIds",d="group",b="cell.type",a="String";qx.Mixin.define(k,{construct:function(){this.__Dw=[];}
,properties:{labelPath:{check:a,nullable:true},iconPath:{check:a,nullable:true},groupLabelPath:{check:a,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},groupLabelOptions:{nullable:true},delegate:{event:m,init:null,nullable:true}},members:{__Dw:null,bindDefaultProperties:function(q,r){if(q.getUserData(b)!=d){this.bindProperty(g,n,null,q,r);this.bindProperty(this.getLabelPath(),l,this.getLabelOptions(),q,r);if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),j,this.getIconOptions(),q,r);}
;}
else {this.bindProperty(this.getGroupLabelPath(),i,this.getGroupLabelOptions(),q,r);}
;}
,bindProperty:function(s,t,u,v,w){var y=v.getUserData(b);var x=this.__Dx(w,s,y);var z=this._list.bind(x,v,t,u);this.__AP(v,z);}
,bindPropertyReverse:function(A,B,C,D,E){var G=D.getUserData(b);var F=this.__Dx(E,A,G);var H=D.bind(B,this._list,F,C);this.__AP(D,H);}
,removeBindings:function(){while(this.__Dw.length>0){var I=this.__Dw.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_removeBindingsFrom:function(T){var U=this.__Dy(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__Dw,T)){qx.lang.Array.remove(this.__Dw,T);}
;}
,__Dx:function(W,X,Y){var ba=p+W+c;if(Y==d){ba=o+W+c;}
;if(X!=null&&X!=g){ba+=h+X;}
;return ba;}
,__AP:function(bb,bc){var bd=this.__Dy(bb);if(!qx.lang.Array.contains(bd,bc)){bd.push(bc);}
;if(!qx.lang.Array.contains(this.__Dw,bb)){this.__Dw.push(bb);}
;}
,__Dy:function(be){var bf=be.getUserData(f);if(bf==null){bf=[];be.setUserData(f,bf);}
;return bf;}
...
,styleSelectabled:function(u){var v=this.__Dz(u);this._styleSelectabled(v);}
,styleUnselectabled:function(w){var x=this.__Dz(w);this._styleUnselectabled(x);}
...
;}
,_styleSelectabled:function(A){this.__DA(A,{selected:1});}
,_styleUnselectabled:function(B){this.__DA(B,{});}
...
,__Dz:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__DA:function(H,I){if(H==null){return;}
...
;this._cellProvider=h;this.__DB=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:g},members:{__DB:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;var q=this.getRowSizes().length;var p=this.getFirstRow();var o=this.getFirstColumn();if(j<p||j>=p+q||k<o||k>=o+l){return null;}
;var n=(k-o)+(j-p)*l;var m=this._getChildren()[n];if(m.getUserData(a)){return null;}
else {return m;}
;}
,_getSpacer:function(){var r=this.__DB.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(a,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(v,w,z,A){var C=this._cellProvider;var G=this._getChildren();for(var i=0;i<G.length;i++){var E=G[i];if(E.getUserData(a)){this.__DB.push(E);}
...
;}
;}
;var U=this._cellProvider;var Y=this._getChildren();for(var i=0;i<Y.length;i++){if(!S[i]){var W=Y[i];if(W.getUserData(a)){this.__DB.push(W);}
...
;this._cellProvider=this.__DB=null;}
});}
)();
...
;}
;f.setUserData(a,g);}
,getCellWidget:function(k,l){var m=this.__DC();this.updateStates(m,l);this.updateData(m,k);return m;}
,pool:function(n){this.__cQ.push(n);}
,_cleanupPool:function(){var o=this.__cQ.pop();while(o){o.destroy();o=this.__cQ.pop();}
;}
,__DC:function(){var p=this.__cQ.pop();if(p==null){p=this._createWidget();this.fireDataEvent("created",p);}
;return p;}
