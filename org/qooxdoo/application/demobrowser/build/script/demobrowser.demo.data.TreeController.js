...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.TreeController.314e28952832.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="changeNames",p="changeName",o="- ",n="",m="changeChild",l="changeColor",k="Marge",j="AFFE",h="Homer",g="\n",c="__AF",f="changeName2",e="changeChildren",b="qx.data.Array",a="demobrowser.demo.data.model.Node",d="String";qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.setChildren(new qx.data.Array());}
,properties:{children:{check:b,event:e},child:{check:a,event:m,nullable:true},names:{check:b,event:q,init:new qx.data.Array(h,k)},name:{check:d,init:j,event:p},name2:{check:d,event:f},number:{init:10,validate:c},color:{event:l,nullable:true}},members:{__AF:function(r){if(!isNaN(parseFloat(r))){if(/^\d+$/.test(r)){return;}
;}
