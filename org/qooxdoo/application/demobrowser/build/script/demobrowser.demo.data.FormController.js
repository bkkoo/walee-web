...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController.4932646167b7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="Cancel",k="Last Name",j="Company",i="Save",h="First Name",g="Email",f="Date",e="firstName",d="lastName",c="demobrowser.demo.data.FormController",a="Simple Form",b="execute";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var q=new qx.ui.groupbox.GroupBox(a);q.setLayout(new qx.ui.layout.Canvas());this.getRoot().add(q,{left:10,top:10});var n=new qx.ui.form.Form();var m=new qx.ui.form.TextField();m.setRequired(true);m.setWidth(200);n.add(m,h,null,e);n.add(new qx.ui.form.TextField(),k,null,d);n.add(new qx.ui.form.TextField(),j);n.add(new qx.ui.form.TextField(),g);n.add(new qx.ui.form.DateField(),f);var r=new qx.ui.form.Button(i);r.setWidth(70);n.addButton(r);var o=new qx.ui.form.Button(l);o.setWidth(70);n.addButton(o);q.add(new qx.ui.form.renderer.Single(n));var p=new qx.data.controller.Form(null,n);var s=p.createModel();r.addListener(b,function(){if(n.validate()){alert("You are saving: "+qx.util.Serializer.toJson(s));}
;}
,this);o.addListener(b,n.reset,n);}
}});}
)();
...
(function(){var k="changeModel",j="qx.core.Object",h="_applyTarget",g="qx.data.controller.Form",f="changeTarget",e=".",d="qx.ui.form.Form",c="_applyModel",b="modelSelection[0]",a="value";qx.Class.define(g,{extend:qx.core.Object,construct:function(l,m,n){qx.core.Object.call(this);this._selfUpdate=!!n;this.__BR={};if(l!=null){this.setModel(l);}
;if(m!=null){this.setTarget(m);}
;}
,properties:{model:{check:j,apply:c,event:k,nullable:true,dereference:true},target:{check:d,apply:h,event:f,nullable:true,init:null,dereference:true}},members:{__BS:null,__BR:null,addBindingOptions:function(name,o,p){this.__BR[name]=[o,p];if(this.getModel()==null||this.getTarget()==null){return;}
;var q=this.getTarget().getItems()[name];var r=this.__BV(q)?b:a;this.__BS.removeTarget(q,r,name);this.__BS.addTarget(q,r,name,!this._selfUpdate,o,p);}
,createModel:function(s){var u=this.getTarget();if(u==null){throw new Error("No target is set.");}
;var v=u.getItems();var w={};for(var name in v){var x=name.split(e);var A=w;for(var i=0;i<x.length;i++){if(i+1==x.length){var z=v[name].constructor;var t=null;if(qx.Class.hasInterface(z,qx.ui.core.ISingleSelection)){t=v[name].getModelSelection().getItem(0)||null;}
else {t=v[name].getValue();}
;if(this.__BR[name]&&this.__BR[name][1]){t=this.__BR[name][1].converter(t);}
;A[x[i]]=t;}
else {if(!A[x[i]]){A[x[i]]={};}
;A=A[x[i]];}
;}
;}
;var y=qx.data.marshal.Json.createModel(w,s);this.setModel(y);return y;}
,updateModel:function(){if(!this._selfUpdate||!this.getModel()||!this.getTarget()){return;}
;var B=this.getTarget().getItems();for(var name in B){var E=B[name];var D=this.__BV(E)?b:a;var C=this.__BR[name];C=C&&this.__BR[name][1];qx.data.SingleValueBinding.updateTarget(E,D,this.getModel(),name,C);}
;}
,_applyTarget:function(F,G){if(G!=null){this.__BU(G);}
;if(this.getModel()==null){return;}
;if(F!=null){this.__BT();}
;}
,_applyModel:function(H,I){if(this.__BS!=null&&H==null){this.__BS.setModel(null);}
;if(this.__BS!=null){var J=this.getTarget().getItems();for(var name in J){var L=J[name];var K=this.__BV(L)?b:a;this.__BS.removeTarget(L,K,name);}
;}
;if(this.__BS!=null){this.__BS.setModel(H);}
;if(this.getTarget()==null){return;}
;if(H!=null){this.__BT();}
;}
,__BT:function(){if(this.__BS==null){this.__BS=new qx.data.controller.Object(this.getModel());}
;var M=this.getTarget().getItems();for(var name in M){var P=M[name];var N=this.__BV(P)?"modelSelection[0]":"value";var O=this.__BR[name];try{if(O==null){this.__BS.addTarget(P,N,name,!this._selfUpdate);}
else {this.__BS.addTarget(P,N,name,!this._selfUpdate,O[0],O[1]);}
;}
...
,__BU:function(R){if(this.__BS==null){return;}
;var S=R.getItems();for(var name in S){var U=S[name];var T=this.__BV(U)?"modelSelection[0]":"value";this.__BS.removeTarget(U,T,name);}
;}
,__BV:function(V){return qx.Class.hasInterface(V.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(V.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__BS){this.__BS.dispose();}
;}
});}
)();
