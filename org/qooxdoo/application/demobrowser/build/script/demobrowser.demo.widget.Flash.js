...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.2212a20908fd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="__Jf",j="Flash Player Version",i="__Jd",h="right",g="qooxdoo is the best!",f="Message from Flash:",d="Simple demo with FlashVars",c="__ce",b="bgcolor",a="demobrowser.demo.widget.Flash",C="demobrowser/demo/flash/TestFlash.swf",B="Send to Flash",A="demobrowser/demo/flash/FlashVersion.swf",z="No message.",y="Flash:",x="<b>qooxdoo:</b>",w="__Je",v="__Jc",u="demobrowser.demo.widget.Flash.sendMessage",t="demobrowser.demo.widget.Flash.flashReady",r="demobrowser/demo/flash/fo_tester.swf",s="this is passed in via FlashVars",p="Two way communication (ActionScript <-> JavaScript)",q="Message to Flash:",n="Show Flash Player version",o="noscale",l="#FF6600",m="execute";qx.Class.define(a,{extend:qx.application.Standalone,members:{__ce:null,main:function(){qx.application.Standalone.prototype.main.call(this);var D=new qx.ui.tabview.TabView();D.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(D,{edge:0});var E=new qx.ui.tabview.Page(d);E.setLayout(new qx.ui.layout.Canvas());E.add(this.createFlashDemo1(),{edge:0});D.add(E);var F=new qx.ui.tabview.Page(p);F.setLayout(new qx.ui.layout.Canvas());F.add(this.createFlashDemo2(),{edge:0});D.add(F);this.__ce=this.createWindow();G.add(this.__ce,{top:20,left:20});}
,createWindow:function(){var H=new qx.ui.window.Window(j).set({width:300,height:200,contentPadding:[0,0,0,0]});H.setLayout(new qx.ui.layout.Canvas());H.add(new qx.ui.embed.Flash(A),{edge:0});return H;}
,createFlashDemo1:function(){var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var I={flashVarText:s};var J=new qx.ui.embed.Flash(r).set({scale:o,variables:I});J.getContentElement().setParam(b,l);K.add(J,{flex:1});var L=new qx.ui.form.Button(n);L.addListener(m,function(){this.__ce.open();}
,this);K.add(L);return K;}
,__Jc:null,__Jd:null,__Je:null,__Jf:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var O=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));O.add(N,{flex:1});N.add(new qx.ui.basic.Label(x).set({rich:true}));N.add(new qx.ui.basic.Label(f));this.__Jd=new qx.ui.form.TextArea(z);this.__Jd.setEnabled(false);N.add(this.__Jd,{flex:1});N.add(new qx.ui.basic.Label(q));this.__Je=new qx.ui.form.TextArea(g);N.add(this.__Je,{flex:1});var P=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));this.__Jf=new qx.ui.form.Button(B);this.__Jf.setEnabled(false);this.__Jf.addListener(m,function(e){this.__Jc.getFlashElement().sendMessage(this.__Je.getValue());}
,this);P.add(this.__Jf);N.add(P);var M=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));O.add(M,{flex:1});M.add(new qx.ui.basic.Label(y).set({rich:true}));this.__Jc=new qx.ui.embed.Flash(C);this.__Jc.setVariables({init:t});M.add(this.__Jc,{flex:1});return O;}
,sendMessage:function(Q){this.__Jd.setValue(Q);}
,initFlash:function(){if(this.__Jc.getFlashElement().setup){this.__Jc.getFlashElement().setup(u);this.__Jf.setEnabled(true);}
...
;}
},statics:{__Jg:null,setCallBackInstance:function(R){demobrowser.demo.widget.Flash.__Jg=R;}
,sendMessage:function(S){demobrowser.demo.widget.Flash.__Jg.sendMessage(S);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Jg.initFlash();}
},destruct:function(){this._disposeObjects(i,w,k,v,c);}
});}
)();
...
,_checkLoading:function(){var bh=this.getSource();if(bh!=s&&bh!=null&&bh!=y){if(!this.isLoaded()){if(!this.__Jh){this.__Jh=new Date().getTime();}
;var bi=new Date().getTime()-this.__Jh;if(this.getLoadTimeout()>bi){var bj=qx.util.TimerManager.getInstance();bj.start(this._checkLoading,0,this,null,10);this.fireEvent(R);}
else {if(qx.core.Environment.get(K)){this.debug("Timeout after: "+bi);}
;this.fireEvent(J);this.__Jh=null;}
;}
else {this.fireEvent(Y);this.__Jh=null;}
;}
;}
...
,_applyQuality:function(bt,bu){this.__Ji(j,bt);}
,_applyScale:function(bv,bw){this.__Ji(f,bv);}
,_applyWmode:function(bx,by){this.__Ji(a,bx);}
,_applyPlay:function(bz,bA){this.__Ji(k,bz);}
,_applyLoop:function(bB,bC){this.__Ji(V,bB);}
,_applyMenu:function(bD,bE){this.__Ji(T,bD);}
,_applyAllowScriptAccess:function(bF,bG){this.__Ji(U,bF);}
,_applyLiveConnect:function(bH,bI){this.__Ji(q,bH);}
,__Ji:function(bJ,bK){this.getContentElement().setParam(bJ,bK);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var g="movie",f="id",e="qx.html.Flash",d="Invalid attribute 'key'.",c="div",b="Invalid attribute 'value'.",a="qx.debug";qx.Class.define(e,{extend:qx.html.Element,construct:function(h,i){qx.html.Element.call(this,c,h,i);this.__Jj={};this.__Jk={};this.__Jl={};}
,members:{__Jj:null,__Jl:null,__Jk:null,__Jc:null,_createDomElement:function(){return qx.dom.Element.create(c);}
,createFlash:function(){this.__Jc=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Jk,this.__Jj);}
,setSource:function(j){if(qx.core.Environment.get(a)){qx.core.Assert.assertString(j,b);}
;if(this.__Jc){throw new Error("The source cannot be modified after initial creation");}
;this.setAttribute(g,j);}
,setId:function(k){if(qx.core.Environment.get(a)){qx.core.Assert.assertString(k,b);}
;if(this.__Jc){throw new Error("The id cannot be modified after initial creation");}
;this.setAttribute(f,k);}
,getVariables:function(){return this.__Jk;}
,setVariables:function(l){if(qx.core.Environment.get(a)){qx.core.Assert.assertMap(l,b);}
;if(this.__Jc){throw new Error("The variables cannot be modified after initial creation");}
;this.__Jk=l;}
,getAttributes:function(){return this.__Jl;}
...
;}
;}
;if(this.__Jc){throw new Error("The attributes cannot be modified after initial creation");}
;if(n===null||n===undefined){delete this.__Jl[m];}
else {this.__Jl[m]=n;}
;}
,getParams:function(){return this.__Jj;}
...
;}
;}
;if(this.__Jc){throw new Error("The params cannot be modified after initial creation");}
;if(p===null||p===undefined){delete this.__Jj[o];}
else {this.__Jj[o]=p;}
;}
,getFlashElement:function(){return this.__Jc;}
},destruct:function(){if(this.__Jc){qx.bom.Flash.destroy(this.__Jc);}
;this.__Jj=this.__Jk=this.__Jl=null;}
});}
)();
(function(){var k="Invalid parameter 'element'.",j="function",h="application/x-shockwave-flash",g='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">',f="param",e="Invalid parameter 'attributes'.",d='" />',c="Invalid attribute 'movie'.",b="qx.bom.Flash",a='<param name="',F="qx.debug",E="type",D="load",C="name",B="data",A="Invalid attribute 'id'.",z="",y="mshtml",x="value",w="&",r='<object id="',s='" value="',p='" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">',q="undefined",n='</object>',o="100%",l="movie",m="beforeunload",t="=",u="object",v="engine.name";qx.Class.define(b,{statics:{_flashObjects:{},create:function(G,H,I,J,K){if(!K){K=window;}
;if(qx.core.Environment.get(F)){qx.core.Assert.assertElement(G,k);qx.core.Assert.assertMap(H,e);qx.core.Assert.assertString(H.movie,c);qx.core.Assert.assertString(H.id,A);if(!qx.dom.Element.isInDom(G,K)){qx.log.Logger.warn(this,"The parent DOM element isn't in DOM! The External Interface doesn't work in IE!");}
;}
;if(!H.width){H.width=o;}
;if(!H.height){H.height=o;}
;J=J?qx.lang.Object.clone(J):{};if(!J[l]){J[l]=H.movie;}
;H[B]=H.movie;delete H.movie;if(I){for(var name in I){if(typeof J.flashvars!=q){J.flashvars+=w+name+t+I[name];}
else {J.flashvars=name+t+I[name];}
;}
;}
;var L=this.__wm(G,H,J,K);this._flashObjects[H.id]=L;return L;}
,destroy:qx.core.Environment.select(v,{"mshtml":function(M,N){M=this.__wh(M);if(M.readyState==4){this.__wi(M);}
else {if(!N){N=window;}
;qx.bom.Event.addNativeListener(N,D,function(){qx.bom.Flash.__wi(M);}
);}
;}
,"default":function(O,P){O=this.__wh(O);if(O.parentNode){O.parentNode.removeChild(O);}
;delete this._flashObjects[O.id];}
}),__wh:function(Q){if(!Q){throw new Error("DOM element is null or undefined!");}
;if(Q.tagName.toLowerCase()!==u){Q=Q.firstChild;}
;if(!Q||Q.tagName.toLowerCase()!==u){throw new Error("DOM element has or is not a flash object!");}
;return Q;}
,__wi:qx.core.Environment.select(v,{"mshtml":qx.event.GlobalError.observeMethod(function(R){for(var i in R){if(typeof R[i]==j){R[i]=null;}
;}
;if(R.parentNode){R.parentNode.removeChild(R);}
;delete this._flashObjects[R.id];}
),"default":null}),__wj:qx.event.GlobalError.observeMethod(function(){for(var S in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[S]);}
;window.__wk=function(){}
;window.__wl=function(){}
;qx.bom.Event.removeNativeListener(window,m,qx.bom.Flash.__wj);}
),__wm:qx.core.Environment.select(v,{"mshtml":function(T,U,V,W){V.movie=U.data;delete U.data;delete U.classid;var X=z;for(name in V){X+=a+name+s+V[name]+d;}
;if(U.id){T.innerHTML=r+U.id+p+X+n;delete U.id;}
else {T.innerHTML=g+X+n;}
;for(var name in U){T.firstChild.setAttribute(name,U[name]);}
;return T.firstChild;}
,"default":function(Y,ba,bb,bc){delete ba.classid;delete bb.movie;var be=qx.dom.Element.create(u,ba,bc);be.setAttribute(E,h);var bd;for(var name in bb){bd=qx.dom.Element.create(f,{},bc);bd.setAttribute(C,name);bd.setAttribute(x,bb[name]);be.appendChild(bd);}
;Y.appendChild(be);return be;}
})},defer:function(bf){if((qx.core.Environment.get(v)==y)){qx.bom.Event.addNativeListener(window,m,bf.__wj);}
;}
});}
)();
