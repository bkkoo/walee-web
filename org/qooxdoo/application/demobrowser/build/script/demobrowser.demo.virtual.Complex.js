...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.a4fb7df9928c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="demobrowser.demo.virtual.DemoLayer",g="mouseover",f="changeValue",e="qx.ui.basic.Atom",d=" / ",c="row",b="foobar!",a="column";qx.Class.define(h,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__nl=[];}
,members:{_pool:null,__nl:null,getCellData:function(i,k){if(!this.__nl[i]){this.__nl[i]=[];}
;if(!this.__nl[i][k]){this.__nl[i][k]={label:this.__IA(),icon:this.__IB()};}
;return this.__nl[i][k];}
,getCellWidget:function(l,m){var n;if(m%2==0){n=this._pool.atom.pop();if(!n){n=new qx.ui.basic.Atom();n.addListener(g,function(){var o=this.__IB();n.setIcon(o);this.__nl[l][m].icon=o;}
,this);}
;n.set(this.getCellData(l,m));}
else {n=this._pool.checkbox.pop();if(!n){n=new qx.ui.form.CheckBox();n.addListener(f,function(){this.setLabel(this.getLabel()==b?n.getUserData(c)+d+n.getUserData(a):b);}
,n);}
;n.set({value:l%2==0,label:l+d+m});}
;n.setUserData(c,l);n.setUserData(a,m);return n;}
,poolCellWidget:function(p){if(p.classname==e){this._pool.atom.push(p);}
else {this._pool.checkbox.push(p);}
;}
,__IA:function(){var name="";for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__IB:function(){var q="icon/";var s="places/";var t=["folder.png","user-trash.png","network-server.png","network-workgroup.png","user-desktop.png"];var r=Math.floor(Math.random()*4);return (q+16+"/"+s+t[r]);}
},destruct:function(){this._pool=this.__nl=null;}
});}
)();
