...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.7bc0da3ddb17.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="#333",j="border-left",i="green",h="demobrowser.demo.mobile.PingPong",g="0",f="qx.debug",d="interval",c="0px",b="12px",a="15em",L="center",K='Lucida Grande',J="Arial",I="<b>This demo is supposed to be run in a WebKit-based browser.</b>",H="engine.name",G="webkit",F="border-right",E="touchmove",D="black",C="200px",r="30px",s="100px",p="1px solid white",q="top",n="right",o="50%",l="none",m="white",t="px",u="innerHTML",w="20px",v="absolute",A="100%",z="div",B="left";qx.Class.define(h,{extend:qx.application.Native,members:{__Eh:null,__Ei:null,__Ej:null,__Ek:null,__El:5,__Em:1,__En:1,__Eo:null,__Ep:null,__Eq:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(f)){qx.log.appender.Native;qx.log.appender.Console;}
...
;var M=this.__Ev(B);R.add(M);var N=this.__Ev(n);R.add(N);this.__Ei=this.__Ew(B);M.add(this.__Ei);M.addListener(E,qx.lang.Function.bind(this.__Eu,this,this.__Ei),this);this.__Eh=this.__Ew(n);N.add(this.__Eh);N.addListener(E,qx.lang.Function.bind(this.__Eu,this,this.__Eh),this);this.__Ej=this.__Ex();R.add(this.__Ej);this.__Ep=this.__Ey();M.add(this.__Ep);this.__Eq=this.__Ey();N.add(this.__Eq);this.__Eo=[0,0];this.__Er();}
,__Er:function(){this.__Ej.setStyles({"left":C,"top":C});this.__Ek=new qx.event.Timer(40);this.__Ek.addListener(d,function(){var x=(parseInt(this.__Ej.getStyle(B))+this.__El*this.__Em);var y=(parseInt(this.__Ej.getStyle(q))+this.__El*this.__En);this.__Ej.setStyle(B,x+t);this.__Ej.setStyle(q,y+t);this.__Et();}
,this);this.__Ek.start();}
,__Es:function(S){this.__Ek.stop();this.__Ek.dispose();this.__El=5;this.__Eo[S]=this.__Eo[S]+1;this.__Ep.setAttribute(u,this.__Eo[0]);this.__Eq.setAttribute(u,this.__Eo[1]);this.__Er();}
,__Et:function(){var U=this.getBoundsFor(this.__Ej);if(U.top<=0){this.__En=1;}
;if(U.bottom>=window.innerHeight-5){this.__En=-1;}
;if(U.left<=0||U.right>=window.innerWidth){this.__Es(U.left<=0?1:0);}
;var V=this.getBoundsFor(this.__Ei);if(U.left<=V.right&&U.bottom>=V.top&&U.top<=V.bottom){this.__Em=1;this.__El=Math.min(this.__El+1,20);}
;var T=this.getBoundsFor(this.__Eh);if(U.right>=T.left&&U.bottom>=T.top&&U.top<=T.bottom){this.__Em=-1;this.__El=Math.min(this.__El+1,20);}
;}
,__Eu:function(W,e){W.setStyles({"top":(e.getDocumentTop()-50)+t});}
,getBoundsFor:function(X){return qx.bom.element.Location.get(X.getDomElement());}
,__Ev:function(Y){var ba={"width":o,"height":A,"position":v,"backgroundColor":D};if(Y==B){ba[F]=p;}
else {ba[B]=o;ba[j]=p;}
;return new qx.html.Element(z,ba);}
,__Ew:function(bb){var bc={"width":r,"height":s,"top":s,"position":v,"backgroundColor":m};bc[bb]=w;return new qx.html.Element(z,bc);}
,__Ex:function(){var bd={"width":w,"height":w,"position":v,"backgroundColor":m,"userSelect":l};return new qx.html.Element(z,bd);}
,__Ey:function(){var be={"width":A,"height":A,"textAlign":L,"fontSize":a,"color":k,"fontFamily":J};var bf=new qx.html.Element(z,be);bf.setAttribute(u,g);return bf;}
}});}
)();
