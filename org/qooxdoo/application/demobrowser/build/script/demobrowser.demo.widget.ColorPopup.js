...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.285c26b670c2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="Selected Color",k="changeGreen",j="Open Popup",i="changeBlue",h="en",g="changeValue",f="changeRed",d="main",c="#23F3C1",b="demobrowser.demo.widget.ColorPopup",a="execute";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var m=this.getRoot();qx.locale.Manager.getInstance().setLocale(h);var o=new qx.ui.control.ColorPopup();o.exclude();o.setValue(c);var p=new qx.ui.form.Button(j);p.addListener(a,function(e){o.placeToWidget(p);o.show();}
);var n=new qx.ui.basic.Label(l).set({marginLeft:10,padding:[3,6],decorator:d});m.add(n,{left:120,top:20});m.add(p,{left:20,top:20});m.add(o,{left:100,top:100});o.addListener(g,function(e){this.debug("Value Listener: "+e.getData());n.setBackgroundColor(e.getData());}
...
;this.getChildControl(I).setBackgroundColor(bv);}
...
;this.__Gd.setRed(bA);this.__Gd.setGreen(bz);this.__Gd.setBlue(by);this.__Gc.open();}
,_onColorSelectorOk:function(){var bB=this.__Gd;this.setValue(qx.util.ColorUtil.rgbToRgbString([bB.getRed(),bB.getGreen(),bB.getBlue()]));this.__Gc.close();}
,_onColorSelectorCancel:function(){this.__Gc.close();}
,_onChangeVisibility:function(e){if(this.getVisibility()==B){var bF=this.getRed();var bE=this.getGreen();var bC=this.getBlue();var bD=null;if(bF!==null||bE!==null||bC!==null){bD=qx.util.ColorUtil.rgbToRgbString([bF,bE,bC]);}
;this.getChildControl(G).setBackgroundColor(bD);this.getChildControl(I).setBackgroundColor(bD);}
;}
,_tables:{core:{label:qx.locale.Manager.tr(w),values:[c,d,g,o,R,s,N,J,U,b,l,k]},recent:{label:qx.locale.Manager.tr(H),values:[]}}},destruct:function(){this._disposeObjects(V,y);this._tables=this.__Gb=null;}
});}
)();
...
,setValue:function(cf){var cg;if(cf==null){this.__nL=true;cg=[255,255,255];}
else {cg=qx.util.ColorUtil.stringToRgb(cf);this.__nL=false;}
;this.__Gm=true;this.setRed(cg[0]);this.setGreen(cg[1]);this.__Gm=false;this.setBlue(cg[2]);}
,getValue:function(){return this.__nL?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__nL=true;this.__Gm=true;this.setRed(255);this.setGreen(255);this.__Gm=false;this.setBlue(255);}
,__nN:function(){if(!this.__Gm){this.__nL=false;this.fireDataEvent(N,this.getValue());}
;}
,_applyRed:function(ch,ci){if(this.__Gg===null){this.__Gg=H;}
;if(this.__Gg!==z){this.getChildControl(w).setValue(ch);}
;if(this.__Gg!==S){this._setHexFromRgb();}
;switch(this.__Gg){case z:case S:case H:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nN();if(this.__Gg===H){this.__Gg=null;}
;}
,_applyGreen:function(cj,ck){if(this.__Gg===null){this.__Gg=A;}
;if(this.__Gg!==z){this.getChildControl(q).setValue(cj);}
;if(this.__Gg!==S){this._setHexFromRgb();}
;switch(this.__Gg){case z:case S:case A:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nN();if(this.__Gg===A){this.__Gg=null;}
;}
,_applyBlue:function(cl,cm){if(this.__Gg===null){this.__Gg=D;}
;if(this.__Gg!==z){this.getChildControl(O).setValue(cl);}
;if(this.__Gg!==S){this._setHexFromRgb();}
;switch(this.__Gg){case z:case S:case D:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nN();if(this.__Gg===D){this.__Gg=null;}
;}
,_applyHue:function(cn,co){if(this.__Gg===null){this.__Gg=B;}
;if(this.__Gg!==T){this.getChildControl(P).setValue(cn);}
;if(this.__Gg!==L){if(this.getChildControl(y).getBounds()){this.getChildControl(y).setDomLeft(Math.round(cn/1.40625)+this.getChildControl(n).getPaddingLeft());}
else {this.getChildControl(y).setLayoutProperties({left:Math.round(cn/1.40625)});}
;}
;switch(this.__Gg){case T:case L:case B:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__Gg===B){this.__Gg=null;}
;}
,_applySaturation:function(cp,cq){if(this.__Gg===null){this.__Gg=I;}
;if(this.__Gg!==T){this.getChildControl(Q).setValue(cp);}
;if(this.__Gg!==L){this._setBrightnessGradiant();if(this.getChildControl(y).getBounds()){this.getChildControl(y).setDomTop(256-Math.round(cp*2.56)+this.getChildControl(n).getPaddingTop());}
else {this.getChildControl(y).setLayoutProperties({top:256-Math.round(cp*2.56)});}
;}
;switch(this.__Gg){case T:case L:case I:this._setRgbFromHue();};if(this.__Gg===I){this.__Gg=null;}
;}
,_applyBrightness:function(cr,cs){if(this.__Gg===null){this.__Gg=C;}
;if(this.__Gg!==T){this.getChildControl(r).setValue(cr);}
;if(this.__Gg!==p){var ct=256-Math.round(cr*2.56);if(this.getChildControl(x).getBounds()){this.getChildControl(x).setDomTop(ct+this.getChildControl(t).getPaddingTop());}
else {this.getChildControl(x).setLayoutProperties({top:ct});}
;}
;switch(this.__Gg){case T:case p:case C:this._setRgbFromHue();};if(this.__Gg===C){this.__Gg=null;}
;}
,_onBrightnessHandleMouseDown:function(e){this.getChildControl(x).capture();this.__Gi=x;var cw=this.getChildControl(M).getContainerLocation();var cv=this.getChildControl(x).getContainerLocation();var cu=this.getChildControl(M).getBounds();this.__Gj=cw.top+(e.getDocumentTop()-cv.top)-cu.top;e.stopPropagation();}
,_onBrightnessHandleMouseUp:function(e){this.getChildControl(x).releaseCapture();this.__Gi=null;}
,_onBrightnessHandleMouseMove:function(e){if(this.__Gi===x){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(M).getContainerLocation();var cx=this.getChildControl(x).getBounds();this.__Gj=location.top+(cx.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(x).capture();this.__Gi=x;}
...
,_setBrightnessOnFieldEvent:function(e){var cy=qx.lang.Number.limit(e.getDocumentTop()-this.__Gj,0,256);this.__Gg=p;if(this.getChildControl(x).getBounds()){this.getChildControl(x).setDomTop(cy);}
else {this.getChildControl(x).setLayoutProperties({top:cy});}
;this.setBrightness(100-Math.round(cy/2.56));this.__Gg=null;}
,_onHueSaturationHandleMouseUp:function(e){if(this.__Gi){e.stopPropagation();this.getChildControl(y).releaseCapture();this.__Gi=null;}
;}
,_onHueSaturationHandleMouseMove:function(e){if(this.__Gi===y){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(s).getContainerLocation();var cz=this.getChildControl(y).getBounds();var cA=this.getChildControl(s).getBounds();this.__Gk=location.top+(cz.height/2)-cA.top;this.__Gl=location.left+(cz.width/2)-cA.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(y).capture();this.__Gi=y;}
...
,_setHueSaturationOnFieldEvent:function(e){var cC=qx.lang.Number.limit(e.getDocumentTop()-this.__Gk,0,256);var cB=qx.lang.Number.limit(e.getDocumentLeft()-this.__Gl,0,256);this.getChildControl(y).setDomPosition(cB,cC);this.__Gg=L;this.setSaturation(100-Math.round(cC/2.56));this.setHue(Math.round(cB*1.40625));this.__Gg=null;}
,_setRedFromSpinner:function(){if(this.__Gg!==null){return;}
;this.__Gg=z;this.setRed(this.getChildControl(w).getValue());this.__Gg=null;}
,_setGreenFromSpinner:function(){if(this.__Gg!==null){return;}
;this.__Gg=z;this.setGreen(this.getChildControl(q).getValue());this.__Gg=null;}
,_setBlueFromSpinner:function(){if(this.__Gg!==null){return;}
;this.__Gg=z;this.setBlue(this.getChildControl(O).getValue());this.__Gg=null;}
,_setHueFromSpinner:function(){if(this.__Gg!==null){return;}
;this.__Gg=T;this.setHue(this.getChildControl(P).getValue());this.__Gg=null;}
,_setSaturationFromSpinner:function(){if(this.__Gg!==null){return;}
;this.__Gg=T;this.setSaturation(this.getChildControl(Q).getValue());this.__Gg=null;}
,_setBrightnessFromSpinner:function(){if(this.__Gg!==null){return;}
;this.__Gg=T;this.setBrightness(this.getChildControl(r).getValue());this.__Gg=null;}
,_onHexFieldChange:function(e){if(this.__Gg!==null){return;}
;try{var cE=this.getChildControl(R);var cD=qx.util.ColorUtil.hexStringToRgb(bM+cE.getValue());}
catch(cF){return;}
;this.__Gg=S;this.setRed(cD[0]);this.setGreen(cD[1]);this.setBlue(cD[2]);this.__Gg=null;}
...
,_setHueFromRgb:function(){switch(this.__Gg){case T:case L:case p:break;default:var cJ=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(cJ[0]);this.setSaturation(cJ[1]);this.setBrightness(cJ[2]);};}
,_setRgbFromHue:function(){switch(this.__Gg){case z:case S:break;default:var cK=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(cK[0]);this.setGreen(cK[1]);this.setBlue(cK[2]);};}
