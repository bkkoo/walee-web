...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection.44122f00146d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__eB=qx.bom.Stylesheet.createElement(n);this.__HV={};this.__mK={};}
,members:{__eB:null,__HV:null,__mK:null,getStylesheet:function(){return this.__eB;}
,getCssClass:function(o){return this.__HV[o]||null;}
,computeClassForStyles:function(p,q){var r=this.__mK[q];if(!r){var r=this.__HW();qx.bom.Stylesheet.addRule(this.__eB,f+r,q);this.__mK[q]=r;}
;this.__HV[p]=r;return r;}
,__HW:function(){return "qx-cell-"+this.toHashCode()+"-"+(this.__HX++);}
,__HX:0},destruct:function(){this.__eB=this.__HV=this.__mK=null;}
});}
)();
(function(){var k="-",j="backgroundColor",h="_applyTextAlign",g="px",f="_applyFont",e="_applyBackgroundColor",d="cell",c="center",b="font",a=":",J="shorthand",I="String",H="_applyAppearance",G="background-color:",F="textAlign",E="qx-cell ",D="left",C="textColor",B="text-align:",A="Font",r="right",s="_applyTextColor",p="justify",q="color:",n=" ",o="qx.ui.virtual.cell.Cell",l="paddingLeft",m="Color",t="",u="paddingBottom",w="paddingTop",v="paddingRight",y=";",x="Integer",z="_applyPadding";qx.Class.define(o,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__eB=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__HY={};this.__Ia={};this.__Ib={};this.__Ic={};this.__jr={};this.__Id={};this.initAppearance();this.__Ih();}
,properties:{appearance:{check:I,init:d,apply:H},backgroundColor:{nullable:true,check:m,apply:e,themeable:true},textColor:{nullable:true,check:m,apply:s,themeable:true},textAlign:{check:[D,c,r,p],nullable:true,themeable:true,apply:h},font:{nullable:true,apply:f,check:A,themeable:true},paddingTop:{check:x,init:0,apply:z,themeable:true},paddingRight:{check:x,nullable:true,apply:z,themeable:true},paddingBottom:{check:x,nullable:true,apply:z,themeable:true},paddingLeft:{check:x,nullable:true,apply:z,themeable:true},padding:{group:[w,v,u,l],mode:J,themeable:true}},members:{__Ie:null,__If:null,__jr:null,__Id:null,__Ia:null,__HY:null,__Ib:null,__Ic:null,__Ig:false,__eB:null,__Ih:function(){var M=qx.util.PropertyUtil;var O=qx.lang.Object.fromArray(this._getCssProperties());this.__Ie=[];var L=this.constructor;while(L){var N=M.getProperties(L);for(var K in N){if(!O[K]){this.__Ie.push(K);}
;}
;L=L.superclass;}
;}
,_getCssProperties:function(){return [j,C,b,F,w,v,u,l];}
,_applyAppearance:function(P,Q){if(Q){this.__Ia={};}
;}
,_getValue:function(R){if(this.__Ig){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(S,T){var U;if(this.__Ig){U=this.__Ia;}
else {U=this.__HY;}
...
;}
,_applyPadding:function(bf,bg,name){var bf=this._getValue(name);if(this.__Ig){var bi=this.__Ic;}
else {bi=this.__Ib;}
...
;}
,getCellProperties:function(bj,bk){this.__Ii(bk);return {classes:this.getCssClasses(bj,bk),style:this.getStyles(bj,bk),attributes:this.getAttributes(bj,bk),content:this.getContent(bj,bk),insets:this.getInsets(bj,bk)};}
,getAttributes:function(bl,bm){return t;}
,getContent:function(bn,bo){return bn;}
,getCssClasses:function(bp,bq){var br=this.__eB.getCssClass(this.__If)||t;return E+br;}
,__Ii:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+k+Object.keys(bs).sort().join(n);if(this.__If==bt){return;}
;this.__If=bt;var bv=this.__jr[this.__If];if(!bv){this.__Ij();this.__Ik(bs);this.__Il(bs);this.__Im();this.__jr[this.__If]=1;}
;this.__In();}
,__Ij:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++){bw.deleteThemeValue(this,bx[i]);}
;}
,__Ik:function(by){this.__Ia={};this.__Ig=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var bz=qx.theme.manager.Appearance.getInstance().styleFrom(bB,by);for(var bC in bz){if(bz[bC]!==undefined){bA.setThemed(this,bC,bz[bC]);}
;}
;this.__Ig=false;}
,__Il:function(){var bD=qx.lang.Object.getValues(this.__Ia).join(y);this.__eB.computeClassForStyles(this.__If,bD);}
,__Im:function(){var bI=this.__Ie;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__Id[this.__If]=bG;}
,__In:function(){var bK=qx.util.PropertyUtil;var bJ=this.__Id[this.__If]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bM,bN){return qx.lang.Object.getValues(this.__HY).join(y);}
,getInsets:function(bO,bP){var bT=this.__Ib;var bS=this.__Ic;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bQ=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bR=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bQ,top+bR];}
},destruct:function(){this.__eB=this.__HY=this.__Ia=this.__Ib=this.__Ic=this.__jr=this.__Id=this.__Ie=null;}
});}
)();
