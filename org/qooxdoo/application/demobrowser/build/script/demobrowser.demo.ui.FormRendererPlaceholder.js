...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererPlaceholder.5943447d0d79.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="Name",i="Registration",h="demobrowser.demo.ui.FormRendererPlaceholder",g="Send",f="Bio",e="Country",d="Personal Information",c="Password",b="Reset",a="execute";qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var l=new qx.ui.form.Form();l.addGroupHeader(i);var k=new qx.ui.form.TextField();k.setRequired(true);l.add(k,j);var p=new qx.ui.form.PasswordField();p.setRequired(true);l.add(p,c);l.addGroupHeader(d);l.add(new qx.ui.form.TextField(),e);l.add(new qx.ui.form.TextArea(),f);var n=new qx.ui.form.Button(g);n.addListener(a,function(){if(l.validate()){alert("send...");}
;}
,this);l.addButton(n);var m=new qx.ui.form.Button(b);m.addListener(a,function(){l.reset();}
,this);l.addButton(m);var o=new qx.ui.form.renderer.SinglePlaceholder(l);this.getRoot().add(o,{left:10,top:10});}
}});}
)();
...
(function(){var a="qx.ui.form.renderer.SinglePlaceholder";qx.Class.define(a,{extend:qx.ui.form.renderer.Single,implement:qx.ui.form.renderer.IFormRenderer,members:{addItems:function(b,c,d){if(d!=null){this._add(this._createHeader(d),{row:this._row,column:0,colSpan:2});this._row++;}
;for(var i=0;i<b.length;i++){if(b[i].setPlaceholder===undefined){throw new Error("Only widgets with placeholders supported.");}
;b[i].setPlaceholder(c[i]);this._add(b[i],{row:this._row,column:0});this._row++;}
;}
}});}
)();
