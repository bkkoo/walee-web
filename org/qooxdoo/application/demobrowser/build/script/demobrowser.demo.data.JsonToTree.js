...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.JsonToTree.81b29e155059.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="changeModel",q="_applyDelegate",p="qx.core.Object",o="_applyLabelPath",n="icon",m="label",l="_applyTarget",k="changeTarget",h="_applyIconPath",g="_applyLabelOptions",c="_applyChildPath",f="_applyIconOptions",d="qx.data.controller.Tree",b="_applyModel",a="String";qx.Class.define(d,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(s,t,u,v){qx.core.Object.call(this);this.__bg={};this.__Aq=[];this.__AG={};if(u!=null){this.setChildPath(u);}
;if(v!=null){this.setLabelPath(v);}
;if(s!=null){this.setModel(s);}
;if(t!=null){this.setTarget(t);}
;}
,properties:{model:{check:p,apply:b,event:r,nullable:true,dereference:true},target:{apply:l,event:k,init:null,nullable:true,dereference:true},childPath:{check:a,apply:c,nullable:true},labelPath:{check:a,apply:o,nullable:true},iconPath:{check:a,apply:h,nullable:true},labelOptions:{apply:g,nullable:true},iconOptions:{apply:f,nullable:true},delegate:{apply:q,init:null,nullable:true}},members:{__AG:null,__bg:null,__Aq:null,__AH:null,_applyDelegate:function(w,x){this._setConfigureItem(w,x);this._setCreateItem(w,x);this._setBindItem(w,x);}
,_applyIconOptions:function(y,z){this.__AB();}
,_applyLabelOptions:function(A,B){this.__AB();}
,_applyTarget:function(C,D){if(D!=undefined){this.__AM(D);}
;if(this.getModel()!=null){this.__AK();}
;this._addChangeTargetListener(C,D);}
,_applyModel:function(E,F){this.__AK();}
,_applyChildPath:function(G,H){this.__AH=H;this.__AK();this.__AH=null;}
,_applyIconPath:function(I,J){this.__AB();}
,_applyLabelPath:function(K,L){this.__AK();}
,__AI:function(M){var O=M.getTarget();var N=this.__AG[O.toHashCode()].treeNode;var P=this.__AG[O.toHashCode()].modelNode;this.__AL(N,P);this._updateSelection();}
,__AJ:function(e){var W=e.getData();var S=e.getOldData();var T=this.__AG[S.toHashCode()];S.removeListenerById(T.changeListenerId);delete this.__AG[S.toHashCode()];T.modelNode.removeListenerById(T.changeChildernListenerId);var X=T.modelNode;var V=qx.Class.getPropertyDefinition(T.modelNode.constructor,this.getChildPath());var Q=V.event;var U=X.addListener(Q,this.__AJ,this);var R=T.treeNode;this.__AG[W.toHashCode()]={modelNode:X,treeNode:R,changeListenerId:T.changeListenerId,changeChildernListenerId:U};this.__AL(R,X);this._updateSelection();}
...
;return Y;}
,__AK:function(){if(this.getTarget()==null||this.getChildPath()==null){return;}
...
;this.__AM();if(this.getModel()!=null){var bb=this._createItem();bb.setModel(this.getModel());this.getTarget().setRoot(bb);this.__AP(this.getModel(),bb);this.__AL(bb,this.getModel());}
;}
,__AL:function(bc,bd){if(bd["get"+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;}
;var bm=bd["get"+qx.lang.String.firstUp(this.getChildPath())]();if(this.__AG[bm.toHashCode()]==undefined){var bh=bm.addListener("change",this.__AI,this);var bl=qx.Class.getPropertyDefinition(bd.constructor,this.getChildPath());var bi=bl.event;var bj=bd.addListener(bi,this.__AJ,this);this.__AG[bm.toHashCode()]={modelNode:bd,treeNode:bc,changeListenerId:bh,changeChildernListenerId:bj};}
...
;}
else {var bk=this._createItem();bk.setModel(bm.getItem(i));bc.addAt(bk,i);this.__AP(bm.getItem(i),bk);this.__AL(bk,bm.getItem(i));}
;}
;}
;for(var i=bc.getChildren().length-1;i>=bm.length;i--){var bg=bc.getChildren()[i];this.__AO(bg,bc);}
;}
,__AM:function(bo){if(bo==null){bo=this.getTarget();}
;if(bo==null){return;}
;var bq=bo.getRoot();if(bq!=null){bo.setRoot(null);this.__AN(bq);var bp=bq.getModel();if(bp){this.__sn(bp);}
;bq.destroy();this.__AG={};}
;}
,__AN:function(br){var bs=br.getChildren()||[];for(var i=bs.length-1;i>=0;i--){if(bs[i].getChildren().length>0){this.__AN(bs[i]);}
;this.__AO(bs[i],br);}
;}
,__AO:function(bt,bu){var bw=bt.getModel();var by=this.__AH||this.getChildPath();var bz="get"+qx.lang.String.firstUp(by);if(bw[bz]!=undefined){var bx=bw[bz]();var bv=this.__AG[bx.toHashCode()];bx.removeListenerById(bv.changeListenerId);bw.removeListenerById(bv.changeChildernListenerId);this.__AN(bt);delete this.__AG[bx.toHashCode()];}
;this.__sn(bw);bu.remove(bt);bt.destroy();}
...
;if(!qx.lang.Array.contains(this.__Aq,bB)){this.__Aq.push(bB);}
;}
...
;if(!qx.lang.Array.contains(this.__Aq,bI)){this.__Aq.push(bI);}
;}
...
;}
,__AB:function(){var bR;for(var bT in this.__bg){bR=bT;break;}
;for(var bQ in this.__bg[bR]){var bU=this.__bg[bR][bQ].treeNode;var bS=qx.core.ObjectRegistry.fromHashCode(bQ);this.__sn(bS);this.__AP(bS,bU);}
;}
,__AP:function(bV,bW){var bX=this.getDelegate();if(bX!=null&&bX.bindItem!=null){bX.bindItem(this,bW,bV);}
else {this.bindDefaultProperties(bW,bV);}
;}
,__sn:function(bY){for(var i=0;i<this.__Aq.length;i++){var cb=this.__Aq[i];var ca=this.__bg[cb][bY.toHashCode()];if(ca!=null){if(ca.id){bY.removeBinding(ca.id);ca.id=null;}
...
;this._startSelectionModification();this.__AM();this.__AK();this._endSelectionModification();this._updateSelection();}
,_setBindItem:function(ch,ci){if(ch!=null&&ch.bindItem!=null){if(ci!=null&&ci.bindItem!=null&&ch.bindItem==ci.bindItem){return;}
;this.__AK();}
;}
},destruct:function(){this.setTarget(null);this.setModel(null);this.__bg=this.__AG=this.__Aq=null;}
});}
)();
