...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererDouble.f1578d4f5702.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="Female",n="Name",m="Registration",l="Male",k="Send",j="Bio",i="demobrowser.demo.ui.FormRendererDouble",h="Gender",g="Country",f="Personal Information",c="Save?",e="Password",d="Reset",b="Age",a="execute";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var q=new qx.ui.form.Form();q.addGroupHeader(m);var p=new qx.ui.form.TextField();p.setRequired(true);q.add(p,n);var v=new qx.ui.form.PasswordField();v.setRequired(true);q.add(v,e);q.add(new qx.ui.form.CheckBox(),c);q.addGroupHeader(f);q.add(new qx.ui.form.Spinner(),b);q.add(new qx.ui.form.TextField(),g);var t=new qx.ui.form.RadioButtonGroup();t.add(new qx.ui.form.RadioButton(l));t.add(new qx.ui.form.RadioButton(o));q.add(t,h);q.add(new qx.ui.form.TextArea(),j);var s=new qx.ui.form.Button(k);s.addListener(a,function(){if(q.validate()){alert("send...");}
;}
,this);q.addButton(s);var r=new qx.ui.form.Button(d);r.addListener(a,function(){q.reset();}
,this);q.addButton(r);var u=new qx.ui.form.renderer.Double(q);this.getRoot().add(u,{left:10,top:10});}
}});}
)();
...
(function(){var n="_applyValid",m="",l="changeRequired",k="changeValid",j="__rW",h="_applyInvalidMessage",g="qx.ui.form.RadioButtonGroup",f="qx.event.type.Data",d="Boolean",c="changeInvalidMessage",a="changeSelection",b="String";qx.Class.define(g,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__rW=new qx.ui.form.RadioGroup();this.__rW.addListener(a,function(e){this.fireDataEvent(a,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:d,init:true,apply:n,event:k},required:{check:d,init:false,event:l},invalidMessage:{check:b,init:m,event:c,apply:h},requiredInvalidMessage:{check:b,nullable:true,event:c}},events:{"changeSelection":f},members:{__rW:null,_applyInvalidMessage:function(p,q){var r=this._getChildren();for(var i=0;i<r.length;i++){r[i].setInvalidMessage(p);}
;}
,_applyValid:function(s,t){var u=this._getChildren();for(var i=0;i<u.length;i++){u[i].setValid(s);}
;}
,getRadioGroup:function(){return this.__rW;}
,getChildren:function(){return this._getChildren();}
,add:function(v,w){this.__rW.add(v);this._add(v,w);}
,remove:function(x){this.__rW.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__rW.getItems();for(var i=0;i<y.length;i++){this.__rW.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__rW.getSelection();}
,setSelection:function(z){this.__rW.setSelection(z);}
,resetSelection:function(){this.__rW.resetSelection();}
,isSelected:function(A){return this.__rW.isSelected(A);}
,isSelectionEmpty:function(){return this.__rW.isSelectionEmpty();}
,getSelectables:function(B){return this.__rW.getSelectables(B);}
},destruct:function(){this._disposeObjects(j);}
});}
)();
