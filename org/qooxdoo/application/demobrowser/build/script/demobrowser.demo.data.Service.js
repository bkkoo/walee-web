...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.ac6eb7c74f4c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="qxc/application/datademo/identica.png",j="one",h="http",g="source",f="error",e="selection[0]",d="Location: ",c="Details",b="http://identi.ca/api/statuses/user_timeline/linuxfoundation.json",a="Name: ",B="... service unavailable!",A="</a>",z="' target='_blank'>",y="qxc.application.datademo.Demo",x="user.name",w="user.location",v="<a href='",u="Avatar: ",t="Message: ",s="text",q="mshtml",r="engine.name",o=" ",p="user.profile_image_url",m="value",n="icon",l="model";qx.Class.define(y,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this._createView();}
,members:{_createView:function(){this.setLayout(new qx.ui.layout.Canvas());var I=new qx.ui.basic.Image(k);this.add(I,{left:10,top:15});var E=new qx.ui.form.List();this.add(E,{left:10,top:175,bottom:5});E.set({selectionMode:j,width:300,maxHeight:400,height:300});var F=new qx.data.controller.List(null,E);F.setDelegate(this);F.setLabelPath(s);if(qx.core.Environment.get(r)!=q){F.setIconPath(p);}
;var C=b;var K=new qx.data.store.Jsonp(C);K.bind(l,F,l);var H=new qx.ui.basic.Label(B);H.setTextColor("invalid");H.hide();this.add(H,{left:290,top:145});K.addListener(f,function(){H.show();E.setEnabled(false);D.setEnabled(false);}
,this);var D=new qx.ui.groupbox.GroupBox(c);this.add(D,{left:320,top:156,bottom:5});D.setWidth(270);D.setHeight(320);D.setAllowGrowY(false);D.setLayout(new qx.ui.layout.Grid(5,5));D.add(new qx.ui.basic.Label(a),{row:0,column:0});D.add(new qx.ui.basic.Label(d),{row:1,column:0});D.add(new qx.ui.basic.Label(t),{row:2,column:0});var name=new qx.ui.basic.Label();D.add(name,{row:0,column:1});var location=new qx.ui.basic.Label();D.add(location,{row:1,column:1});var J=new qx.ui.basic.Label();J.setRich(true);J.setWidth(150);J.setSelectable(true);D.add(J,{row:2,column:1});var G=new qx.data.controller.Object();G.addTarget(name,m,x);G.addTarget(location,m,w);G.addTarget(J,m,s,false,{converter:function(M){var N=M.split(o);for(var i=N.length-1;i>=0;i--){if(N[i].indexOf(h)==0){N[i]=v+N[i]+z+N[i]+A;}
;}
;return N.join(o);}
});if(qx.core.Environment.get(r)!=q){D.add(new qx.ui.basic.Label(u),{row:3,column:0});var L=new qx.ui.basic.Image();D.add(L,{row:3,column:1});G.addTarget(L,g,p);}
;F.bind(e,G,l);}
,configureItem:function(O){O.setRich(true);O.getChildControl(n).setWidth(48);O.getChildControl(n).setHeight(48);O.getChildControl(n).setScale(true);}
}});}
)();
...
(function(){var m="qx.ui.form.List",k="text",j="Boolean",h="one",g="addChildWidget",f="_applySpacing",d="Enter",c="__nz",b="Integer",a="action",A="keyinput",z="addItem",y="removeChildWidget",x="_applyOrientation",w="single",v="keypress",u="list",t="label",s="pane",r="removeItem",p="qx.event.type.Data",q="vertical",n="",o="horizontal";qx.Class.define(m,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__nz=this._createListItemContainer();this.__nz.addListener(g,this._onAddChild,this);this.__nz.addListener(y,this._onRemoveChild,this);this.getChildControl(s).add(this.__nz);if(B){this.setOrientation(o);}
else {this.initOrientation();}
;this.addListener(v,this._onKeyPress);this.addListener(A,this._onKeyInput);this.__zY=n;}
,events:{addItem:p,removeItem:p},properties:{appearance:{refine:true,init:u},focusable:{refine:true,init:true},orientation:{check:[o,q],init:q,apply:x},spacing:{check:b,init:0,apply:f,themeable:true},enableInlineFind:{check:j,init:true}},members:{__zY:null,__Aa:null,__nz:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__nz;}
...
,_applyOrientation:function(C,D){var E=C===o;var F=E?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__nz;content.setLayout(F);content.setAllowGrowX(!E);content.setAllowGrowY(E);this._applySpacing(this.getSpacing());}
,_applySpacing:function(G,H){this.__nz.getLayout().setSpacing(G);}
,_onKeyPress:function(e){if(e.getKeyIdentifier()==d&&!e.isAltPressed()){var I=this.getSelection();for(var i=0;i<I.length;i++){I[i].fireEvent(a);}
;return true;}
;return false;}
,_onKeyInput:function(e){if(!this.getEnableInlineFind()){return;}
;var J=this.getSelectionMode();if(!(J===w||J===h)){return;}
;if(((new Date).valueOf()-this.__Aa)>1000){this.__zY=n;}
;this.__zY+=e.getChar();var K=this.findItemByLabelFuzzy(this.__zY);if(K){this.setSelection([K]);}
;this.__Aa=(new Date).valueOf();}
...
;if(this.getSelection()==null){this.__Ai=new qx.data.Array();this.setSelection(this.__Ai);}
;}
,properties:{selection:{check:f,event:a,apply:d,init:null}},events:{"changeSelection":b},members:{_modifingSelection:0,__Aj:null,__Ak:null,__Ai:null,_applySelection:function(h,j){if(this.__Ak!=undefined&&j!=undefined){j.removeListenerById(this.__Ak);}
;this.__Ak=h.addListener(g,this.__Al,this);this._updateSelection();}
,__Al:function(){this._updateSelection();}
,_changeTargetSelection:function(){if(this.getTarget()==null){return;}
;if(!this.__Am()&&!this.__An()){return;}
;if(this._inSelectionModification()){return;}
;var l=this.getTarget().getSelection();var k=this.getSelection();if(k==null){k=new qx.data.Array();this.__Ai=k;this.setSelection(k);}
...
,_addChangeTargetListener:function(n,o){if(this.__Aj!=undefined&&o!=undefined){o.removeListenerById(this.__Aj);}
;if(n!=null){if(this.__Am()||this.__An()){this.__Aj=n.addListener(a,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()){return;}
;this._startSelectionModification();if(this.__Am()){var r=[];for(var i=0;i<this.getSelection().length;i++){var s=this.getSelection().getItem(i);var t=this.__Ao(s);if(t!=null){r.push(t);}
;}
...
;}
;}
else if(this.__An()){var q=this.getSelection().getItem(this.getSelection().length-1);if(q!==undefined){this.__sI(q);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__Am:function(){var u=this.getTarget().constructor;return qx.Class.implementsInterface(u,qx.ui.core.IMultiSelection);}
,__An:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.ISingleSelection);}
,__sI:function(w){var x=this.__Ao(w);if(x==null){return;}
;if(this.__Am()){this.getTarget().addToSelection(x);}
else if(this.__An()){this.getTarget().setSelection([x]);}
;}
,__Ao:function(y){var z=this.getTarget().getSelectables(true);for(var i=0;i<z.length;i++){if(z[i].getModel()==y){return z[i];}
;}
;return null;}
...
(function(){var m="changeModel",k="_applyLabelOptions",h="_applyLabelPath",g="changeTarget",f="_applyModel",e="icon",d="qx.data.controller.List",c="_applyIconPath",b="_applyDelegate",a="changeDelegate",z="_applyTarget",y="qx.data.IListData",x="model",w="label",v="_applyIconOptions",u="change",t="ReverseBindingId",s="BindingId",r="]",q="model[",o="String",p=".",n="";qx.Class.define(d,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__Ap=[];this.__Aq=[];this.__Ar=[];this.__As={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:y,apply:f,event:m,nullable:true,dereference:true},target:{apply:z,event:g,nullable:true,init:null,dereference:true},labelPath:{check:o,apply:h,nullable:true},iconPath:{check:o,apply:c,nullable:true},labelOptions:{apply:k,nullable:true},iconOptions:{apply:v,nullable:true},delegate:{apply:b,event:a,init:null,nullable:true}},members:{__At:null,__Ap:null,__As:null,__Aq:null,__Ar:null,__Au:null,__Av:null,update:function(){this.__Ax();this.__AB();this._updateSelection();}
,_applyDelegate:function(D,E){this._setConfigureItem(D,E);this._setFilter(D,E);this._setCreateItem(D,E);this._setBindItem(D,E);}
,_applyIconOptions:function(F,G){this.__AB();}
,_applyLabelOptions:function(H,I){this.__AB();}
,_applyIconPath:function(J,K){this.__AB();}
,_applyLabelPath:function(L,M){this.__AB();}
,_applyModel:function(N,O){if(O!=undefined){if(this.__At!=undefined){O.removeListenerById(this.__At);}
;}
;if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length).dispose();}
;if(N!=null){this.__At=N.addListener(u,this.__Aw,this);this.__AD();this.__Ax();if(O==null){this._changeTargetSelection();}
else {this.__Au=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var P=this.getTarget();if(P!=null){var length=P.getChildren().length;for(var i=0;i<length;i++){this.__AA();}
;}
;}
;}
...
;if(Q!=null){if(this.getModel()!=null){for(var i=0;i<this.__Ap.length;i++){this.__Az(this.__AE(i));}
;}
;}
;}
,__Aw:function(){this.__Av=true;qx.ui.core.queue.Widget.add(this);if(this.__Ap.length!=this.getModel().getLength()){this.update();}
;}
,syncWidget:function(){if(this.__Au){this._changeTargetSelection();}
;if(this.__Av){this._updateSelection();}
;this.__Av=this.__Au=null;}
,__Ax:function(){if(this.getTarget()==null){return;}
;this.__AD();var U=this.__Ap.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++){this.__Az(this.__AE(j));}
;}
else if(U<T){for(var j=T;j>U;j--){this.__AA();}
;}
;this.__Au=true;qx.ui.core.queue.Widget.add(this);}
,__Ay:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__At);this.__At=V.addListener(u,this.__Aw,this);}
;}
...
;return W;}
,__Az:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__AA:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bm,bn,bo,bp,bq){if(bo!=null){var bo=qx.lang.Object.clone(bo);this.__As[bn]=bo.onUpdate;delete bo.onUpdate;}
else {bo={};this.__As[bn]=null;}
;bo.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bq);var br=q+bq+r;if(bm!=null&&bm!=n){br+=p+bm;}
;var bs=this.bind(br,bp,bn,bo);bp.setUserData(bn+s,bs);if(!qx.lang.Array.contains(this.__Aq,bn)){this.__Aq.push(bn);}
;}
,bindPropertyReverse:function(bt,bu,bv,bw,bx){var by=q+bx+r;if(bt!=null&&bt!=n){by+=p+bt;}
;var bz=bw.bind(bu,this,by,bv);bw.setUserData(bt+t,bz);if(!qx.lang.Array.contains(this.__Ar,bt)){this.__Ar.push(bt);}
;}
,_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;}
;for(var i=0;i<this.__Aq.length;i++){if(this.__As[this.__Aq[i]]!=null){this.__As[this.__Aq[i]]();}
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__Aq.length;i++){var bE=bD.getUserData(this.__Aq[i]+s);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__Ar.length;i++){var bE=bD.getUserData(this.__Ar[i]+t);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__AB:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__AE(i));}
;this.__Ay();}
...
,_setFilter:function(bP,bQ){if((bP==null||bP.filter==null)&&(bQ!=null&&bQ.filter!=null)){this.__AC();}
...
;var bS=this.__Ap;this.__AD();if(bS.length>this.__Ap.length){for(var j=bS.length;j>this.__Ap.length;j--){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bS.length<this.__Ap.length){for(var j=bS.length;j<this.__Ap.length;j++){var bT=this._createItem();this.getTarget().add(bT);}
;}
;var bR=this.getTarget().getChildren();for(var i=0;i<bR.length;i++){this._bindListItem(bR[i],this.__AE(i));}
;this.__Ay();this._endSelectionModification();this._updateSelection();}
,__AC:function(){this.__AD();this.__Ax();this.__AB();this.__Av=true;qx.ui.core.queue.Widget.add(this);}
,__AD:function(){var bW=this.getModel();if(bW==null){return;}
;var bX=this.getDelegate();if(bX!=null){var bV=bX.filter;}
;this.__Ap=[];for(var i=0;i<bW.getLength();i++){if(bV==null||bV(bW.getItem(i))){this.__Ap.push(i);}
;}
;}
,__AE:function(bY){return this.__Ap[bY];}
},destruct:function(){this.__Ap=this.__As=this.__Aq=null;this.__Ar=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
...
;this.fireDataEvent(f,this.getModel());if(this.__rS){this.__rS.dispose();this.__rS=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__rS!=null){this._disposeObjects(g);}
...
(function(){var a="qx.data.marshal.Json";qx.Class.define(a,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(b){qx.core.Object.call(this);this.__AQ=b;}
,statics:{$$instance:null,createModel:function(c,d){if(this.$$instance===null){this.$$instance=new qx.data.marshal.Json();}
;this.$$instance.toClass(c,d);return this.$$instance.toModel(c);}
},members:{__AQ:null,__AR:function(e){return Object.keys(e).sort().join('"');}
,toClass:function(f,g){this.__AS(f,g,null,0);}
,__AS:function(h,j,k,l){if(!qx.lang.Type.isObject(h)||!!h.$$isString||h instanceof qx.core.Object){if(h instanceof Array||qx.Bootstrap.getClass(h)=="Array"){for(var i=0;i<h.length;i++){this.__AS(h[i],j,null,l+1);}
;}
;return;}
;var n=this.__AR(h);if(this.__AW(n,k,l)){return;}
;for(var o in h){this.__AS(h[o],j,o,l+1);}
;if(qx.Class.isDefined("qx.data.model."+n)){return;}
;if(this.__AQ&&this.__AQ.getModelClass&&this.__AQ.getModelClass(n)!=null){return;}
;var u={};var t={__AT:this.__AT};for(var o in h){if(this.__AQ&&this.__AQ.getPropertyMapping){o=this.__AQ.getPropertyMapping(o,n);}
;o=o.replace(/-|\.|\s+/g,"");if(qx.core.Environment.get("qx.debug")){this.assertTrue((/^[$0-9A-Za-z_]*$/).test(o),"The key '"+o+"' is not a valid JavaScript identifier.");}
;u[o]={};u[o].nullable=true;u[o].event="change"+qx.lang.String.firstUp(o);if(j){u[o].apply="_applyEventPropagation";}
;if(this.__AQ&&this.__AQ.getValidationRule){var q=this.__AQ.getValidationRule(n,o);if(q){u[o].validate="_validate"+o;t["_validate"+o]=q;}
;}
;}
;if(this.__AQ&&this.__AQ.getModelSuperClass){var s=this.__AQ.getModelSuperClass(n)||qx.core.Object;}
else {var s=qx.core.Object;}
;var p=[];if(this.__AQ&&this.__AQ.getModelMixins){var r=this.__AQ.getModelMixins(n);if(!qx.lang.Type.isArray(r)){if(r!=null){p=[r];}
;}
else {p=r;}
;}
;if(j){p.push(qx.data.marshal.MEventBubbling);}
;var m={extend:s,include:p,properties:u,members:t,destruct:this.__AU};qx.Class.define("qx.data.model."+n,m);}
,__AU:function(){var v=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var w in v){this.__AT(this.get(v[w].name));}
;}
,__AT:function(x){if(!(x instanceof qx.core.Object)){return;}
;if(x.isDisposed()){return;}
;x.dispose();}
,__AV:function(y){var z;if(this.__AQ&&this.__AQ.getModelClass){z=this.__AQ.getModelClass(y);}
;if(z!=null){return (new z());}
else {var A=qx.Class.getByName("qx.data.model."+y);return (new A());}
;}
,__AW:function(B,C,D){var E=this.__AQ;return E&&E.ignore&&E.ignore(B,C,D);}
,toModel:function(F){return this.__AX(F,null,0);}
,__AX:function(G,H,I){var N=qx.lang.Type.isObject(G);var J=G instanceof Array||qx.Bootstrap.getClass(G)=="Array";if((!N&&!J)||!!G.$$isString||G instanceof qx.core.Object){return G;}
else if(this.__AW(this.__AR(G),H,I)){return G;}
else if(J){var P=new qx.data.Array();P.setAutoDisposeItems(true);for(var i=0;i<G.length;i++){P.push(this.__AX(G[i],null,I+1));}
;return P;}
else if(N){var K=this.__AR(G);var Q=this.__AV(K);for(var O in G){var L=O;if(this.__AQ&&this.__AQ.getPropertyMapping){L=this.__AQ.getPropertyMapping(O,K);}
;var R=L.replace(/-|\.|\s+/g,"");if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.debug.databinding")){if(R!=L){this.warn("The model contained an illegal name: '"+O+"'. Replaced it with '"+L+"'.");}
;}
;L=R;var M="set"+qx.lang.String.firstUp(L);if(Q[M]){Q[M](this.__AX(G[O],O,I+1));}
;}
;return Q;}
...
(function(){var s="head",r="unknown",q="readystatechange",p="script",o="load",n="opera",m="abort",l="on",k="timeout",j="Unknown response headers",d="error",i="qx.debug",g="mshtml",c="",b="loadend",f="browser.documentmode",e="engine.name",h="qx.debug.io",a="qx.bom.request.Script";qx.Bootstrap.define(a,{construct:function(){this.__Be();this.__AY=qx.Bootstrap.bind(this._onNativeLoad,this);this.__Ba=qx.Bootstrap.bind(this._onNativeError,this);this.__uV=qx.Bootstrap.bind(this._onTimeout,this);this.__Bb=document.head||document.getElementsByTagName(s)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__Bg()?0:15000;}
,events:{"readystatechange":a,"error":a,"loadend":a,"timeout":a,"abort":a,"load":a},members:{readyState:null,status:null,statusText:null,timeout:null,__Bc:null,on:function(name,t,u){this._emitter.on(name,t,u);return this;}
,open:function(v,w){if(this.__vq){return;}
;this.__Be();this.__uY=null;this.__vl=w;if(this.__Bj(h)){qx.Bootstrap.debug(qx.bom.request.Script,"Open native request with "+"url: "+w);}
;this._readyStateChange(1);}
,setRequestHeader:function(x,y){if(this.__vq){return null;}
;var z={};if(this.readyState!==1){throw new Error("Invalid state");}
;z[x]=y;this.__vl=qx.util.Uri.appendParamsToUrl(this.__vl,z);return this;}
,send:function(){if(this.__vq){return null;}
;var C=this.__Bh(),A=this.__Bb,B=this;if(this.timeout>0){this.__fu=window.setTimeout(this.__uV,this.timeout);}
;if(this.__Bj(h)){qx.Bootstrap.debug(qx.bom.request.Script,"Send native request");}
;A.insertBefore(C,A.firstChild);window.setTimeout(function(){B._readyStateChange(2);B._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__vq){return null;}
;this.__uY=true;this.__Bi();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(D){if(this.__vq){return null;}
;if(this.__Bj(i)){qx.Bootstrap.debug("Response header cannot be determined for "+"requests made with script transport.");}
;return r;}
,getAllResponseHeaders:function(){if(this.__vq){return null;}
;if(this.__Bj(i)){qx.Bootstrap.debug("Response headers cannot be determined for"+"requests made with script transport.");}
;return j;}
,setDetermineSuccess:function(E){this.__Bc=E;}
,dispose:function(){var F=this.__Bd;if(!this.__vq){if(F){F.onload=F.onreadystatechange=null;this.__Bi();}
;if(this.__fu){window.clearTimeout(this.__fu);}
;this.__vq=true;}
;}
,_getUrl:function(){return this.__vl;}
,_getScriptElement:function(){return this.__Bd;}
,_onTimeout:function(){this.__Bf();if(!this.__Bg()){this._emit(d);}
;this._emit(k);if(!this.__Bg()){this._emit(b);}
;}
,_onNativeLoad:function(){var I=this.__Bd,G=this.__Bc,H=this;if(this.__uY){return;}
;if(this.__Bj(e)===g&&this.__Bj(f)<9){if(!(/loaded|complete/).test(I.readyState)){return;}
else {if(this.__Bj(h)){qx.Bootstrap.debug(qx.bom.request.Script,"Received native readyState: loaded");}
;}
;}
;if(this.__Bj(h)){qx.Bootstrap.debug(qx.bom.request.Script,"Received native load");}
;if(G){if(!this.status){this.status=G()?200:500;}
;}
;if(this.status===500){if(this.__Bj(h)){qx.Bootstrap.debug(qx.bom.request.Script,"Detected error");}
;}
;if(this.__fu){window.clearTimeout(this.__fu);}
;window.setTimeout(function(){H._success();H._readyStateChange(4);H._emit(o);H._emit(b);}
);}
,_onNativeError:function(){this.__Bf();this._emit(d);this._emit(b);}
,__Bd:null,__Bb:null,__vl:c,__AY:null,__Ba:null,__uV:null,__fu:null,__uY:null,__vq:null,__Be:function(){this.readyState=0;this.status=0;this.statusText=c;}
,_readyStateChange:function(J){this.readyState=J;this._emit(q);}
,_success:function(){this.__Bi();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=c+this.status;}
,__Bf:function(){this.__Bi();this.readyState=4;this.status=0;this.statusText=null;}
,__Bg:function(){var L=this.__Bj(e)===g&&this.__Bj(f)<9;var K=this.__Bj(e)===n;return !(L||K);}
,__Bh:function(){var M=this.__Bd=document.createElement(p);M.src=this.__vl;M.onerror=this.__Ba;M.onload=this.__AY;if(this.__Bj(e)===g&&this.__Bj(f)<9){M.onreadystatechange=this.__AY;}
;return M;}
,__Bi:function(){var N=this.__Bd;if(N&&N.parentNode){this.__Bb.removeChild(N);}
;}
,__Bj:function(O){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(O);}
...
(function(){var j="qx.bom.request.Jsonp",i="callback",h="open",g="dispose",f="qx.debug",e="_onNativeLoad",d="].callback",c="qx.bom.request.Jsonp[",b="",a="qx.debug.io";qx.Bootstrap.define(j,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__Bq();}
,members:{responseJson:null,__bV:null,__Bk:null,__Bl:null,__Bm:null,__Bn:null,__vq:null,__Bo:b,open:function(k,l){if(this.__vq){return;}
;var m={},o,n,p=this;this.responseJson=null;this.__Bm=false;o=this.__Bk||i;n=this.__Bl||this.__Bo+c+this.__bV+d;if(!this.__Bl){this.constructor[this.__bV]=this;}
else {if(!window[this.__Bl]){this.__Bn=true;window[this.__Bl]=function(q){p.callback(q);}
;}
else {if(qx.core.Environment.get(a)){qx.Bootstrap.debug(qx.bom.request.Jsonp,"Callback "+this.__Bl+" already exists");}
;}
;}
;if(qx.core.Environment.get(a)){qx.Bootstrap.debug(qx.bom.request.Jsonp,"Expecting JavaScript response to call: "+n);}
;m[o]=n;l=qx.util.Uri.appendParamsToUrl(l,m);this.__hJ(h,[k,l]);}
,callback:function(r){if(this.__vq){return;}
;this.__Bm=true;if(qx.core.Environment.get(f)){r=qx.lang.Json.stringify(r);r=qx.lang.Json.parse(r);}
;this.responseJson=r;this.constructor[this.__bV]=undefined;this.__Bp();}
,setCallbackParam:function(s){this.__Bk=s;return this;}
,setCallbackName:function(name){this.__Bl=name;return this;}
,setPrefix:function(t){this.__Bo=t;}
,dispose:function(){this.__Bp();this.__hJ(g);}
,_onNativeLoad:function(){this.status=this.__Bm?200:500;this.__hJ(e);}
,__Bp:function(){if(this.__Bn&&window[this.__Bl]){window[this.__Bl]=undefined;this.__Bn=false;}
;}
,__hJ:function(u,v){qx.bom.request.Script.prototype[u].apply(this,v||[]);}
,__Bq:function(){this.__bV=(new Date().valueOf())+(b+Math.random()).substring(2,5);}
}});}
)();
...
(function(){var h="changeModel",g="qx.core.Object",f="qx.data.controller.Object",e="get",d="reset",c="_applyModel",b="last",a="[";qx.Class.define(f,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bg={};this.__gh=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:g,event:h,apply:c,nullable:true,dereference:true}},members:{__gh:null,__bg:null,_applyModel:function(k,l){for(var i=0;i<this.__gh.length;i++){var t=this.__gh[i][0];var q=this.__gh[i][1];var o=this.__gh[i][2];var r=this.__gh[i][3];var s=this.__gh[i][4];var n=this.__gh[i][5];if(l!=undefined&&!l.isDisposed()){this.__Bw(t,q,o,l);}
;if(k!=undefined){this.__Bv(t,q,o,r,s,n);}
...
;}
;}
,addTarget:function(u,v,w,x,y,z){this.__gh.push([u,v,w,x,y,z]);this.__Bv(u,v,w,x,y,z);}
,__Bv:function(A,B,C,D,E,F){if(this.getModel()==null){return;}
...
,removeTarget:function(J,K,L){this.__Bw(J,K,L,this.getModel());for(var i=0;i<this.__gh.length;i++){if(this.__gh[i][0]==J&&this.__gh[i][1]==K&&this.__gh[i][2]==L){this.__gh.splice(i,1);}
;}
;}
,__Bw:function(M,N,O,P){if(!(M instanceof qx.core.Object)){return;}
