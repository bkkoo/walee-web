...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer.796141831b0a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{selectionModel:{check:b}},members:{__pM:null,handleMouseDown:function(c,d){if(d.isLeftPressed()){var e=this.getSelectionModel();if(!e.isSelectedIndex(c)){this._handleSelectEvent(c,d);this.__pM=true;}
...
;}
;}
,handleMouseUp:function(f,g){if(g.isLeftPressed()&&!this.__pM){this._handleSelectEvent(f,g);}
;}
...
(function(){var n="]",m="..",l="changeSelection",k=" [",h='ie',g="browser.version",f="qx.event.type.Event",d="Ranges:",c="qx.ui.table.selection.Model",b="browser.name",a="_applySelectionMode";qx.Class.define(c,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__pN=[];this.__pO=-1;this.__pP=-1;this.hasBatchModeRefCount=0;this.__pQ=false;}
,events:{"changeSelection":f},statics:{NO_SELECTION:1,SINGLE_SELECTION:2,SINGLE_INTERVAL_SELECTION:3,MULTIPLE_INTERVAL_SELECTION:4,MULTIPLE_INTERVAL_SELECTION_TOGGLE:5},properties:{selectionMode:{init:2,check:[1,2,3,4,5],apply:a}},members:{__pQ:null,__pO:null,__pP:null,__pN:null,_applySelectionMode:function(o){this.resetSelection();}
,setBatchMode:function(p){if(p){this.hasBatchModeRefCount+=1;}
else {if(this.hasBatchModeRefCount==0){throw new Error("Try to turn off batch mode althoug it was not turned on.");}
;this.hasBatchModeRefCount-=1;if(this.__pQ){this.__pQ=false;this._fireChangeSelection();}
;}
;return this.hasBatchMode();}
,hasBatchMode:function(){return this.hasBatchModeRefCount>0;}
,getAnchorSelectionIndex:function(){return this.__pO;}
,_setAnchorSelectionIndex:function(q){this.__pO=q;}
,getLeadSelectionIndex:function(){return this.__pP;}
,_setLeadSelectionIndex:function(r){this.__pP=r;}
,_getSelectedRangeArr:function(){return this.__pN;}
,resetSelection:function(){if(!this.isSelectionEmpty()){this._resetSelection();this._fireChangeSelection();}
;}
,isSelectionEmpty:function(){return this.__pN.length==0;}
,getSelectedCount:function(){var t=0;for(var i=0;i<this.__pN.length;i++){var s=this.__pN[i];t+=s.maxIndex-s.minIndex+1;}
;return t;}
,isSelectedIndex:function(u){for(var i=0;i<this.__pN.length;i++){var v=this.__pN[i];if(u>=v.minIndex&&u<=v.maxIndex){return true;}
;}
;return false;}
,getSelectedRanges:function(){var w=[];for(var i=0;i<this.__pN.length;i++){w.push({minIndex:this.__pN[i].minIndex,maxIndex:this.__pN[i].maxIndex});}
;return w;}
,iterateSelection:function(x,y){for(var i=0;i<this.__pN.length;i++){for(var j=this.__pN[i].minIndex;j<=this.__pN[i].maxIndex;j++){x.call(y,j);}
;}
;}
...
,removeSelectionInterval:function(F,G){this.__pO=F;this.__pP=G;var H=Math.min(F,G);var J=Math.max(F,G);for(var i=0;i<this.__pN.length;i++){var L=this.__pN[i];if(L.minIndex>J){break;}
else if(L.maxIndex>=H){var M=(L.minIndex>=H)&&(L.minIndex<=J);var K=(L.maxIndex>=H)&&(L.maxIndex<=J);if(M&&K){this.__pN.splice(i,1);i--;}
else if(M){L.minIndex=J+1;}
else if(K){L.maxIndex=H-1;}
else {var I={minIndex:J+1,maxIndex:L.maxIndex};this.__pN.splice(i+1,0,I);L.maxIndex=H-1;break;}
;}
;}
;this._fireChangeSelection();}
,_resetSelection:function(){this.__pN=[];this.__pO=-1;this.__pP=-1;}
,_addSelectionInterval:function(N,O){this.__pO=N;this.__pP=O;var P=Math.min(N,O);var R=Math.max(N,O);var Q=0;for(;Q<this.__pN.length;Q++){var S=this.__pN[Q];if(S.minIndex>P){break;}
;}
;this.__pN.splice(Q,0,{minIndex:P,maxIndex:R});var T=this.__pN[0];for(var i=1;i<this.__pN.length;i++){var S=this.__pN[i];if(T.maxIndex+1>=S.minIndex){T.maxIndex=Math.max(T.maxIndex,S.maxIndex);this.__pN.splice(i,1);i--;}
else {T=S;}
;}
;}
,_dumpRanges:function(){var U=d;for(var i=0;i<this.__pN.length;i++){var V=this.__pN[i];U+=k+V.minIndex+m+V.maxIndex+n;}
;this.debug(U);}
,_fireChangeSelection:function(){if(this.hasBatchMode()){this.__pQ=true;}
...
,_insetY:1,_renderFont:function(y){if(y){this.__pn=y.getStyles();this.__po=qx.bom.element.Style.compile(this.__pn);this.__po=this.__po.replace(/"/g,e);}
else {this.__po=k;this.__pn=qx.bom.Font.getDefaultStyles();}
;}
,updateDataRowElement:function(z,A){var C=this.__pn;var B=A.style;qx.bom.element.Style.setStyles(A,C);if(z.focusedRow&&this.getHighlightFocusRow()){B.backgroundColor=z.selected?this._colors.bgcolFocusedSelected:this._colors.bgcolFocused;}
...
;return f+D+o;}
,createRowStyle:function(E){var F=[];F.push(l);F.push(this.__po);F.push(s);if(E.focusedRow&&this.getHighlightFocusRow()){F.push(E.selected?this._colors.bgcolFocusedSelected:this._colors.bgcolFocused);}
...
},destruct:function(){this._colors=this.__pn=this.__po=null;qx.theme.manager.Appearance.getInstance().removeListener(m,this.initThemeValues,this);}
});}
)();
...
(function(){var e="__pR",d="qx.ui.table.pane.Header",c="hovered",b="first",a="last";qx.Class.define(d,{extend:qx.ui.core.Widget,construct:function(f){qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.HBox());this.__kP=new qx.ui.core.Blocker(this);this.__pR=f;}
,members:{__pR:null,__qa:null,__qb:null,__kP:null,getPaneScroller:function(){return this.__pR;}
,getTable:function(){return this.__pR.getTable();}
...
;}
,setMouseOverColumn:function(k){if(k!=this.__qb){if(this.__qb!=null){var l=this.getHeaderWidgetAtColumn(this.__qb);if(l!=null){l.removeState(c);}
;}
...
,showColumnMoveFeedback:function(o,x){var s=this.getContainerLocation();if(this.__qa==null){var y=this.getTable();var p=this.getPaneScroller().getTablePaneModel().getX(o);var r=this._getChildren()[p];var t=y.getTableModel();var v=y.getTableColumnModel();var w={xPos:p,col:o,name:t.getColumnName(o),table:y};var u=v.getHeaderCellRenderer(o);var q=u.createHeaderCell(w);var z=r.getBounds();q.setWidth(z.width);q.setHeight(z.height);q.setZIndex(1000000);q.setOpacity(0.8);q.setLayoutProperties({top:s.top});this.getApplicationRoot().add(q);this.__qa=q;}
;this.__qa.setLayoutProperties({left:s.left+x});this.__qa.show();}
,hideColumnMoveFeedback:function(){if(this.__qa!=null){this.__qa.destroy();this.__qa=null;}
;}
...
;}
},destruct:function(){this.__kP.dispose();this._disposeObjects(e);}
});}
)();
...
(function(){var k='<div>',j="</div>",h="overflow: hidden;",g="qx.event.type.Data",f="paneReloadsData",e="div",d='style="',c="_applyMaxCacheLines",b="qx.ui.table.pane.Pane",a="width: 100%;",E="qx.event.type.Event",D="_applyVisibleRowCount",C='>',B="line-height: ",A="appear",z='class="',w="width:100%;",v="px;",u='<div ',t="'>",r="_applyFirstVisibleRow",s="<div style='",p=";position:relative;",q='</div>',n='" ',o="paneUpdated",l="Number",m="";qx.Class.define(b,{extend:qx.ui.core.Widget,construct:function(F){qx.ui.core.Widget.call(this);this.__pR=F;this.__pS=0;this.__pi=0;this.__pT=[];}
,events:{"paneReloadsData":g,"paneUpdated":E},properties:{firstVisibleRow:{check:l,init:0,apply:r},visibleRowCount:{check:l,init:0,apply:D},maxCacheLines:{check:l,init:1000,apply:c},allowShrinkX:{refine:true,init:false}},members:{__pi:null,__pS:null,__pR:null,__pU:null,__pf:null,__pe:null,__pT:null,__pV:0,_applyFirstVisibleRow:function(G,H){this.updateContent(false,G-H);}
,_applyVisibleRowCount:function(I,J){this.updateContent(true);}
,_getContentHint:function(){return {width:this.getPaneScroller().getTablePaneModel().getTotalWidth(),height:400};}
,getPaneScroller:function(){return this.__pR;}
,getTable:function(){return this.__pR.getTable();}
,setFocusedCell:function(K,L,M){if(K!=this.__pe||L!=this.__pf){var N=this.__pf;this.__pe=K;this.__pf=L;if(L!=N&&!M){if(N!==null){this.updateContent(false,null,N,true);}
...
,onTableModelDataChanged:function(Q,R,S,T){this.__pW();var V=this.getFirstVisibleRow();var U=this.getVisibleRowCount();if(R==-1||R>=V&&Q<V+U){this.updateContent();}
;}
,onTableModelMetaDataChanged:function(){this.updateContent(true);}
,_applyMaxCacheLines:function(W,X){if(this.__pV>=W&&W!==-1){this.__pW();}
;}
,__pW:function(){this.__pT=[];this.__pV=0;}
,__pX:function(Y,ba,bb){if(!ba&&!bb&&this.__pT[Y]){return this.__pT[Y];}
else {return null;}
;}
,__pY:function(bc,bd,be,bf){var bg=this.getMaxCacheLines();if(!be&&!bf&&!this.__pT[bc]&&bg>0){this._applyMaxCacheLines(bg);this.__pT[bc]=bd;this.__pV+=1;}
;}
...
;by.push(q);var bQ=by.join(m);this.__pY(bE,bQ,bH,bK);bX.push(bQ);}
...
;}
;if(!this.__pU){this.__pU=document.createElement(e);}
;var ck=k;ck+=this._getRowsHtml(ci+ce,Math.abs(cb));ck+=q;this.__pU.innerHTML=ck;var cf=this.__pU.firstChild.childNodes;if(cb>0){for(var i=cf.length-1;i>=0;i--){var ch=cf[0];cl.appendChild(ch);}
;}
else {for(var i=cf.length-1;i>=0;i--){var ch=cf[cf.length-1];cl.insertBefore(ch,cl.firstChild);}
;}
;if(this.__pf!==null){this._updateRowStyles(this.__pf-cb);this._updateRowStyles(this.__pf);}
;this.fireEvent(o);}
...
;var cA=cu.join(m);cs.innerHTML=cA;this.setWidth(cr);this.__pS=cw;this.__pi=cq;this.fireEvent(o);}
},destruct:function(){this.__pU=this.__pR=this.__pT=null;}
});}
)();
...
;}
,properties:{defaultCellStyle:{init:null,check:D,nullable:true}},members:{_onChangeTheme:function(){qx.bom.Stylesheet.removeAllRules(qx.ui.table.cellrenderer.Abstract.__ol.stylesheet);this._createStyleSheet();}
...
;qx.ui.table.cellrenderer.Abstract.__ol.stylesheet=qx.bom.Stylesheet.createElement(M);}
...
;}
,__GG:function(Q,top,R,S,T){var U=["<div style='position:absolute;height:20px;width:",R,"px;top:",top,"px'>"];S.createDataCellHtml(T,U);U.push("</div>");Q.innerHTML+=U.join("");}
,testDefaultRenderer:function(V){var W=100;var Y={value:[null,D,32,new Date()],styleLeft:[0],styleWidth:[W],styleHeight:[20],style:[C]};var X=this._getNewTableDiv(W);var top=0;qx.util.Permutation.permute(Y,function(ba){this.__GG(X,top,W,V,ba);top+=20;}
,this);}
,testBooleanRenderer:function(){var be=70;var bd=30;var bf=new qx.ui.table.cellrenderer.Boolean();var bb={value:[null,true,false],styleLeft:[0],styleWidth:[be],styleHeight:[bd],style:[C]};var bc=this._getNewTableDiv(be);var top=0;qx.util.Permutation.permute(bb,function(bg){this.__GG(bc,top,be,bf,bg);top+=bd;}
,this);bf.setIconFalse(l);bf.setIconTrue(m);qx.util.Permutation.permute(bb,function(bh){this.__GG(bc,top,be,bf,bh);top+=bd;}
,this);}
,testDateRenderer:function(){var bl=180;var bm=new qx.ui.table.cellrenderer.Date();var bo={value:new Date(),styleLeft:[0],styleWidth:[bl],styleHeight:[20],style:[C]};var bk=qx.util.format.DateFormat;var bn=[bk.getDateTimeInstance(),bk.getDateInstance()];var bi=this._getNewTableDiv(bl);var top=0;for(var i=0;i<bn.length;i++){var bj=bn[i];bm.setDateFormat(bj);this.__GG(bi,top,bl,bm,bo);top+=20;}
;}
,testNumberRenderer:function(){var bt=new qx.ui.table.cellrenderer.Number();var bs=100;var bv={value:Math.PI,styleLeft:[0],styleWidth:[bs],styleHeight:[20],style:[C]};var br=qx.util.format.NumberFormat;var bu=[new br().set({maximumFractionDigits:0}),new br().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:e})];var bp=this._getNewTableDiv(bs);var top=0;for(var i=0;i<bu.length;i++){var bq=bu[i];bt.setNumberFormat(bq);this.__GG(bp,top,bs,bt,bv);top+=20;}
;}
,testImageRenderer:function(){var by=new qx.ui.table.cellrenderer.Image();var bw=50;var bz={value:[null,y,r,K,h,f],styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[C],tooltip:[C,n]};var bx=this._getNewTableDiv(bw);var top=0;qx.util.Permutation.permute(bz,function(bA){this.__GG(bx,top,bw,by,bA);top+=20;}
,this);}
,testStringRenderer:function(){var bF=new qx.ui.table.cellrenderer.String();var bE=100;var bD=20;var bB={value:[null,z,B],styleLeft:[0],styleWidth:[bE],styleHeight:[bD],style:[C]};var bC=this._getNewTableDiv(bE);var top=0;qx.util.Permutation.permute(bB,function(bG){this.__GG(bC,top,bE,bF,bG);top+=20;}
,this);}
,testPasswordRenderer:function(){var bL=new qx.ui.table.cellrenderer.Password();var bK=100;var bJ=20;var bH={value:[null,z,B],styleLeft:[0],styleWidth:[bK],styleHeight:[bJ],style:[C]};var bI=this._getNewTableDiv(bK);var top=0;qx.util.Permutation.permute(bH,function(bM){this.__GG(bI,top,bK,bL,bM);top+=20;}
,this);}
,testHtmlRenderer:function(){var bR=new qx.ui.table.cellrenderer.Html();var bQ=100;var bP=50;var bN={value:[null,E,H,a],styleLeft:[0],styleWidth:[bQ],styleHeight:[bP],style:[C]};var bO=this._getNewTableDiv(bQ);var top=0;qx.util.Permutation.permute(bN,function(bS){this.__GG(bO,top,bQ,bR,bS);top+=20;}
,this);}
,testConditionalRenderer:function(){var bX=new qx.ui.table.cellrenderer.Conditional();bX.addNumericCondition(M,0,null,o,null,null);bX.addNumericCondition(u,100,t,null,null,null);bX.addBetweenCondition(N,0,2,null,null,null,v,null);bX.addRegex(G,null,null,v,c);var bW=100;var bV=20;var bT={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bW],table:[this.tableMock],styleHeight:[bV],style:[C]};var bU=this._getNewTableDiv(bW);var top=0;qx.util.Permutation.permute(bT,function(bY){this.__GG(bU,top,bW,bX,bY);top+=20;}
,this);}
...
);var cd=100;var cc=20;var ca={value:[null,D,new Date(),30,y,false],styleLeft:[0],styleWidth:[cd],styleHeight:[cc],table:[this.tableMock],style:[C]};var cb=this._getNewTableDiv(cd);var top=0;qx.util.Permutation.permute(ca,function(ci){this.__GG(cb,top,cd,ce,ci);top+=20;}
,this);}
,testReplaceRenderer:function(){var cn=new qx.ui.table.cellrenderer.Replace();cn.setReplaceMap({'1':x,'2':L,'3':j});cn.addReversedReplaceMap();var cm=100;var cl=20;var cj={value:[1,2,3],styleLeft:[0],styleWidth:[cm],table:[this.tableMock],styleHeight:[cl],style:[C]};var ck=this._getNewTableDiv(cm);var top=0;qx.util.Permutation.permute(cj,function(co){this.__GG(ck,top,cm,cn,co);top+=20;}
,this);}
...
,init:k}},members:{__rv:16,__rw:16,__rx:null,_insetY:2,_identifyImage:function(A){throw new Error("_identifyImage is abstract");}
,_getImageInfos:function(B){var C=this._identifyImage(B);if(C==null||typeof C==g){C={url:C,tooltip:null};}
;if(!C.imageWidth||!C.imageHeight){var D=this.__ry(C.url);C.imageWidth=D.width;C.imageHeight=D.height;}
;C.width=C.imageWidth;C.height=C.imageHeight;return C;}
,__ry:function(E){var H=qx.util.ResourceManager.getInstance();var G=qx.io.ImageLoader;var F,I;if(H.has(E)){F=H.getImageWidth(E);I=H.getImageHeight(E);}
else if(G.isLoaded(E)){F=G.getWidth(E);I=G.getHeight(E);}
else {F=this.__rv;I=this.__rw;}
;return {width:F,height:I};}
,createDataCellHtml:function(J,K){this.__rx=this._getImageInfos(J);return qx.ui.table.cellrenderer.Abstract.prototype.createDataCellHtml.call(this,J,K);}
,_getCellClass:function(L){return qx.ui.table.cellrenderer.Abstract.prototype._getCellClass.call(this)+q;}
,_getContentHtml:function(M){var content=t;if(this.__rx.url){content=qx.bom.element.Decoration.create(this.__rx.url,this.getRepeat(),{width:this.__rx.width+m,height:this.__rx.height+m,display:qx.core.Environment.get(j),verticalAlign:s,position:f});}
;return content;}
,_getCellAttributes:function(N){var O=this.__rx.tooltip;if(O){return n+O+e;}
else {return u;}
;}
},destruct:function(){this.__rx=null;}
});}
)();
(function(){var h="_applyIconTrue",g="decoration/table/boolean-true.png",f="qx.ui.table.cellrenderer.Boolean",e=";padding-top:4px;",d="decoration/table/boolean-false.png",c="_applyIconFalse",b="changeTheme",a="String";qx.Class.define(f,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(){qx.ui.table.cellrenderer.AbstractImage.call(this);this.__Go=qx.util.AliasManager.getInstance();this.initIconTrue();this.initIconFalse();qx.theme.manager.Appearance.getInstance().addListener(b,this._onChangeTheme,this);}
,properties:{iconTrue:{check:a,init:g,apply:h},iconFalse:{check:a,init:d,apply:c}},members:{__Fk:null,__Fl:false,__Go:null,_onChangeTheme:function(){this._applyIconTrue(this.getIconTrue());this._applyIconFalse(this.getIconFalse());}
,_applyIconTrue:function(i){this.__Fk=this.__Go.resolve(i);}
,_applyIconFalse:function(j){this.__Fl=this.__Go.resolve(j);}
,_insetY:5,_getCellStyle:function(k){return qx.ui.table.cellrenderer.AbstractImage.prototype._getCellStyle.call(this,k)+e;}
,_identifyImage:function(l){var m={imageWidth:11,imageHeight:11};switch(l.value){case true:m.url=this.__Fk;break;case false:m.url=this.__Fl;break;default:m.url=null;break;};return m;}
},destruct:function(){this.__Go=null;qx.theme.manager.Appearance.getInstance().removeListener(b,this._onChangeTheme,this);}
});}
)();
(function(){var s="font-weight",r=";",q="text-align",p='g',o=":",n="qx.ui.table.cellrenderer.Conditional",m="color",l="font-style",k="==",j=">",c="between",h="<",f="regex",b="!between",a=">=",e="!=",d="<=",g="";qx.Class.define(n,{extend:qx.ui.table.cellrenderer.Default,construct:function(t,u,v,w){qx.ui.table.cellrenderer.Default.call(this);this.numericAllowed=[k,e,j,h,a,d];this.betweenAllowed=[c,b];this.conditions=[];this.__Fo=t||g;this.__Fp=u||g;this.__Fq=v||g;this.__Fr=w||g;}
,members:{__Fo:null,__Fp:null,__Fq:null,__Fr:null,__Fu:function(x,y){if(x[1]!=null){y[q]=x[1];}
;if(x[2]!=null){y[m]=x[2];}
;if(x[3]!=null){y[l]=x[3];}
;if(x[4]!=null){y[s]=x[4];}
;}
...
;var bd=X.table.getTableModel();var i;var bf;var Y;var bb={"text-align":this.__Fo,"color":this.__Fp,"font-style":this.__Fq,"font-weight":this.__Fr};for(i in this.conditions){bf=false;if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){Y=X.value;}
...
;if(bf==true){this.__Fu(this.conditions[i],bb);}
;}
...
(function(){var b="qx.ui.table.cellrenderer.Image",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__rz=c;}
;if(d){this.__rA=d;}
;this.__rB=qx.util.AliasManager.getInstance();}
,members:{__rB:null,__rA:16,__rz:16,_identifyImage:function(e){var f={imageWidth:this.__rz,imageHeight:this.__rA};if(e.value==a){f.url=null;}
else {f.url=this.__rB.resolve(e.value);}
