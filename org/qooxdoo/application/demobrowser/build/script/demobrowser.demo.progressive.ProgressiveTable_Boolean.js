...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean.5eb5e8186779.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},destruct:function(){this.__Fk=this.__Fl=null;qx.theme.manager.Appearance.getInstance().removeListener(p,this.__Fs,this);}
});}
)();
