...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Button.7de122947afe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="Off",q="Button A",p="#AAA",o="icon/22/actions/list-add.png",n="Button B",m="demobrowser.demo.widget.Button",l="icon/22/apps/internet-web-browser.png",k="Hover",j="icon/22/apps/media-video-player.png",i="icon/22/apps/internet-mail.png",c="changeValue",h="On",g="Toggle Button",b="0",a="white",f="main",d="execute";qx.Class.define(m,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var s=new qx.ui.layout.HBox();s.setSpacing(10);var t=new qx.ui.container.Composite(s);t.setPadding(20);this.getRoot().add(t,{left:0,top:0});this.addNormalButtons(t);this.addToggleButton(t);this.addToggleButtonGroup(t);this.addRepeatButton(t);this.addHoverButton(t);}
,addNormalButtons:function(u){var v=new qx.ui.form.Button(q,j);u.add(v);var w=new qx.ui.form.Button(n,i);w.setEnabled(false);u.add(w);}
,addToggleButton:function(x){var y=new qx.ui.form.ToggleButton(g,l);y.focus();x.add(y);y.addListener(c,function(e){this.debug("Checked: "+e.getData());}
,this);}
,addToggleButtonGroup:function(z){var B=new qx.ui.form.ToggleButton(h);var A=new qx.ui.form.ToggleButton(r);var C=new qx.ui.form.RadioGroup();C.add(B,A);z.add(B);z.add(A);}
,addRepeatButton:function(D){var E=new qx.ui.form.RepeatButton(null,o);D.add(E);var F=new qx.ui.basic.Label(b);F.setDecorator(f);F.setPadding(2,4);F.setBackgroundColor(a);D.add(F);E.addListener(d,function(){var G=parseInt(F.getValue())+1;F.setValue(G.toString());}
);}
,addHoverButton:function(H){var I=new qx.ui.form.HoverButton(k).set({padding:10,backgroundColor:p});H.add(I);var J=new qx.ui.basic.Label(b);J.setDecorator(f);J.setPadding(2,4);J.setBackgroundColor(a);H.add(J);I.addListener(d,function(){var K=parseInt(J.getValue())+1;J.setValue(K.toString());}
);}
}});}
)();
