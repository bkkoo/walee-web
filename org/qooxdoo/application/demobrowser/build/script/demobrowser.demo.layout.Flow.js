...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow.41aceddd402f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var x=new qx.ui.layout.LineSizeIterator(A,this.getSpacingX());var y=0;while(x.hasMoreLines()){var z=x.computeNextLine(v);this.__DY(z,y,v);y+=z.height+this.getSpacingY();}
;}
,__DY:function(B,C,D){var F=qx.ui.layout.Util;var I=0;if(this.getAlignX()!="left"){I=D-B.width;if(this.getAlignX()=="center"){I=Math.round(I/2);}
;}
...
;}
,_computeSizeHint:function(){return this.__Ea(Infinity);}
,hasHeightForWidth:function(){return true;}
,getHeightForWidth:function(K){return this.__Ea(K).height;}
,__Ea:function(L){var M=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());var Q=0;var N=0;var O=0;while(M.hasMoreLines()){var P=M.computeNextLine(L);O+=1;N=Math.max(N,P.width);Q+=P.height;}
;return {width:N,height:Q+this.getSpacingY()*(O-1)};}
}});}
)();
(function(){var a="qx.ui.layout.LineSizeIterator";qx.Class.define(a,{extend:Object,construct:function(b,c){this.__fU=b;this.__Eb=c;this.__Ec=b.length>0;this.__Ed=0;}
,members:{__fU:null,__Eb:null,__Ec:null,__Ed:null,computeNextLine:function(d){var d=d||Infinity;if(!this.__Ec){throw new Error("No more lines to compute");}
;var o=this.__fU;var m=0;var f=0;var n=[];var j=[];for(var i=this.__Ed;i<o.length;i++){var l=o[i];var p=l.getSizeHint();var h=this.__Ee(i);var g=p.width+h;var e=i==this.__Ed;if(!e&&f+g>d){this.__Ed=i;break;}
;var k=p.height+l.getMarginTop()+l.getMarginBottom();n.push(l);j.push(h);f+=g;m=Math.max(m,k);if(l.getLayoutProperties().lineBreak){this.__Ed=i+1;break;}
;}
;if(i>=o.length){this.__Ec=false;}
;return {height:m,width:f,children:n,gapsBefore:j};}
,__Ee:function(q){var r=q==this.__Ed;if(r){return this.__fU[q].getMarginLeft();}
else {return Math.max(this.__fU[q-1].getMarginRight(),this.__fU[q].getMarginLeft(),this.__Eb);}
;}
,hasMoreLines:function(){return this.__Ec;}
}});}
)();
