...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional.4988b9078162.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="maxWidth",c="qx.ui.progressive.renderer.table.Widths",b="minWidth",a="width";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__EF=[];for(var i=0;i<e;i++){this.__EF[i]=new qx.ui.core.ColumnData();}
;}
,members:{__EF:null,getData:function(){return this.__EF;}
...
;}
,setWidth:function(j,k){if(j>this.__EF.length-1||j<0){throw new Error("Column number out of range");}
;this.__EF[j].setColumnWidth(k);}
,setMinWidth:function(l,m){if(l>this.__EF.length-1||l<0){throw new Error("Column number out of range");}
;this.__EF[l].setMinWidth(m);}
,setMaxWidth:function(n,o){if(n>this.__EF.length-1||n<0){throw new Error("Column number out of range");}
;this.__EF[n].setMaxWidth(o);}
}});}
)();
...
,members:{__oU:null,renderLayout:function(f,top,g,h){this.__oU=g;}
,getComputedWidth:function(){return this.__oU;}
...
,members:{__EG:null,join:function(c){this.__EG=c;}
...
(function(){var f="resize",d="progressive-table-header",c="_layout",b="qx.ui.progressive.headfoot.TableHeading",a="progressive-table-header-cell";qx.Class.define(b,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(g,h){qx.ui.progressive.headfoot.Abstract.call(this);this.__EY=g;var k=g.getData();this.__Fa=[];for(var i=0;i<k.length;i++){var l=new qx.ui.basic.Atom(h[i]);l.setAppearance(a);this.add(l);this.__Fa[i]=l;}
;var j=new qx.ui.core.Widget();j.set({height:16,appearance:a,minWidth:0,width:0});this.add(j,{flex:1});this.addListener(f,this._resizeColumns,this);this.__oW=new qx.ui.layout.HBox();this.__oW.connectToWidget(this);}
,properties:{appearance:{refine:true,init:d}},members:{__EY:null,__Fb:null,__Fa:null,__oW:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__Fb){return this.__EY.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var n=this.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();this.__Fb=true;this.__oW.renderLayout(n,100);this.__Fb=false;var o=this.__EY.getData();for(var i=0;i<o.length;i++){this.__Fa[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__EY=this.__Fa=null;this._disposeObjects(c);}
});}
)();
(function(){var i="__EI",h="__EJ",g="%",f="renderStart",d="progress",c="0%",b="qx.ui.progressive.headfoot.Progress",a="renderEnd";qx.Class.define(b,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(j,k){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__EH={};this.__EL();this.set({backgroundColor:this.__EH.background});this.__EI=new qx.ui.core.Widget();this.__EI.set({width:0,backgroundColor:this.__EH.indicatorDone});this.add(this.__EI);var l=new qx.ui.core.Widget();l.set({backgroundColor:this.__EH.indicatorUndone});this.add(l,{flex:1});this.__EJ=new qx.ui.basic.Atom(c);this.__EJ.set({width:100,backgroundColor:this.__EH.percentBackground,textColor:this.__EH.percentText});this.add(this.__EJ);this.exclude();}
,members:{__EK:null,__EH:null,__EI:null,__EJ:null,_onChangeTheme:function(){qx.ui.progressive.headfoot.Abstract.prototype._onChangeTheme.call(this);this.__EL();}
,__EL:function(){var m=qx.theme.manager.Color.getInstance();this.__EH.background=m.resolve("progressive-progressbar-background");this.__EH.indicatorDone=m.resolve("progressive-progressbar-indicator-done");this.__EH.indicatorUndone=m.resolve("progressive-progressbar-indicator-undone");this.__EH.percentBackground=m.resolve("progressive-progressbar-percent-background");this.__EH.percentText=m.resolve("progressive-progressbar-percent-text");}
,join:function(n){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,n);n.addListener(f,function(e){this.__EK=e.getData().initial;this.show();}
,this);n.addListener(d,function(e){var q=1.0-(e.getData().remaining/this.__EK);var r=this.getBounds();if(r){var o=Math.floor((r.width-this.__EJ.getBounds().width)*q);var p=Math.floor(q*100)+g;if(!isNaN(o)){this.__EI.setMinWidth(o);this.__EJ.setLabel(p);}
;}
;}
,this);n.addListener(a,function(e){this.exclude();}
,this);}
},destruct:function(){this.__EH=null;this._disposeObjects(i,h);}
});}
)();
(function(){var d="abstract",c="qx.ui.progressive.structure.Abstract",b="overflowY",a="auto";qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);if(!e){this.__wn=new qx.ui.core.Widget();this.__CE=this.__wn;}
else {this.__wn=null;this.__CE=e;}
;this.__CE.getContentElement().setStyle(b,a);}
,members:{__wn:null,__CE:null,applyStructure:function(f){throw new Error("applyStructure() is abstract");}
,getPane:function(){return this.__CE;}
},destruct:function(){if(this.__wn){this.__wn.dispose();}
;this.__wn=this.__CE=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,c,d){qx.ui.progressive.structure.Abstract.call(this,d);if(!b){this.__EM=new qx.ui.progressive.headfoot.Null();this.__qe=this.__EM;}
else {this.__EM=null;this.__qe=b;}
;if(!c){this.__EN=new qx.ui.progressive.headfoot.Null();this.__EO=this.__EN;}
else {this.__EN=null;this.__EO=c;}
;}
,members:{__qe:null,__EO:null,__EM:null,__EN:null,applyStructure:function(e){this.__qe.join(e);this.__EO.join(e);e.add(this.__qe);e.add(this.getPane(),{flex:1});e.add(this.__EO);}
,getHeader:function(){return this.__qe;}
,getFooter:function(){return this.__EO;}
},destruct:function(){if(this.__EM){this.__EM.dispose();this.__EM=null;}
;if(this.__EN){this.__EN.dispose();this.__EN=null;}
;this.__qe=this.__EO=null;}
});}
)();
...
(function(){var k="_applyDataModel",j="Boolean",h="qx.ui.progressive.model.Abstract",g="white",f="qx.ui.progressive.Progressive",d="dataAvailable",c="renderStart",b="Integer",a="qx.event.type.Data";qx.Class.define(f,{extend:qx.ui.container.Composite,construct:function(l){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__EP={};this.set({backgroundColor:g});if(!l){l=new qx.ui.progressive.structure.Default();}
;this.__EQ=l;l.applyStructure(this);this.__ER=false;this.__ES=false;this.__ET=0;}
,events:{"renderStart":a,"renderEnd":a,"progress":a,"progressDetail":a},properties:{dataModel:{check:h,apply:k},batchSize:{check:b,init:20},flushWidgetQueueAfterBatch:{check:j,init:false},interElementTimeout:{check:b,init:0}},members:{__EP:null,__ES:null,__EU:null,__ET:null,__ER:null,__EQ:null,getStructure:function(){return this.__EQ;}
,addRenderer:function(name,m){this.__EP[name]=m;m.join(this,name);}
,removeRenderer:function(name){if(!this.__EP[name]){throw new Error("No existing renderer named "+name);}
;delete this.__EP[name];}
,render:function(){if(this.__ES){return;}
;this.__ES=true;var n=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__EQ.getPane(),batchSize:this.getBatchSize(),rendererData:this.__EW(),userData:{}});this.__EU=new Date();if(this.__ER){this.__ET=n.getModel().getElementCount();this.fireDataEvent(c,{state:n,initial:this.__ET});this.__EV(n);}
else {qx.event.Timer.once(function(){this.__ET=n.getModel().getElementCount();this.fireDataEvent(c,{state:n,initial:this.__ET});this.__EV(n);this.__ER=true;}
,this,10);}
;}
,_applyDataModel:function(o,p){if(p){p.removeListener(d,this.__EX,this);p.dispose();}
;o.addListener(d,this.__EX,this);}
,__EV:function(q){var r;var t;var s;for(var i=q.getBatchSize();i>0;i--){r=q.getModel().getNextElement();if(!r){this.debug("Render time: "+(new Date()-this.__EU)+"ms");this.__ES=false;this.fireDataEvent("renderEnd",q);q.dispose();return;}
;t=r.element;s=this.__EP[t.renderer];s.render(q,t);this.fireDataEvent("progressDetail",{initial:this.__ET,remaining:r.remaining,element:t});}
;this.fireDataEvent("progress",{initial:this.__ET,remaining:r.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__EV(q);}
,this,this.getInterElementTimeout());}
,__EW:function(){var u={};for(var name in this.__EP){u[name]={};}
;return u;}
,__EX:function(e){this.__ET=e.getData();this.render();}
},destruct:function(){for(var name in this.__EP){this.__EP[name].dispose();}
;this.__EU=this.__EP=this.__EQ=null;}
});}
)();
...
(function(){var b="qx.ui.progressive.model.Default",a="dataAvailable";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__DM=[];}
,members:{__DM:null,addElements:function(c){this.__DM=this.__DM.concat(c);this.fireDataEvent(a,this.__DM.length);}
,addElement:function(d){this.__DM.push(d);this.fireDataEvent(a,this.__DM.length);}
,getElementCount:function(){return this.__DM.length;}
,getNextElement:function(){if(this.__DM.length>0){return ({element:this.__DM.shift(),remaining:this.__DM.length});}
;return null;}
...
(function(){var l="__Fd",k="px",j="  font-size: 11px;",h="content",g="px ",f=';',d='',c="padding: ",b="end",a="div",X="  position: absolute;",W="qx.tableResizeDebug",V="__columnData",U="css.boxmodel",T="  top: 0px;",S="  width : 100%;",R="  overflow:hidden;",Q=" {",P="  border-right:1px solid #f2f2f2;",O="  cursor:default;",s="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",t="-row {",q="qx.debug",r="resize",o="start",p="relative",m=':ellipsis;',n=':',u="  white-space:nowrap;",v="  padding : 0px 6px 0px 6px;",C="qx.ui.progressive.renderer.table.Row",A="__oW",G="  height: 100%;",E="  border-bottom:1px solid #eeeeee;",K="left: ",I="css.userselect.none",x="changeTheme",N="css.userselect",M="css.textoverflow",L="}",w="",y="width: ",z="0px ",B="qx-progressive-",D="-row",F="-col-",H="px;",J=".qx-progressive-";qx.Class.define(C,{extend:qx.ui.progressive.renderer.Abstract,construct:function(Y){qx.ui.progressive.renderer.Abstract.call(this);this.__EY=Y;this.__Fc={};this.__Fd=new qx.ui.progressive.renderer.table.cell.Default();this.__EG=null;this.__EH={};this.__EL();this.__oW=new qx.ui.layout.HBox();this.__oW.connectToWidget(this);qx.theme.manager.Appearance.getInstance().addListener(x,this.__EL,this);}
,statics:{__ol:null,__Fe:6,__Ff:X+T+G+R+(qx.core.Environment.get(M)?qx.bom.Style.getCssName(qx.core.Environment.get(M))+m:w)+u+P+E+v+O+j+s+(qx.core.Environment.get(N)?qx.bom.Style.getCssName(qx.core.Environment.get(N))+n+qx.core.Environment.get(I)+f:d)},properties:{defaultRowHeight:{init:16}},members:{__EG:null,__Fg:null,__Fh:null,__EY:null,__Fc:null,__Fd:null,__EH:null,__oW:null,__EL:function(){var ba=qx.theme.manager.Color.getInstance();this.__EH.bgcol=[];this.__EH.bgcol[0]=ba.resolve("progressive-table-row-background-even");this.__EH.bgcol[1]=ba.resolve("progressive-table-row-background-odd");}
,join:function(bb,name){if(this.__EG){throw new Error("Renderer is already joined to a Progressive.");}
;this.__EG=bb;this.__Fg=name;var bd=qx.ui.progressive.renderer.table.Row;if(!bd.__ol){bd.__ol={};}
;var bc=bb.toHashCode();if(!bd.__ol[bc]){bd.__ol[bc]={rowstylesheet:null,cellstylesheet:[]};var be=J+bc+t+S+L;bd.__ol[bc].rowstylesheet=qx.bom.Stylesheet.createElement(be);var bf=this.__EY.getData();for(var i=0;i<bf.length;i++){var be=J+bc+F+i+Q+bd.__Ff+L;bd.__ol[bc].cellstylesheet[i]=qx.bom.Stylesheet.createElement(be);}
;this.__Fh=bc;var bg=bb.getStructure().getPane();bg.addListener(r,this._resizeColumns,this);}
;}
,addRenderer:function(bh,bi){var bj=this.__EY.getData();if(bh<0||bh>=bj.length){throw new Error("Column "+bh+" out of range (max: "+(bj.length-1)+")");}
;this.__Fc[bh]=bi;}
,removeRenderer:function(bk){var bl=this.__EY.getData();if(bk<0||bk>=bl.length){throw new Error("Column "+bk+" out of range (max: "+(bl.length-1)+")");}
;if(!this.__Fc[bk]){throw new Error("No existing renderer for column "+bk);}
;delete this.__Fc[bk];}
,render:function(bm,bn){var bx=bn.data;var bs=[];var bu;var bt;var bq=0;if(bm.getRendererData()[this.__Fg].end===undefined){bm.getRendererData()[this.__Fg]={end:0,start:1,rows:0,totalHeight:0};}
;var bw=document.createElement(a);for(var i=0;i<bx.length;i++){var br=B+this.__Fh+F+i;bt=this.__Fc[i]||this.__Fd;bu={state:bm,rowDiv:bw,stylesheet:br,element:bn,dataIndex:i,cellData:bx[i],height:bq};bs.push(bt.render(bu));if(bu.height>bq){bq=bu.height;}
;}
;bq=(bq>0?bq:this.getDefaultRowHeight());var bv=bm.getRendererData()[this.__Fg];bv.totalHeight+=bq;bw.style.position=p;bw.style.height=bq+k;bw.className=B+this.__Fh+D;bw.innerHTML=bs.join(w);switch(bn.location){case b:var bo=bv.end||0;bw.style.backgroundColor=this.__EH.bgcol[bo];bv.end=(bo==0?1:0);bm.getPane().getContentElement().getDomElement().appendChild(bw);break;case o:var bp=bm.getPane().getContentElement().getDomElement();var by=bp.childNodes;if(by.length>0){var bo=bv.start;bw.style.backgroundColor=this.__EH.bgcol[bo];bv.start=(bo==0?1:0);bp.insertBefore(bw,by[0]);break;}
else {bp.appendChild(bw);}
;break;default:throw new Error("Invalid location: "+bn.location);};++bv.rows;}
,getLayoutChildren:function(){return this.__EY.getData();}
,_resizeColumns:function(e){var bG=this.__EG.getStructure().getPane();var bD=bG.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();var bE=J+this.__Fh+D;var bA=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bA.__ol[this.__Fh].rowstylesheet,bE);var bC=y+bD+H;qx.bom.Stylesheet.addRule(bA.__ol[this.__Fh].rowstylesheet,bE,bC);this.__oW.renderLayout(bD,100);var bF=this.__EY.getData();for(var i=0,bJ=0;i<bF.length;i++,bJ+=bD){var bE=J+this.__Fh+F+i;var bA=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bA.__ol[this.__Fh].cellstylesheet[i],bE);bD=bF[i].getComputedWidth();if(qx.core.Environment.get(q)){if(qx.core.Environment.get(W)){this.debug("col "+i+": width="+bD);}
;}
;var bB;if(qx.core.Environment.get(U)==h){bB=qx.ui.progressive.renderer.table.Row.__Fe*2;}
else {bB=-1;}
;var bI=(bD-bB)+H;var bH=z+qx.ui.progressive.renderer.table.Row.__Fe+g+z+qx.ui.progressive.renderer.table.Row.__Fe+H;var bz=bJ+H;var bC=bA.__Ff+y+bI+K+bz+c+bH;qx.bom.Stylesheet.addRule(bA.__ol[this.__Fh].cellstylesheet[i],bE,bC);}
;}
},destruct:function(){qx.theme.manager.Appearance.getInstance().removeListener(x,this.__EL,this);var name;for(name in this.__Fc){this.__Fc[name]=null;}
;var bL=qx.ui.progressive.renderer.table.Row;var bK=this.__EG.toHashCode();if(bL.__ol&&bL.__ol[bK]){if(bL.__ol[bK].rowstylesheet){var bN=J+this.__Fh+D;var bL=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bL.__ol[this.__Fh].rowstylesheet,bN);}
;if(bL.__ol[bK].cellstylesheet){for(var i=bL.__ol[bK].cellstylesheet.length-1;i>=0;i--){var bN=J+this.__Fh+F+i;var bM=bL.__ol[this.__Fh].cellstylesheet[i];var bL=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bM,bN);}
;}
;}
;if(this.__EG&&this.__EG.getRendererData){var bO=this.__EG.getRendererData();if(bO&&bO[this.__Fg]&&bO[this.__Fg].end!==undefined){bO[this.__Fg]=null;}
;}
;this.__EH=this.__Fc=this.__EG=this.__EY=null;this._disposeObjects(A,l,V);}
});}
)();
...
(function(){var s="font-weight",r="text-align",q='g',p="qx.ui.progressive.renderer.table.cell.Conditional",o=":",n=";",m="color",l="font-style",k="==",j=">",c="between",h="regex",f="<",b="!between",a=">=",e="!=",d="<=",g="";qx.Class.define(p,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(t,u,v,w){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__Fm=[k,e,j,f,a,d];this.__Ft=[c,b];this.__Fn=[];this.__Fo=t||g;this.__Fp=u||g;this.__Fq=v||g;this.__Fr=w||g;}
,members:{__Fm:null,__Ft:null,__Fn:null,__Fo:null,__Fp:null,__Fq:null,__Fr:null,__Fu:function(x,y){if(x.align){y[r]=x.align;}
;if(x.color){y[m]=x.color;}
;if(x.style){y[l]=x.style;}
;if(x.weight){y[s]=x.weight;}
;}
,addNumericCondition:function(z,A,B,C,D,E,F){if(!qx.lang.Array.contains(this.__Fm,z)||A==null){throw new Error("Condition not recognized or value is null!");}
;this.__Fn.push({condition:z,align:B,color:C,style:D,weight:E,value1:A,target:F});}
,addBetweenCondition:function(G,H,I,J,K,L,M,N){if(!qx.lang.Array.contains(this.__Ft,G)||H==null||I==null){throw new Error("Condition not recognized or value1/value2 is null!");}
;this.__Fn.push({condition:G,align:J,color:K,style:L,weight:M,value1:H,value2:I,target:N});}
,addRegex:function(O,P,Q,R,S,T){if(!O){throw new Error("regex cannot be null!");}
;this.__Fn.push({condition:h,align:P,color:Q,style:R,weight:S,regex:O,target:T});}
,_getCellStyle:function(U){if(this.__Fn.length==0){return U.style||g;}
;var i;var Y;var V;var X={"text-align":this.__Fo,"color":this.__Fp,"font-style":this.__Fq,"font-weight":this.__Fr};for(i=0;i<this.__Fn.length;i++){var bc=this.__Fn[i];Y=false;if(qx.lang.Array.contains(this.__Fm,bc.condition)){if(bc.target==null){V=U.cellData;}
else {V=U.element.data[bc.target];}
;switch(bc.condition){case k:if(V==bc.value1){Y=true;}
;break;case e:if(V!=bc.value1){Y=true;}
;break;case j:if(V>bc.value1){Y=true;}
;break;case f:if(V<bc.value1){Y=true;}
;break;case a:if(V>=bc.value1){Y=true;}
;break;case d:if(V<=bc.value1){Y=true;}
;break;};}
else if(qx.lang.Array.contains(this.__Ft,bc.condition)){if(bc.target==null){V=U.cellData;}
else {V=U.element.data[bc.target];}
;switch(bc.condition){case c:if(V>=bc.value1&&V<=bc.value2){Y=true;}
;break;case b:if(V<bc.value1&&V>bc.value2){Y=true;}
;break;};}
else if(bc.condition==h){if(bc.target==null){V=U.cellData;}
else {V=U.element.data[bc.target];}
;var W=new RegExp(bc.value1,q);Y=W.test(V);}
;if(Y){this.__Fu(bc,X);}
;var ba=[];for(var bb in X){if(X[bb]){ba.push(bb,o,X[bb],n);}
;}
;}
;return ba.join(g);}
},destruct:function(){this.__Fm=this.__Ft=this.__Fn=null;}
});}
)();
